    ...
    , function(module, exports, __webpack_require__) {
        ...
        !function(global, factory) {
            ...
            function defaultPrefilter(elem, props, opts) {
                ...
                "inline" === ("none" === display ? data_priv.get(elem, "olddisplay") || defaultDisplay(elem.nodeName) : display) && "none" === jQuery.css(elem, "float") && (style.display = "inline-block")),
                    ...
                    data: function(key, value) {
                        ...
                        return "object" == typeof key ? this.each(function() {
                            ...
                            if (elem && void 0 === value) {
                                if (void 0 !== (data = data_user.get(elem, key)))
                                    return data;
                                if (void 0 !== (data = data_user.get(elem, camelKey)))
                                    return data;
                                if (void 0 !== (data = dataAttr(elem, camelKey, void 0)))
                                    return data
                            } else
                                this.each(function() {
            ...
            jQuery.event = {
                ...
                trigger: function(event, data, elem, onlyHandlers) {
                    ...
                    if (cur = tmp = elem = elem || document,
                        ...
                        onlyHandlers || event.isDefaultPrevented() || special._default && !1 !== special._default.apply(eventPath.pop(), data) || !jQuery.acceptData(elem) || ontype && jQuery.isFunction(elem[type]) && !jQuery.isWindow(elem) && (tmp = elem[ontype],
                ...
                jQuery.Event = function(src, props) {
                    ...
                    src && src.type ? (this.originalEvent = src,
                        this.type = src.type,
                        this.isDefaultPrevented = src.defaultPrevented || void 0 === src.defaultPrevented && !1 === src.returnValue ? returnTrue : returnFalse) : this.type = src,
                ...
                jQuery.extend({
                    attr: function(elem, name, value) {
                        ...
                        if (elem && 3 !== nType && 8 !== nType && 2 !== nType)
                            return void 0 === elem.getAttribute ? jQuery.prop(elem, name, value) : (1 === nType && jQuery.isXMLDoc(elem) || (name = name.toLowerCase(),
                ...
                toggleClass: function(value, stateVal) {
                    ...
                    return "boolean" == typeof stateVal && "string" === type ? stateVal ? this.addClass(value) : this.removeClass(value) : jQuery.isFunction(value) ? this.each(function(i) {
                        ...
                        if ("string" === type)
                            ...
                            "undefined" !== type && "boolean" !== type || (this.className && data_priv.set(this, "__className__", this.className),
    ...
    , function(module, exports) {
        window.__ctx = "/agile-bpm-platform",
            ...
            window.getCtxUrl = function(url, replaceRequestParam) {
                return !url || url.startWith(__ctx) || url.startWith("http") || (url.startWith("/") || (url = "/" + url),
                    url = __ctx + url,
                replaceRequestParam && -1 != url.indexOf("?") && $.getParams && (url = url.format($.getParams()))),
                    url
            }
            ,
    ...
    , function(module, exports) {
        ...
        function forbidF5(exp) {
            window.navigator.userAgent.indexOf(exp) >= 0 && (document.onkeydown = function(e) {
                    ...
                    if (116 == (ev.keyCode || ev.which))
                        return ev.keyCode ? ev.keyCode = 0 : ev.which = 0,
                            cancelBubble = !0,
                            !1
                }
            )
        ...
        jQuery.extend({
            ...
            getParameter: function(key) {
                for (var parameters = unescape(window.location.search.substr(1)).split("&"), i = 0; i < parameters.length; i++) {
                    ...
                    if (2 == paramCell.length && paramCell[0].toUpperCase() == key.toUpperCase())
                        return paramCell[1]
                }
                return ""
            },
            ...
            weekOfYear: function(year, month, day) {
                ...
                return date1 = date1.getTime(),
                    date2 = date2.getTime(),
                Math.ceil((date2 - date1 - firstDay) / 6048e5) + 1
            },
            timeLag: function(difference) {
                var r = ""
                    , days = Math.floor(difference / 864e5)
                    , leave1 = difference % 864e5
                    , hours = Math.floor(leave1 / 36e5)
                    , leave2 = leave1 % 36e5
                    , minutes = Math.floor(leave2 / 6e4)
                    , leave3 = leave2 % 6e4
                    , seconds = Math.round(leave3 / 1e3);
                return days > 0 && (r += days + "天"),
                hours > 0 && (r += hours + "小时"),
                minutes > 0 && (r += minutes + "分钟"),
                seconds > 0 && (r += seconds + "秒"),
                r || (leave3 ? difference + "毫秒" : "")
            },
            ...
            setCookie: function(name, value) {
                ...
                null != expires && expdate.setTime(expdate.getTime() + 1e3 * expires),
                    document.cookie = name + "=" + escape(value) + (null == expires ? "" : ";  expires=" + expdate.toGMTString()) + (null == path ? "" : ";  path=" + path) + (null == domain ? "" : ";  domain=" + domain) + (1 == secure ? ";  secure" : "")
            },
            ...
            convertCurrency: function(currencyDigits) {
                ...
                if ("" == (currencyDigits = currencyDigits.toString()))
                    return "";
                if (null != currencyDigits.match(/[^,.\d]/))
                    return "";
                if (null == currencyDigits.match(/^((\d{1,3}(,\d{3})*(.((\d{3},)*\d{1,3}))?)|(\d+(.\d+)?))$/))
                    return "";
                if (currencyDigits = currencyDigits.replace(/,/g, ""),
                        currencyDigits = currencyDigits.replace(/^0+/, ""),
                    Number(currencyDigits) > 99999999999.99)
                    return "";
                if (parts = currencyDigits.split("."),
                        parts.length > 1 ? (integral = parts[0],
                            decimal = parts[1],
                            decimal = decimal.substr(0, 2)) : (integral = parts[0],
                            decimal = ""),
                    ...
                    Number(integral) > 0) {
                    for (zeroCount = 0,
                             i = 0; i < integral.length; i++)
                        p = integral.length - i - 1,
                            d = integral.substr(i, 1),
                            quotient = p / 4,
                            modulus = p % 4,
                            "0" == d ? zeroCount++ : (zeroCount > 0 && (outputCharacters += digits[0]),
                                zeroCount = 0,
                                outputCharacters += digits[Number(d)] + radices[modulus]),
                        0 == modulus && zeroCount < 4 && (outputCharacters += bigRadices[quotient]);
                    outputCharacters += "元"
                }
                if ("" != decimal)
                    for (i = 0; i < decimal.length; i++)
                        "0" != (d = decimal.substr(i, 1)) && (outputCharacters += digits[Number(d)] + decimals[i]);
                return "" == outputCharacters && (outputCharacters = "零元"),
                "" == decimal && (outputCharacters += "整"),
                    outputCharacters = "" + outputCharacters
            },
            cloneObject: function(obj) {
                var o = obj.constructor === Array ? [] : {};
                for (var i in obj)
                    obj.hasOwnProperty(i) && (o[i] = "object" == typeof obj[i] ? cloneObject(obj[i]) : obj[i]);
                return o
            },
            ...
            getResult: function(result, fn, errMsgType, sucMsgType, errorFn, isFastJson) {
                ...
                if (isFastJson && FastJson.format(result),
                        !result.isOk)
                    return errMsgType && "toast" !== errMsgType ? "alert" === errMsgType && $.Dialog.alert(result.msg, 2) : $.Toast.error(result.msg),
                        console.error(result),
                        void (errorFn && errorFn(result));
                sucMsgType ? "toast" === sucMsgType ? ($.Toast.success(result.msg),
                fn && fn(result.data)) : "alert" === errMsgType && $.Dialog.alert(result.msg, function() {
                    fn && fn(result.data)
                }, 1) : fn && fn(result.data)
            },
            getPageSize: function() {
                var winW, winH;
                return window.innerHeight ? (winW = window.innerWidth,
                    winH = window.innerHeight) : document.documentElement && document.documentElement.clientHeight ? (winW = document.documentElement.clientWidth,
                    winH = document.documentElement.clientHeight) : document.body && (winW = document.body.clientWidth,
            ...
            String.prototype.isPicture = function() {
                if (this.indexOf(".") > -1) {
                    var p = this.lastIndexOf(".")
                        , strPostfix = this.substring(p, this.length) + "|";
                    if (strPostfix = strPostfix.toLowerCase(),
                        ".jpeg|.gif|.jpg|.png|.bmp|.pic|".indexOf(strPostfix) > -1)
                        return !0
                }
                return !1
            }
            ...
            String.prototype.toDate = function(format) {
                ...
                var year = String_toDate(this, format, "yyyy")
                    , month = String_toDate(this, format, "MM")
                    , day = String_toDate(this, format, "dd")
                    , hour = String_toDate(this, format, "HH")
                    , minth = String_toDate(this, format, "mm")
                    , second = String_toDate(this, format, "ss")
                    , date = new Date(0);
            ...
            String.prototype.endWith = function(str, isCasesensitive) {
                if (null == str || "" == str || 0 == this.length || str.length > this.length)
                    return !1;
            ...
            window._stringRender = function(template, scopeData) {
                ...
                return template.replace(tokenReg, function(word, slash1, token, slash2) {
                    ...
                    for (var i, key, currentObject = scopeData, i = 0; key = variables[i++]; )
                        if (void 0 === (currentObject = currentObject[key]) || null === currentObject)
                            return "";
            ...
            window.GetRandomStr = function(len) {
                len = len || 32;
                for (var $chars = "ABCDEFGHJKLMNOPQRSTUVWXYZabcdefhijklmnoprstuvwxyz", maxPos = $chars.length, pwd = "", i = 0; i < len; i++)
                ...
                for (var name in obj) {
                    ...
                    if (null == val)
                        ...
                        if (c == Array) {
                            ...
                            for (var levelUp = level + 2, tempArrValue = [], i = 0; i < val.length; i++)
                                tempArrValue.push(JsonUtil.__writeObj(val[i], levelUp, !0));
                            temp.push(tempArrValue.join("," + JsonUtil.n)),
                                temp.push(JsonUtil.n + paddingTab + "]")
                        } else
                            c == Function ? temp.push(val) : temp.push(JsonUtil.__writeObj(val, level + 1))
                    }
            ...
            window.TraverseTreeUtil = {
                traverse: function(node, nodeAttrName, callback) {
                    if (node && (callback(node),
                        node[nodeAttrName] && node[nodeAttrName].length > 0))
        ...
        !function(e, q, h) {
            ...
            m.draw = function() {
                ...
                m.prepare = function(a, b) {
                    var c;
                    return this.svg ? c = e(this.svg).empty() : (this.svg = o("svg", {
                        class: "peity"
                    }),
                ...
                j.register("line", {
                    ...
                    for (var c = h.max.apply(h, b.concat([a.max])), d = h.min.apply(h, b.concat([a.min])), f = this.prepare(a.width, a.height), g = f.width(), f = f.height() - a.strokeWidth, e = g / (b.length - 1), c = c - d, j = 0 == c ? f : f / c, m = f + d * j, c = [0, m], i = 0; i < b.length; i++)
        ...
        !function(window, document, undefined) {
            !function(factory) {
                ...
                function sanitizeOptions(opts) {
                    ...
                    "content"in opts && (content = opts.content,
                        invalidOpt(content) || content.jquery || content.done ? content = opts.content = {
                            text: text = invalidContent(content) ? FALSE : content
                        } : text = content.text,
                    "ajax"in content && (ajax = content.ajax,
                            ...
                            content.text = function(event, api) {
                                var loading = text || $(this).attr(api.options.content.attr) || "Loading..."
                                    ...
                                    return content && once && api.set("content.text", content),
                                        content
                                }, function(xhr, status, error) {
                                    api.destroyed || 0 === xhr.status || api.set("content.text", status + ": " + error)
                                });
                                return once ? loading : (api.set("content.text", loading),
                                    deferred)
                            }
                    ),
                    "title"in content && (invalidOpt(content.title) || (content.button = content.title.button,
                        content.title = content.title.text),
                    invalidContent(content.title || FALSE) && (content.title = FALSE))),
                    "position"in opts && invalidOpt(opts.position) && (opts.position = {
                        my: opts.position,
                        at: opts.position
                    }),
                ...
                function setCallback(notation, args) {
                    ...
                    for (category in this.checks)
                        for (rule in this.checks[category])
                            (match = new RegExp(rule,"i").exec(notation)) && (args.push(match),
                            ("builtin" === category || this.plugins[category]) && this.checks[category][rule].apply(this.plugins[category] || this, args))
                }
                ...
                function hideMethod(event) {
                    ...
                    if (clearTimeout(this.timers.show),
                            clearTimeout(this.timers.hide),
                        this !== relatedTarget[0] && "mouse" === this.options.position.target && ontoTooltip || this.options.hide.fixed && /mouse(out|leave|move)/.test(event.type) && (ontoTooltip || ontoTarget))
                        try {
                ...
                function init(elem, id, opts) {
                    ...
                    if (config = $.extend(TRUE, {}, QTIP.defaults, opts, "object" == typeof html5 ? sanitizeOptions(html5) : NULL, sanitizeOptions(metadata5 || metadata)),
                            posOptions = config.position,
                            config.id = id,
                        "boolean" == typeof config.content.text) {
                        if (attr = elem.attr(config.content.attr),
                    ...
                    if (posOptions.container.length || (posOptions.container = docBody),
                        ...
                        config.show.solo === TRUE && (config.show.solo = posOptions.container.closest("body")),
                        config.hide.target === FALSE && (config.hide.target = newTarget),
                        config.position.viewport === TRUE && (config.position.viewport = posOptions.container),
                        ...
                        if (config.overwrite)
                            ...
                            return FALSE;
                    return elem.attr(ATTR_HAS, id),
                    config.suppress && (title = elem.attr("title")) && elem.removeAttr("title").attr(oldtitle, title).attr("title", ""),
                ...
                function vendorCss(elem, prop) {
                    var cur, val, ucProp = prop.charAt(0).toUpperCase() + prop.slice(1), props = (prop + " " + cssPrefixes.join(ucProp + " ") + ucProp).split(" "), i = 0;
                    if (cssProps[prop])
                ...
                PROTOTYPE = QTip.prototype,
                    ...
                    PROTOTYPE.render = function(show) {
                        ...
                        var self = this
                            ...
                            , deferreds = (this._id,
                            []);
                        return $.attr(this.target[0], "aria-describedby", this._id),
                        ...
                        $.isFunction(title) || deferreds.push(this._updateTitle(title, FALSE))),
                        button && this._createButton(),
                        $.isFunction(text) || deferreds.push(this._updateContent(text, FALSE)),
                            this.rendered = TRUE,
                            this._setWidget(),
                            ...
                            this._when(deferreds).then(function() {
                                ...
                                self.hiddenDuringWait || !options.show.ready && !show || self.toggle(TRUE, cache.event, FALSE),
                    ...
                    PROTOTYPE.destroy = function(immediate) {
                        function process() {
                            if (!this.destroyed) {
                                ...
                                this.options.suppress && title && target.attr("title", title).removeAttr(oldtitle),
                                    this._unbind(target),
                                    this.options = this.elements = this.cache = this.timers = this.plugins = this.mouse = NULL,
                                    delete QTIP.api[this.id]
                            }
                        }
                        return this.destroyed ? this.target : (immediate === TRUE && "hide" !== this.triggering || !this.rendered ? process.call(this) : (this.tooltip.one("tooltiphidden", $.proxy(process, this)),
                        ...
                        builtin: {
                            "^id$": function(obj, o, v, prev) {
                                var id = v === TRUE ? QTIP.nextid : v
                                    , new_id = NAMESPACE + "-" + id;
                                id !== FALSE && id.length > 0 && !$("#" + new_id).length ? (this._id = new_id,
                                this.rendered && (this.tooltip[0].id = this._id,
                                    this.elements.content[0].id = this._id + "-content",
                                    this.elements.title[0].id = this._id + "-title")) : obj[o] = prev
                            },
                            ...
                            "^(show|hide|position).(event|target|fixed|inactive|leave|distance|viewport|adjust)": function() {
                                if (this.rendered) {
                                    ...
                                    this.tooltip.attr("tracking", "mouse" === posOptions.target && posOptions.adjust.mouse),
                                        this._unassignEvents(),
                                        this._assignEvents()
                                }
                            }
                ...
                PROTOTYPE.set = function(option, value) {
                    ...
                    this.checks;
                    return "string" == typeof option ? (name = option,
                        option = {},
                        option[name] = value) : option = $.extend({}, option),
                    ...
                    this.rendered && this.tooltip[0].offsetWidth > 0 && reposition && this.reposition("mouse" === options.position.target ? NULL : this.cache.event),
                        this
                }
                    ,
                    PROTOTYPE._update = function(content, element, reposition) {
                        var self = this
                            , cache = this.cache;
                        return this.rendered && content ? ($.isFunction(content) && (content = content.call(this.elements.target, cache.event, this) || ""),
                            $.isFunction(content.then) ? (cache.waiting = TRUE,
                                content.then(function(c) {
                                    return cache.waiting = FALSE,
                                        self._update(c, element)
                                }, NULL, function(e) {
                                ...
                                this._waitForContent(element).then(function(images) {
                    ...
                    PROTOTYPE._waitForContent = function(element) {
                        ...
                        return cache.waiting = TRUE,
                            ($.fn.imagesLoaded ? element.imagesLoaded() : $.Deferred().resolve([])).done(function() {
                                cache.waiting = FALSE
                            }).promise()
                    }
                    ,
                    ...
                    PROTOTYPE._createTitle = function() {
                        var elements = this.elements
                            , id = this._id + "-title";
                        elements.titlebar && this._removeTitle(),
                    ...
                    PROTOTYPE._removeTitle = function(reposition) {
                        var elements = this.elements;
                        elements.title && (elements.titlebar.remove(),
                    ...
                    PROTOTYPE.reposition = function(event, effect) {
                        ...
                        var pluginCalculations, offset, cache = this.cache, tooltip = this.tooltip, posOptions = this.options.position, target = posOptions.target, my = posOptions.my, at = posOptions.at, viewport = posOptions.viewport, container = posOptions.container, adjust = posOptions.adjust, method = adjust.method.split(" "), tooltipWidth = tooltip.outerWidth(FALSE), tooltipHeight = tooltip.outerHeight(FALSE), targetWidth = 0, targetHeight = 0, type = tooltip.css("position"), position = {
                            left: 0,
                            top: 0
                        }, visible = tooltip[0].offsetWidth > 0, isScroll = event && "scroll" === event.type, win = $(window), doc = container[0].ownerDocument, mouse = this.mouse;
                        if ($.isArray(target) && 2 === target.length)
                            ...
                            at = {
                                ...
                                !mouse || !mouse.pageX || !adjust.mouse && event && event.pageX ? event && event.pageX || ((!adjust.mouse || this.options.show.distance) && cache.origin && cache.origin.pageX ? event = cache.origin : event && (!event || "resize" !== event.type && "scroll" !== event.type) || (event = cache.event)) : event = mouse,
                            "static" !== type && (position = container.offset()),
                            doc.body.offsetWidth !== (window.innerWidth || doc.documentElement.clientWidth) && (offset = $(document.body).offset()),
                                position = {
                                    left: event.pageX - position.left + (offset && offset.left || 0),
                                    top: event.pageY - position.top + (offset && offset.top || 0)
                                },
                            adjust.mouse && isScroll && mouse && (position.left -= (mouse.scrollX || 0) - win.scrollLeft(),
                                position.top -= (mouse.scrollY || 0) - win.scrollTop());
                        else {
                            if ("event" === target ? event && event.target && "scroll" !== event.type && "resize" !== event.type ? cache.target = $(event.target) : event.target || (cache.target = this.elements.target) : "event" !== target && (cache.target = $(target.jquery ? target : this.elements.target)),
                                    target = cache.target,
                                    target = $(target).eq(0),
                                0 === target.length)
                                return this;
                            target[0] === document || target[0] === window ? (targetWidth = BROWSER.iOS ? window.innerWidth : target.width(),
                                targetHeight = BROWSER.iOS ? window.innerHeight : target.height(),
                            target[0] === window && (position = {
                                top: (viewport || target).scrollTop(),
                                left: (viewport || target).scrollLeft()
                            })) : PLUGINS.imagemap && target.is("area") ? pluginCalculations = PLUGINS.imagemap(this, target, at, PLUGINS.viewport ? method : FALSE) : PLUGINS.svg && target && target[0].ownerSVGElement ? pluginCalculations = PLUGINS.svg(this, target, at, PLUGINS.viewport ? method : FALSE) : (targetWidth = target.outerWidth(FALSE),
                                targetHeight = target.outerHeight(FALSE),
                                position = target.offset()),
                            pluginCalculations && (targetWidth = pluginCalculations.width,
                                targetHeight = pluginCalculations.height,
                                offset = pluginCalculations.offset,
                                position = pluginCalculations.position),
                                position = this.reposition.offset(target, position, container),
                            (BROWSER.iOS > 3.1 && BROWSER.iOS < 4.1 || BROWSER.iOS >= 4.3 && BROWSER.iOS < 4.33 || !BROWSER.iOS && "fixed" === type) && (position.left -= win.scrollLeft(),
                                position.top -= win.scrollTop()),
                            (!pluginCalculations || pluginCalculations && pluginCalculations.adjustable !== FALSE) && (position.left += at.x === RIGHT ? targetWidth : at.x === CENTER ? targetWidth / 2 : 0,
                                position.top += "bottom" === at.y ? targetHeight : at.y === CENTER ? targetHeight / 2 : 0)
                        }
                        return position.left += adjust.x + (my.x === RIGHT ? -tooltipWidth : my.x === CENTER ? -tooltipWidth / 2 : 0),
                            position.top += adjust.y + ("bottom" === my.y ? -tooltipHeight : my.y === CENTER ? -tooltipHeight / 2 : 0),
                            PLUGINS.viewport ? (position.adjusted = PLUGINS.viewport(this, position, posOptions, targetWidth, targetHeight, tooltipWidth, tooltipHeight),
                            offset && position.adjusted.left && (position.left += offset.left),
                            offset && position.adjusted.top && (position.top += offset.top)) : position.adjusted = {
                                left: 0,
                                top: 0
                            },
                            this._trigger("move", [position, viewport.elem || viewport], event) ? (delete position.adjusted,
                                effect === FALSE || !visible || isNaN(position.left) || isNaN(position.top) || "mouse" === target || !$.isFunction(posOptions.effect) ? tooltip.css(position) : $.isFunction(posOptions.effect) && (posOptions.effect.call(tooltip, this, $.extend({}, position)),
                    ...
                    PROTOTYPE.reposition.offset = function(elem, pos, container) {
                        ...
                        do {
                            "static" !== (position = $.css(parent, "position")) && ("fixed" === position ? (parentOffset = parent.getBoundingClientRect(),
                                scroll(ownerDocument, -1)) : (parentOffset = $(parent).position(),
                                parentOffset.left += parseFloat($.css(parent, "borderLeftWidth")) || 0,
                                parentOffset.top += parseFloat($.css(parent, "borderTopWidth")) || 0),
                                pos.left -= parentOffset.left + (parseFloat($.css(parent, "marginLeft")) || 0),
                                pos.top -= parentOffset.top + (parseFloat($.css(parent, "marginTop")) || 0),
                            scrolled || "hidden" === (overflow = $.css(parent, "overflow")) || "visible" === overflow || (scrolled = $(parent)))
                        } while (parent = parent.offsetParent);return scrolled && (scrolled[0] !== ownerDocument[0] || quirks) && scroll(scrolled, 1),
                            pos
                    }
                ;
                ...
                C.invert = function(z, center) {
                    ...
                    PROTOTYPE.toggle = function(state, event) {
                        ...
                        if (this.waiting && !state && (this.hiddenDuringWait = TRUE),
                                !this.rendered)
                            return state ? this.render(1) : this;
                        if (this.destroyed || this.disabled)
                            return this;
                        var identicalState, allow, after, type = state ? "show" : "hide", opts = this.options[type], posOptions = (this.options[state ? "hide" : "show"],
                            this.options.position), contentOptions = this.options.content, width = this.tooltip.css("width"), visible = this.tooltip.is(":visible"), animate = state || 1 === opts.target.length, sameTarget = !event || opts.target.length < 2 || cache.target[0] === event.target;
                        return (typeof state).search("boolean|number") && (state = !visible),
                            identicalState = !tooltip.is(":animated") && visible === state && sameTarget,
                            allow = identicalState ? NULL : !!this._trigger(type, [90]),
                            this.destroyed ? this : (allow !== FALSE && state && this.focus(event),
                                !allow || identicalState ? this : ($.attr(tooltip[0], "aria-hidden", !state),
                                    state ? (cache.origin = cloneEvent(this.mouse),
                                    $.isFunction(contentOptions.text) && this._updateContent(contentOptions.text, FALSE),
                                    $.isFunction(contentOptions.title) && this._updateTitle(contentOptions.title, FALSE),
                                    !trackingBound && "mouse" === posOptions.target && posOptions.adjust.mouse && ($(document).bind("mousemove." + NAMESPACE, this._storeMouse),
                                        trackingBound = TRUE),
                                    width || tooltip.css("width", tooltip.outerWidth(FALSE)),
                                        this.reposition(event, arguments[2]),
                                    width || tooltip.css("width", ""),
                                    opts.solo && ("string" == typeof opts.solo ? $(opts.solo) : $(SELECTOR, opts.solo)).not(tooltip).not(opts.target).qtip("hide", $.Event("tooltipsolo"))) : (clearTimeout(this.timers.show),
                                        delete cache.origin,
                                    trackingBound && !$(SELECTOR + '[tracking="true"]:visible', opts.solo).not(tooltip).length && ($(document).unbind("mousemove." + NAMESPACE),
                                        trackingBound = FALSE),
                                        this.blur(event)),
                                    after = $.proxy(function() {
                                        state ? (BROWSER.ie && tooltip[0].style.removeAttribute("filter"),
                                            tooltip.css("overflow", ""),
                                        "string" == typeof opts.autofocus && $(this.options.show.autofocus, tooltip).focus(),
                                            this.options.show.target.trigger("qtip-" + this.id + "-inactive")) : tooltip.css({
                                            display: "",
                                            visibility: "",
                                            opacity: "",
                                            left: "",
                                    ...
                                    opts.effect === FALSE || animate === FALSE ? (tooltip[type](),
                                        after()) : $.isFunction(opts.effect) ? (tooltip.stop(1, 1),
                                        opts.effect.call(tooltip, this),
                                        tooltip.queue("fx", function(n) {
                                            after(),
                                                n()
                                        })) : tooltip.fadeTo(90, state ? 1 : 0, after),
                                state && opts.target.trigger("qtip-" + this.id + "-inactive"),
                                    this))
                    }
                    ,
                    ...
                    PROTOTYPE.blur = function(event) {
                        return !this.rendered || this.destroyed ? this : (this.tooltip.removeClass(CLASS_FOCUS),
                            this._trigger("blur", [this.tooltip.css("zIndex")], event),
                            this)
                    }
                    ,
                    PROTOTYPE.disable = function(state) {
                        return this.destroyed ? this : ("toggle" === state ? state = !(this.rendered ? this.tooltip.hasClass(CLASS_DISABLED) : this.disabled) : "boolean" != typeof state && (state = TRUE),
                        this.rendered && this.tooltip.toggleClass(CLASS_DISABLED, state).attr("aria-disabled", state),
                            this.disabled = !!state,
                            this)
                    }
                    ,
                    ...
                    PROTOTYPE._createButton = function() {
                        ...
                        elements.button && elements.button.remove(),
                            button.jquery ? elements.button = button : elements.button = $("<a />", {
                            ...
                            elements.button.appendTo(elements.titlebar || tooltip).attr("role", "button").click(function(event) {
                                return tooltip.hasClass(CLASS_DISABLED) || self.hide(event),
                                    FALSE
                            })
                    }
                    ,
                    ...
                    PROTOTYPE._setWidget = function() {
                        ...
                        elements.content && elements.content.toggleClass(createWidgetClass("content"), on),
                        elements.titlebar && elements.titlebar.toggleClass(createWidgetClass("header"), on),
                        elements.button && elements.button.toggleClass(NAMESPACE + "-icon", !on)
                    }
                    ,
                ...
                $(function() {
                    delegate(SELECTOR, ["mouseenter", "mouseleave"], function(event) {
                        var state = "mouseenter" === event.type
                            ...
                            , options = this.options;
                        state ? (this.focus(event),
                        tooltip.hasClass(CLASS_FIXED) && !tooltip.hasClass(CLASS_DISABLED) && clearTimeout(this.timers.hide)) : "mouse" === options.position.target && options.hide.event && options.show.target && !target.closest(options.show.target[0]).length && this.hide(event),
                    ...
                    PROTOTYPE._trigger = function(type, args, event) {
                        ...
                        return callback.originalEvent = event && $.extend({}, event) || this.cache.event || NULL,
                    ...
                    PROTOTYPE._assignInitialEvents = function(event) {
                        ...
                        /mouse(over|enter)/i.test(options.show.event) && !/mouse(out|leave)/i.test(options.hide.event) && hideEvents.push("mouseleave"),
                    ...
                    PROTOTYPE._assignEvents = function() {
                        ...
                        "number" == typeof options.hide.inactive && (this._bind(showTarget, "qtip-" + this.id + "-inactive", inactiveMethod),
                        ...
                        (posOptions.adjust.resize || viewportTarget.length) && this._bind($.event.special.resize ? viewportTarget : windowTarget, "resize", repositionMethod),
                        posOptions.adjust.scroll && this._bind(windowTarget.add(posOptions.container), "scroll", repositionMethod)
                    }
                    ,
                    ...
                    QTIP = $.fn.qtip = function(options, notation, newValue) {
                        ...
                        return !arguments.length && opts || "api" === command ? opts : "string" == typeof options ? (this.each(function() {
                            ...
                            if (event && event.timeStamp && (api.cache.event = event),
                                !notation || "option" !== command && "options" !== command)
                                api[command] && api[command].apply(api, args);
                            else {
                                if (newValue === undefined && !$.isPlainObject(notation))
                                    return returned = api.get(notation),
                                        FALSE;
                                api.set(notation, newValue)
                            }
                        }),
                            returned !== NULL ? returned : this) : "object" != typeof options && arguments.length ? void 0 : (opts = sanitizeOptions($.extend(TRUE, {}, options)),
                            this.each(function(i) {
                                var api, id;
                                if (id = $.isArray(opts.id) ? opts.id[i] : opts.id,
                                        id = !id || id === FALSE || id.length < 1 || QTIP.api[id] ? QTIP.nextid++ : id,
                                    (api = init($(this), id, opts)) === FALSE)
                                    return TRUE;
                                QTIP.api[id] = api,
                                    $.each(PLUGINS, function() {
                    ...
                    $.each({
                        attr: function(attr, val) {
                            if (this.length) {
                                var self = this[0]
                                    , api = $.data(self, "qtip");
                                if ("title" === attr && api && "object" == typeof api && api.options.suppress)
                                    return arguments.length < 2 ? $.attr(self, oldtitle) : (api && "title" === api.options.content.attr && api.cache.attr && api.set("content.text", val),
                        ...
                        clone: function(keepData) {
                            var elems = ($([]),
                                $.fn.clone_replacedByqTip.apply(this, arguments));
                        ...
                        if (!func || $.fn[name + "_replacedByqTip"])
                            return TRUE;
                ...
                $.ui || ($.cleanData_replacedByqTip = $.cleanData,
                        $.cleanData = function(elems) {
                ...
                var TIP, MARGIN = "margin", BG_COLOR = "background-color", HASCANVAS = !!document.createElement("canvas").getContext, INVALID = /rgba?\(0, 0, 0(, 0)?\)|transparent|#123456/i, cssProps = {}, cssPrefixes = ["Webkit", "O", "Moz", "ms"];
                if (HASCANVAS)
                ...
                $.extend(Tip.prototype, {
                    init: function(qtip) {
                        ...
                        tip = this.element = qtip.elements.tip = $("<div />", {
                            ...
                            HASCANVAS ? (context = $("<canvas />").appendTo(this.element)[0].getContext("2d"),
                                context.lineJoin = "miter",
                                context.miterLimit = 1e5,
                                context.save()) : (context = createVML("shape", 'coordorigin="0,0"', "position:absolute;"),
                    ...
                    _parseCorner: function(corner) {
                        ...
                        return corner === FALSE || my === FALSE ? corner = FALSE : corner === TRUE ? corner = new CORNER(my.string()) : corner.string || (corner = new CORNER(corner),
                            corner.fixed = TRUE),
                            corner
                    },
                    ...
                    _parseColours: function(corner) {
                        var elements = this.qtip.elements
                            ...
                            , color = [];
                        return color[0] = css(tip, BG_COLOR) || css(colorElem, BG_COLOR) || css(elements.content, BG_COLOR) || css(elements.tooltip, BG_COLOR) || tip.css(BG_COLOR),
                    ...
                    _calculateSize: function(corner) {
                        var bigHyp, ratio, result, y = corner.precedance === Y, width = this.options.width, height = this.options.height, isCenter = "c" === corner.abbrev(), base = (y ? width : height) * (isCenter ? .5 : 1), pow = Math.pow, round = Math.round, smallHyp = Math.sqrt(pow(base, 2) + pow(height, 2)), hyp = [this.border / base * smallHyp, this.border / height * smallHyp];
                        return hyp[2] = Math.sqrt(pow(hyp[0], 2) - pow(this.border, 2)),
                            hyp[3] = Math.sqrt(pow(hyp[1], 2) - pow(this.border, 2)),
                            bigHyp = smallHyp + hyp[2] + hyp[3] + (isCenter ? 0 : hyp[0]),
                            ratio = bigHyp / smallHyp,
                            result = [round(ratio * width), round(ratio * height)],
                            y ? result : result.reverse()
                    },
                    ...
                    create: function() {
                        ...
                        return (this.enabled = !!this.corner && "c" !== this.corner.abbrev()) && (this.qtip.cache.corner = c.clone(),
                            this.update()),
                    ...
                    update: function(corner, position) {
                        if (!this.enabled)
                            return this;
                        var color, precedance, context, coords, bigCoords, translate, newSize, border, elements = this.qtip.elements, tip = this.element, inner = tip.children(), options = this.options, curSize = this.size, mimic = options.mimic, round = Math.round;
                        corner || (corner = this.qtip.cache.corner || this.corner),
                            mimic === FALSE ? mimic = corner : (mimic = new CORNER(mimic),
                                mimic.precedance = corner.precedance,
                                "inherit" === mimic.x ? mimic.x = corner.x : "inherit" === mimic.y ? mimic.y = corner.y : mimic.x === mimic.y && (mimic[corner.precedance] = corner[corner.precedance])),
                            precedance = mimic.precedance,
                            corner.precedance === X ? this._swapDimensions() : this._resetDimensions(),
                            color = this.color = this._parseColours(corner),
                            "transparent" !== color[1] ? (border = this.border = this._parseWidth(corner, corner[corner.precedance]),
                            options.border && border < 1 && !INVALID.test(color[1]) && (color[0] = color[1]),
                                this.border = border = options.border !== TRUE ? options.border : border) : this.border = border = 0,
                            ...
                            translate = corner.precedance === Y ? [round(mimic.x === LEFT ? border : mimic.x === RIGHT ? newSize[0] - curSize[0] - border : (newSize[0] - curSize[0]) / 2), round(mimic.y === TOP ? newSize[1] - curSize[1] : 0)] : [round(mimic.x === LEFT ? newSize[0] - curSize[0] : 0), round(mimic.y === TOP ? border : "bottom" === mimic.y ? newSize[1] - curSize[1] - border : (newSize[1] - curSize[1]) / 2)],
                            HASCANVAS ? (context = inner[0].getContext("2d"),
                                context.restore(),
                                context.save(),
                                ...
                                context.fill()) : (coords = this._calculateTip(mimic),
                                coords = "m" + coords[0] + "," + coords[1] + " l" + coords[2] + "," + coords[3] + " " + coords[4] + "," + coords[5] + " xe",
                                translate[2] = border && /^(r|b)/i.test(corner.string()) ? 8 === BROWSER.ie ? 2 : 1 : 0,
                                inner.css({
                                    ...
                                    !i && $this.html(createVML("stroke", 'weight="' + 2 * border + 'px" color="' + color[1] + '" miterlimit="1000" joinstyle="miter"'))
                                })),
                        ...
                        position !== FALSE && this.calculate(corner, newSize)
                    },
                    calculate: function(corner, size) {
                        if (!this.enabled)
                            return FALSE;
                        var precedance, corners, self = this, elements = this.qtip.elements, tip = this.element, userOffset = this.options.offset, position = (elements.tooltip.hasClass("ui-widget"),
                            {});
                        return corner = corner || this.corner,
                        ...
                        precedance === X && corners.reverse(),
                            $.each(corners, function(i, side) {
                                var b, bc, br;
                                side === CENTER ? (b = precedance === Y ? LEFT : TOP,
                                    position[b] = "50%",
                                    position[MARGIN + "-" + b] = -Math.round(size[precedance === Y ? 0 : 1] / 2) + userOffset) : (b = self._parseWidth(corner, side, elements.tooltip),
                    ...
                    reposition: function(event, api, pos, viewport) {
                        ...
                        function shiftonly(xy, side, opposite) {
                            newCorner[xy] === CENTER ? css[MARGIN + "-" + side] = shift[xy] = offset[MARGIN + "-" + side] - adjust[side] : (props = offset[opposite] !== undefined ? [adjust[side], -offset[side]] : [-adjust[side], offset[side]],
                            (shift[xy] = Math.max(props[0], props[1])) > props[0] && (pos[side] -= adjust[side],
                                shift[side] = FALSE),
                                css[offset[opposite] !== undefined ? opposite : side] = shift[xy])
                        }
                        if (this.enabled) {
                            var offset, props, cache = api.cache, newCorner = this.corner.clone(), adjust = pos.adjusted, method = api.options.position.adjust.method.split(" "), horizontal = method[0], vertical = method[1] || method[0], shift = {
                                left: FALSE,
                                top: FALSE,
                                x: 0,
                                y: 0
                            }, css = {};
                            this.corner.fixed !== TRUE && (shiftflip(horizontal, X, Y, LEFT, RIGHT),
                                shiftflip(vertical, Y, X, TOP, "bottom"),
                            newCorner.string() === cache.corner.string() || cache.cornerTop === adjust.top && cache.cornerLeft === adjust.left || this.update(newCorner, FALSE)),
                                offset = this.calculate(newCorner),
                            offset.right !== undefined && (offset.left = -offset.right),
                            offset.bottom !== undefined && (offset.top = -offset.bottom),
                                offset.user = this.offset,
                            (shift.left = horizontal === SHIFT && !!adjust.left) && shiftonly(X, LEFT, RIGHT),
                ...
                OVERLAY = function() {
                    function focusable(element) {
                        ...
                        var map, mapName, img, isTabIndexNotNaN = !isNaN($.attr(element, "tabindex")), nodeName = element.nodeName && element.nodeName.toLowerCase();
                        return "area" === nodeName ? (map = element.parentNode,
                            mapName = map.name,
                        !(!element.href || !mapName || "map" !== map.nodeName.toLowerCase()) && (!!(img = $("img[usemap=#" + mapName + "]")[0]) && img.is(":visible"))) : /input|select|textarea|button|object/.test(nodeName) ? !element.disabled : "a" === nodeName ? element.href || isTabIndexNotNaN : isTabIndexNotNaN
                    }
                    ...
                    function stealFocus(event) {
                        if (elem.is(":visible")) {
                            var targetOnTop, target = $(event.target), tooltip = current.tooltip, container = target.closest(SELECTOR);
                            targetOnTop = container.length < 1 ? FALSE : parseInt(container[0].style.zIndex, 10) > parseInt(tooltip[0].style.zIndex, 10),
                            targetOnTop || target.closest(SELECTOR)[0] === tooltip[0] || focusInputs(target),
                    ...
                    $.extend(self, {
                        init: function() {
                            return elem = self.elem = $("<div />", {
                                ...
                                $(document.body).bind("focusin.qtip-modal", stealFocus),
                                $(document).bind("keydown.qtip-modal", function(event) {
                        ...
                        update: function(api) {
                            current = api,
                                focusableElems = api.options.show.modal.stealfocus !== FALSE ? api.tooltip.find("*").filter(function() {
                                    return focusable(this)
                                }) : []
                        },
                        toggle: function(api, state, duration) {
                            var tooltip = ($(document.body),
                                api.tooltip)
                            ...
                            return self.update(api),
                            state && options.stealfocus !== FALSE && focusInputs($(":focus")),
                                elem.toggleClass("blurs", options.blur),
                            state && elem.appendTo(document.body),
                                elem.is(":animated") && visible === state && prevState !== FALSE || !state && visibleModals.length ? self : (elem.stop(TRUE, FALSE),
                                    $.isFunction(effect) ? effect.call(elem, state) : effect === FALSE ? elem[type]() : elem.fadeTo(parseInt(duration, 10) || 90, state ? 1 : 0, function() {
                                        state || elem.hide()
                                    }),
                                state || elem.queue(function(next) {
                                    ...
                                    $(".qtip-modal").length || elem.detach(),
                                        next()
                                }),
                                    prevState = state,
                                current.destroyed && (current = NULL),
                                    self)
                        }
                    }),
                        self.init()
                    ...
                    $.extend(Modal.prototype, {
                        init: function(qtip) {
                            ...
                            qtip.elements.overlay = OVERLAY.elem,
                                tooltip.addClass("qtip-modal").css("z-index", QTIP.modal_zindex + $(".qtip-modal").length),
                                qtip._bind(tooltip, ["tooltipshow", "tooltiphide"], function(event, api, duration) {
                                    var oEvent = event.originalEvent;
                                    if (event.target === tooltip[0])
                                        if (oEvent && "tooltiphide" === event.type && /mouse(leave|enter)/.test(oEvent.type) && $(oEvent.relatedTarget).closest(OVERLAY.elem[0]).length)
                                            try {
                                                event.preventDefault()
                                            } catch (e) {}
                                        else
                                            (!oEvent || oEvent && "tooltipsolo" !== oEvent.type) && this.toggle(event, "tooltipshow" === event.type, duration)
                                }, this._ns, this),
                                qtip._bind(tooltip, "tooltipfocus", function(event, api) {
                                    if (!event.isDefaultPrevented() && event.target === tooltip[0]) {
                                        var qtips = $(".qtip-modal")
                        ...
                        destroy: function() {
                            this.qtip.tooltip.removeClass("qtip-modal"),
                                this.qtip._unbind(this.qtip.tooltip, this._ns),
                    ...
                    PLUGINS.viewport = function(api, position, posOptions, targetWidth, targetHeight, elemWidth, elemHeight) {
                        function calculate(side, otherSide, type, adjust, side1, side2, lengthName, targetLength, elemLength) {
                            ...
                            return isShift ? (offset = (mySide === side1 ? 1 : -1) * myLength,
                                position[side1] += overflow1 > 0 ? overflow1 : overflow2 > 0 ? -overflow2 : 0,
                                position[side1] = Math.max(-containerOffset[side1] + viewportOffset[side1], initialPos - offset, Math.min(Math.max(-containerOffset[side1] + viewportOffset[side1] + (lengthName === WIDTH ? viewportWidth : viewportHeight), initialPos + offset), position[side1], "center" === mySide ? initialPos - myLength : 1e9))) : (adjust *= type === FLIPINVERT ? 2 : 0,
                                overflow1 > 0 && (mySide !== side1 || overflow2 > 0) ? (position[side1] -= offset + adjust,
                                    newMy.invert(side, side1)) : overflow2 > 0 && (mySide !== side2 || overflow1 > 0) && (position[side1] -= (mySide === CENTER ? -offset : offset) + adjust,
                                    newMy.invert(side, side2)),
                            position[side1] < viewportScroll && -position[side1] > overflow2 && (position[side1] = initialPos,
                                newMy = my.clone())),
                            position[side1] - initialPos
                        }
                        var fixed, newMy, newClass, containerOffset, containerStatic, viewportWidth, viewportHeight, viewportScroll, viewportOffset, target = posOptions.target, tooltip = api.elements.tooltip, my = posOptions.my, at = posOptions.at, adjust = posOptions.adjust, method = adjust.method.split(" "), methodX = method[0], methodY = method[1] || method[0], viewport = posOptions.viewport, container = posOptions.container, cache = api.cache, adjusted = {
                            left: 0,
                            top: 0
                        };
                        return viewport.jquery && target[0] !== window && target[0] !== document.body && "none" !== adjust.method ? (containerOffset = container.offset() || adjusted,
                            containerStatic = "static" === container.css("position"),
                        ...
                        "shift" === methodX && "shift" === methodY || (newMy = my.clone()),
                            adjusted = {
                        ...
                        newMy && cache.lastClass !== (newClass = NAMESPACE + "-pos-" + newMy.abbrev()) && tooltip.removeClass(api.cache.lastClass).addClass(api.cache.lastClass = newClass),
                            adjusted) : adjusted
                    }
                    ,
                    PLUGINS.polys = {
                        polygon: function(baseCoords, corner) {
                            ...
                            for (i = baseCoords.length; i--; )
                                ...
                                next[0] > result.position.right && (result.position.right = next[0]),
                                next[0] < result.position.left && (result.position.left = next[0]),
                                next[1] > result.position.bottom && (result.position.bottom = next[1]),
                                next[1] < result.position.top && (result.position.top = next[1]),
                                    coords.push(next);
                            if (newWidth = result.width = Math.abs(result.position.right - result.position.left),
                                ...
                                for (; newWidth > 0 && newHeight > 0 && compareX > 0 && compareY > 0; )
                                    for (newWidth = Math.floor(newWidth / 2),
                                             newHeight = Math.floor(newHeight / 2),
                                             corner.x === LEFT ? compareX = newWidth : corner.x === RIGHT ? compareX = result.width - newWidth : compareX += Math.floor(newWidth / 2),
                                             corner.y === TOP ? compareY = newHeight : "bottom" === corner.y ? compareY = result.height - newHeight : compareY += Math.floor(newHeight / 2),
                                             i = coords.length; i-- && !(coords.length < 2); )
                                        realX = coords[i][0] - result.position.left,
                                            realY = coords[i][1] - result.position.top,
                                        (corner.x === LEFT && realX >= compareX || corner.x === RIGHT && realX <= compareX || corner.x === CENTER && (realX < compareX || realX > result.width - compareX) || corner.y === TOP && realY >= compareY || "bottom" === corner.y && realY <= compareY || corner.y === CENTER && (realY < compareY || realY > result.height - compareY)) && coords.splice(i, 1);
                                result.position = {
                                    left: coords[0][0],
                                    top: coords[0][1]
                                }
                        ...
                        ellipse: function(cx, cy, rx, ry, corner) {
                            var c = PLUGINS.polys._angles[corner.abbrev()]
                                , rxc = 0 === c ? 0 : rx * Math.cos(c * Math.PI)
                    ...
                    PLUGINS.svg = function(api, svg, corner) {
                        for (var rootWidth, rootHeight, mtx, transformed, viewBox, len, next, i, points, result, position, doc = $(document), elem = svg[0], root = $(elem.ownerSVGElement), xScale = 1, yScale = 1, complex = !0; !elem.getBBox; )
                        ...
                        switch (strokeWidth2 && (xScale += strokeWidth2 / rootWidth,
                        ...
                        return position = result.position,
                            root = root[0],
                        complex && (root.createSVGPoint && (mtx = elem.getScreenCTM(),
                        ...
                        root.viewBox && (viewBox = root.viewBox.baseVal) && viewBox.width && viewBox.height && (xScale *= rootWidth / viewBox.width,
                    ...
                    PLUGINS.imagemap = function(api, area, corner, adjustMethod) {
                        ...
                        var imageOffset, coords, i, result, len, shape = area.attr("shape").toLowerCase().replace("poly", "polygon"), image = $('img[usemap="#' + area.parent("map").attr("name") + '"]'), coordsString = $.trim(area.attr("coords")), coordsArray = coordsString.replace(/,$/, "").split(",");
                        if (!image.length)
                            return FALSE;
                        if ("polygon" === shape)
                            result = PLUGINS.polys.polygon(coordsArray, corner);
                        else {
                            if (!PLUGINS.polys[shape])
                                return FALSE;
                            for (i = -1,
                        ...
                        return imageOffset = image.offset(),
                ...
                $.extend(Ie6.prototype, {
                    ...
                    init: function(qtip) {
                        var tooltip = qtip.tooltip;
                        $("select, object").length < 1 && (this.bgiframe = qtip.elements.bgiframe = $('<iframe class="qtip-bgiframe" frameborder="0" tabindex="-1" src="javascript:\'\';"  style="display:block; position:absolute; z-index:-1; filter:alpha(opacity=0); -ms-filter:"progid:DXImageTransform.Microsoft.Alpha(Opacity=0)";"></iframe>').appendTo(tooltip),
                            qtip._bind(tooltip, "tooltipmove", this.adjustBGIFrame, this._ns, this)),
                            this.redrawContainer = $("<div/>", {
                                id: NAMESPACE + "-rcontainer"
                            }).appendTo(document.body),
                        qtip.elements.overlay && qtip.elements.overlay.addClass("qtipmodal-ie6fix") && (qtip._bind(window, ["scroll", "resize"], this._scroll, this._ns, this),
                            qtip._bind(tooltip, ["tooltipshow"], this._scroll, this._ns, this)),
                            this.redraw()
                    },
                    adjustBGIFrame: function() {
                        var tipAdjust, offset, tooltip = this.qtip.tooltip, dimensions = {
                        ...
                        plugin && tip && (tipAdjust = "x" === plugin.corner.precedance ? [WIDTH, LEFT] : ["height", TOP],
                    ...
                    redraw: function() {
                        if (this.qtip.rendered < 1 || this.drawing)
                            return this;
                        var perc, width, max, min, tooltip = this.qtip.tooltip, style = this.qtip.options.style, container = this.qtip.options.position.container;
                        return this.qtip.drawing = 1,
                        style.height && tooltip.css("height", style.height),
                            style.width ? tooltip.css(WIDTH, style.width) : (tooltip.css(WIDTH, "").appendTo(this.redrawContainer),
                                width = tooltip.width(),
                            width % 2 < 1 && (width += 1),
        ...
        dialogHelper__.initDialogs = function() {
            jQuery.extend({
                Dialog: {
                    alert: function(content, fn, icon) {
                        fn && !jQuery.isFunction(fn) && (icon = fn),
                        "error" == icon && (icon = 2),
                        "ask" == icon && (icon = 3),
                        "ok" == icon && (icon = 1),
                        "smiley" == icon && (icon = 1);
                        ...
                        icon && (conf.icon = icon),
                            ...
                            top.layer.alert(content, conf, function(index) {
                                fn && jQuery.isFunction(fn) && fn(),
                                top && top.layer && top.layer.close(index),
                                    layer.close(index)
                            })
                    },
                    ...
                    open: function(conf) {
                        !0 === conf.btn && (conf.btn = ["确定", "取消"],
                        conf.ok || alert("确定btn 没有回调？"));
                        var iframeId, height = conf.height, width = conf.width, title = conf.title, url = conf.url, openWindow = conf.topOpen ? top : window;
                        if (url) {
                            url = dialogHelper__.getProjectUrl(url),
                                conf.type = 1,
                                iframeId = "dialogId_" + Math.random(1e3);
                        ...
                        if (!conf.type)
                            return jQuery.Dialog.msg("请设置访问地址!或者指定对话框类型"),
                                !1;
                        height || (height = jQuery(openWindow).height(),
                        ...
                        width || (width = 600),
                            ...
                            height += "",
                            width += "",
                        -1 == height.indexOf("%") && (height += "px"),
                        -1 == width.indexOf("%") && (width += "px");
                        var dialogConf = {
                            title: title,
                            maxmin: !1,
                            closeBtn: 1,
                        ...
                        if (openWindow.layerIndexRecord || (openWindow.layerIndexRecord = []),
                            ...
                            conf.passData && (contentWindow.passData = conf.passData)
                        }
                    },
                    close: function(obj) {
                        var openner = parent;
                        ...
                        var openner = openner.layerIndexRecord ? openner : top
                            , index = openner.layerIndexRecord.pop();
                ...
                Toast: {
                    warning: function(content, title, openner) {
                        openner || (openner = top.toastr ? top : window),
            ...
            dialogHelper__.init = function() {
                jQuery("body").delegate("[openDialog]", "click", function() {
                    ...
                    dialogConf ? (-1 == dialogConf.indexOf("{") && (dialogConf = "{" + dialogConf + "}"),
                        dialogConf = eval("(" + dialogConf + ")"),
                        conf.height = dialogConf.height,
                        conf.width = dialogConf.width) : conf.height = 0;
            ...
            dialogHelper__.getUrl = function(obj) {
                ...
                return url ? ("http://" != url.substr(0, 7) && -1 == url.indexOf("html") && (url += ".html"),
                -1 != url.indexOf("?") && (url = url.format(jQuery.getParams())),
                    url) : ""
            }
            ,
            dialogHelper__.initCustDialogs = function() {
                window.CustUtil = {
                    openCustDialog: function(key, param, callBack, initData, dialogSetting, closeDialog) {
                        jQuery.isFunction(param) && (dialogSetting = initData,
                            initData = callBack,
                            callBack = param,
                            param = {}),
                        callBack || (callBack = function(data, innerwin) {
                        ...
                        jQuery.post(__ctx + "/form/formCustDialog/getObject?key=" + key, {}, function(result) {
                            ...
                            if (!dialogConf)
                                return void jQuery.Dialog.error("对话框查找不到" + key);
                            conf.height = dialogConf.height,
                            ...
                            "tree" === dialogConf.style && (conf.url = "/form/formCustDialog/formCustDialogShowTree.html?key=" + key),
                                jQuery.Dialog.open(conf)
                        }, "json"),
                            conf.ok = function(index, innerWindow) {
                                callBack(innerWindow.getData(), innerWindow),
                                closeDialog && jQuery.Dialog.close(innerWindow)
                            }
                    },
                    doCustQuery: function(key, param, callBack, dialogSetting) {
                        jQuery.isFunction(param) && (dialogSetting = callBack,
                            callBack = param,
                            param = {}),
                        param || (param = {}),
                        ...
                        param && jQuery.each(dialog.conditionFields, function(index, field) {
                            jQuery.each(param, function(key, val) {
                                if (key === field.columnName) {
                                    ...
                                    "varchar" === field.dbType && (id += "V"),
                                    "number" === field.dbType && (id += "N"),
                                    "date" === field.dbType && (id += "D"),
                                        id += field.condition,
                                        param[id] = val
                                }
                            })
            ...
            void 0 !== (__WEBPACK_AMD_DEFINE_RESULT__ = function(e) {
                return function() {
                    ...
                    function f(t) {
                        ...
                        if (void 0 !== t.optionsOverride && (r = e.extend(r, t.optionsOverride),
                ...
                msg: function(a, d, g) {
                    ...
                    return i && (g = d),
                        f.open(c.extend({
                            ...
                            return d = d || {},
                            (-1 === d.icon || void 0 === d.icon && !e.config.skin) && (d.skin = k + " " + (d.skin || "layui-layer-hui")),
                                d
                        }()))
                },
                load: function(a, b) {
        ...
        !function() {
            ...
            var isLayui = window.layui && layui.define
                ...
                getPath: function() {
                    var jsPath = document.currentScript ? document.currentScript.src : function() {
                        for (var src, js = document.scripts, last = js.length - 1, i = last; i > 0; i--)
                            if ("interactive" === js[i].readyState) {
                                src = js[i].src;
                                break
                            }
                ...
                link: function(href, fn, cssname) {
                    ...
                    if (laydate.path) {
                        ...
                        link.rel = "stylesheet",
                            ...
                            link.id = id,
                        document.getElementById(id) || head.appendChild(link),
                ...
                set: function(options) {
                    var that = this;
                    return that.config = lay.extend({}, that.config, options),
                        that
                },
                ready: function(fn) {
                    var path = (isLayui ? "modules/laydate/" : "theme/") + "default/laydate.css?v=" + laydate.v;
                    return isLayui ? layui.addcss(path, fn, "laydate") : ready.link(path, fn, "laydate"),
                        this
                }
            }
                , thisDate = function() {
                ...
                , LAY = function(selector) {
                for (var index = 0, nativeDOM = "object" == typeof selector ? [selector] : (this.selector = selector,
                    document.querySelectorAll(selector || null)); index < nativeDOM.length; index++)
            ...
            LAY.prototype = [],
                ...
                lay.extend = function() {
                    ...
                    for (args[0] = "object" == typeof args[0] ? args[0] : {}; ai < args.length; ai++)
                        "object" == typeof args[ai] && clone(args[0], args[ai]);
                    return args[0]
                }
                ,
                lay.ie = function() {
                ...
                lay.each = function(obj, fn) {
                    ...
                    if (obj = obj || [],
                        ...
                        for (key = 0; key < obj.length && !fn.call(obj[key], key, obj[key]); key++)
                            ;
                    return that
                }
                ,
                ...
                LAY.prototype.find = function(selector) {
                    var that = this
                        , index = 0
                        , arr = []
                        , isObject = "object" == typeof selector;
                    return this.each(function(i, item) {
                        for (var nativeDOM = isObject ? [selector] : item.querySelectorAll(selector || null); index < nativeDOM.length; index++)
                            arr.push(nativeDOM[index]);
                        that.shift()
                    }),
                    isObject || (that.selector = (that.selector ? that.selector + " " : "") + selector),
                ...
                Class.prototype.init = function() {
                    var that = this
                        ...
                        , isStatic = "static" === options.position
                        , format = {
                        year: "yyyy",
                        month: "yyyy-MM",
                        date: "yyyy-MM-dd",
                    ...
                    options.elem[0] && (!0 === options.range && (options.range = "-"),
                    options.format === format.date && (options.format = format[options.type]),
                    ...
                    that.isInput(options.elem[0]) || "focus" === options.trigger && (options.trigger = "click"),
                    options.elem.attr("lay-key") || (options.elem.attr("lay-key", that.index),
                        options.eventElem.attr("lay-key", that.index)),
                        options.mark = lay.extend({}, options.calendar && "cn" === options.lang ? {
                            "0-1-1": "元旦",
                            "0-2-14": "情人",
                            "0-3-8": "妇女",
                            "0-3-12": "植树",
                        ...
                        lay.each(["min", "max"], function(i, item) {
                            ...
                            if ("number" == typeof options[item]) {
                                ...
                                day < 864e5 || (hms = [thisDate.getHours(), thisDate.getMinutes(), thisDate.getSeconds()])
                            } else
                    ...
                    (options.show || isStatic) && that.render(),
                    isStatic || that.events(),
                    options.value && (options.value.constructor === Date ? that.setValue(that.parse(0, that.systemDate(options.value))) : that.setValue(options.value)))
                }
                ,
                Class.prototype.render = function() {
                    ...
                    if (options.zIndex && (elem.style.zIndex = options.zIndex),
                            ...
                            lay(divFooter).html(function() {
                                var html = []
                                    , btns = [];
                                return "datetime" === options.type && html.push('<span lay-type="datetime" class="laydate-btns-time">' + lang.timeTips + "</span>"),
                                    lay.each(options.btns, function(i, item) {
                                        var title = lang.tools[item] || "btn";
                                        options.range && "now" === item || (isStatic && "clear" === item && (title = "cn" === options.lang ? "重置" : "Reset"),
                        ...
                        "styleSheet"in style ? (style.setAttribute("type", "text/css"),
                            style.styleSheet.cssText = styleText) : style.innerHTML = styleText,
                    ...
                    "function" == typeof options.ready && options.ready(lay.extend({}, options.dateTime, {
                ...
                Class.prototype.position = function() {
                    var that = this
                        ...
                        return type = type ? "scrollLeft" : "scrollTop",
                        document.body[type] | document.documentElement[type]
                    }
                        ...
                        , left = rect.left
                        , top = rect.bottom;
                    left + elemWidth + 5 > winArea("width") && (left = winArea("width") - elemWidth - 5),
                    top + elemHeight + 5 > winArea() && (top = rect.top > elemHeight ? rect.top - elemHeight : winArea() - elemHeight,
                        top -= 10),
                    options.position && (that.elem.style.position = options.position),
                        that.elem.style.left = left + ("fixed" === options.position ? 0 : scrollArea(1)) + "px",
                        that.elem.style.top = top + ("fixed" === options.position ? 0 : scrollArea()) + "px"
                }
                ,
                ...
                Class.prototype.checkDate = function(fn) {
                    var thisMaxDate, error, that = this, options = (new Date,
                        that.config), dateTime = options.dateTime = options.dateTime || that.systemDate(), elem = that.bindElem || options.elem[0], value = (that.isInput(elem),
                        that.isInput(elem) ? elem.value : "static" === options.position ? "" : elem.innerHTML), checkValid = function(dateTime) {
                        dateTime.year > LIMIT_YEAR[1] && (dateTime.year = LIMIT_YEAR[1],
                            error = !0),
                        dateTime.month > 11 && (dateTime.month = 11,
                            error = !0),
                        dateTime.hours > 23 && (dateTime.hours = 0,
                            error = !0),
                        dateTime.minutes > 59 && (dateTime.minutes = 0,
                            dateTime.hours++,
                            error = !0),
                        dateTime.seconds > 59 && (dateTime.seconds = 0,
                            dateTime.minutes++,
                            error = !0),
                            thisMaxDate = laydate.getEndDate(dateTime.month + 1, dateTime.year),
                        dateTime.date > thisMaxDate && (dateTime.date = thisMaxDate,
                            error = !0)
                    }, initDate = function(dateTime, value, index) {
                        var startEnd = ["startTime", "endTime"];
                        value = (value.match(that.EXP_SPLIT) || []).slice(1),
                            index = index || 0,
                        options.range && (that[startEnd[index]] = that[startEnd[index]] || {}),
                            lay.each(that.format, function(i, item) {
                                var thisv = parseFloat(value[i]);
                                value[i].length < item.length && (error = !0),
                                    /yyyy|y/.test(item) ? (thisv < LIMIT_YEAR[0] && (thisv = LIMIT_YEAR[0],
                                        error = !0),
                                        dateTime.year = thisv) : /MM|M/.test(item) ? (thisv < 1 && (thisv = 1,
                                        error = !0),
                                        dateTime.month = thisv - 1) : /dd|d/.test(item) ? (thisv < 1 && (thisv = 1,
                                        error = !0),
                                        dateTime.date = thisv) : /HH|H/.test(item) ? (thisv < 1 && (thisv = 0,
                                        error = !0),
                                        dateTime.hours = thisv,
                                    options.range && (that[startEnd[index]].hours = thisv)) : /mm|m/.test(item) ? (thisv < 1 && (thisv = 0,
                                        error = !0),
                                        dateTime.minutes = thisv,
                                    options.range && (that[startEnd[index]].minutes = thisv)) : /ss|s/.test(item) && (thisv < 1 && (thisv = 0,
                                        error = !0),
                    ...
                    return "limit" === fn ? (checkValid(dateTime),
                        that) : (value = value || options.value,
                    "string" == typeof value && (value = value.replace(/\s+/g, " ").replace(/^\s|\s$/g, "")),
                    that.startState && !that.endState && (delete that.startState,
                        that.endState = !0),
                        "string" == typeof value && value ? that.EXP_IF.test(value) ? options.range ? (value = value.split(" " + options.range + " "),
                            that.startDate = that.startDate || that.systemDate(),
                            that.endDate = that.endDate || that.systemDate(),
                            options.dateTime = lay.extend({}, that.startDate),
                            lay.each([that.startDate, that.endDate], function(i, item) {
                                initDate(item, value[i], i)
                            })) : initDate(dateTime, value) : (that.hint("日期格式不合法<br>必须遵循下述格式：<br>" + (options.range ? options.format + " " + options.range + " " + options.format : options.format) + "<br>已为你重置"),
                            error = !0) : value && value.constructor === Date ? options.dateTime = that.systemDate(value) : (options.dateTime = that.systemDate(),
                            ...
                            delete that.endTime),
                        checkValid(dateTime),
                    error && value && that.setValue(options.range ? that.endDate ? that.parse() : "" : that.parse()),
                    fn && fn(),
                        that)
                }
                ,
                ...
                Class.prototype.limit = function(elem, date, index, time) {
                    var isOut, that = this, options = that.config, timestrap = {}, dateTime = options[index > 41 ? "endDate" : "dateTime"], thisDateTime = lay.extend({}, dateTime, date || {});
                    return lay.each({
                        now: thisDateTime,
                        min: options.min,
                        max: options.max
                ...
                Class.prototype.calendar = function(value) {
                    var startWeek, prevMaxDate, thisMaxDate, that = this, options = that.config, dateTime = value || options.dateTime, thisDate = new Date, lang = that.lang(), isAlone = "date" !== options.type && "datetime" !== options.type, index = value ? 1 : 0, tds = lay(that.table[index]).find("td"), elemYM = lay(that.elemHeader[index][2]).find("span");
                    if (dateTime.year < LIMIT_YEAR[0] && (dateTime.year = LIMIT_YEAR[0],
                            that.hint("最低只能支持到公元" + LIMIT_YEAR[0] + "年")),
                        dateTime.year > LIMIT_YEAR[1] && (dateTime.year = LIMIT_YEAR[1],
                            that.hint("最高只能支持到公元" + LIMIT_YEAR[1] + "年")),
                        that.firstDate || (that.firstDate = lay.extend({}, dateTime)),
                            ...
                            lay.each(tds, function(index, item) {
                                ...
                                item = lay(item),
                                    ...
                                    index < startWeek ? (st = prevMaxDate - startWeek + index,
                                        item.addClass("laydate-day-prev"),
                                        YMD = that.getAsYM(dateTime.year, dateTime.month, "sub")) : index >= startWeek && index < thisMaxDate + startWeek ? (st = index - startWeek,
                                    options.range || st + 1 === dateTime.date && item.addClass(THIS)) : (st = index - thisMaxDate - startWeek,
                            ...
                            "cn" === options.lang ? (lay(elemYM[0]).attr("lay-type", "year").html(dateTime.year + "年"),
                                lay(elemYM[1]).attr("lay-type", "month").html(dateTime.month + 1 + "月")) : (lay(elemYM[0]).attr("lay-type", "month").html(lang.month[dateTime.month]),
                                lay(elemYM[1]).attr("lay-type", "year").html(dateTime.year)),
                        isAlone && (options.range && (value ? that.endDate = that.endDate || {
                        ...
                        value && (that.listYM = [[that.startDate.year, that.startDate.month + 1], [that.endDate.year, that.endDate.month + 1]],
                            that.list(options.type, 0).list(options.type, 1),
                            "time" === options.type ? that.setBtnStatus("时间", lay.extend({}, that.systemDate(), that.startTime), lay.extend({}, that.systemDate(), that.endTime)) : that.setBtnStatus(!0))),
                        options.range || (that.listYM = [[dateTime.year, dateTime.month + 1]],
                    ...
                    return options.range || that.limit(lay(that.footer).find(ELEM_CONFIRM), null, 0, ["hours", "minutes", "seconds"]),
                    options.range && value && !isAlone && that.stampRange(),
                        that
                }
                ,
                Class.prototype.list = function(type, index) {
                    var that = this
                        ...
                        , lang = that.lang()
                        , isAlone = options.range && "date" !== options.type && "datetime" !== options.type
                        , ul = lay.elem("ul", {
                        class: ELEM_LIST + " " + {
                    ...
                    if (listYM[0] < 1 && (listYM[0] = 1),
                        ...
                        startY < 1 && (startY = yearNum = 1),
                            lay.each(new Array(15), function(i) {
                                ...
                                yearNum == listYM[0] && lay(li).addClass(THIS),
                                    ...
                                    ul.appendChild(li),
                                    yearNum < that.firstDate.year ? (ymd.month = options.min.month,
                                        ymd.date = options.min.date) : yearNum >= that.firstDate.year && (ymd.month = options.max.month,
                        ...
                        lay.each(new Array(12), function(i) {
                            ...
                            i + 1 == listYM[1] && lay(li).addClass(THIS),
                                ...
                                ul.appendChild(li),
                                listYM[0] < that.firstDate.year ? ymd.date = options.min.date : listYM[0] >= that.firstDate.year && (ymd.date = options.max.date),
                                that.limit(lay(li), ymd, index)
                        }),
                    ...
                    if (haveList && elemCont.removeChild(haveList),
                        ...
                        lay(that.elemMain[index]).addClass("laydate-ym-show"),
                            lay(ul).find("li").on("click", function() {
                                ...
                                if (!lay(this).hasClass(DISABLED)) {
                                    if (0 === index)
                                        dateTime[type] = ym,
                                        isAlone && (that.startDate[type] = ym),
                                    ...
                                    "year" === options.type || "month" === options.type ? (lay(ul).find("." + THIS).removeClass(THIS),
                                        lay(this).addClass(THIS),
                                    "month" === options.type && "year" === type && (that.listYM[index][0] = ym,
                                    isAlone && (that[["startDate", "endDate"][index]].year = ym),
                                        that.list("month", index))) : (that.checkDate("limit").calendar(),
                                        that.closeList()),
                                        that.setBtnStatus(),
                                    options.range || that.done(null, "change"),
                                        lay(that.footer).find(".laydate-btns-time").removeClass(DISABLED)
                                }
                            });
                    else {
                        var span = lay.elem("span", {
                            class: "laydate-time-text"
                        })
                            , scroll = function() {
                            lay(ul).find("ol").each(function(i) {
                                ...
                                ol.scrollTop <= 0 && li.each(function(ii, item) {
                                    if (!lay(this).hasClass(DISABLED))
                                        return ol.scrollTop = 30 * (ii - 2),
                                            !0
                                })
                            })
                        }
                        ...
                        haveSpan[0] && haveSpan.remove(),
                            elemHeader[2].appendChild(span),
                            lay(ul).find("ol").each(function(i) {
                                var ol = this;
                                lay(ol).find("li").on("click", function() {
                                    var value = 0 | this.innerHTML;
                                    lay(this).hasClass(DISABLED) || (options.range ? that[startEnd][hms[i]] = value : dateTime[hms[i]] = value,
                                        lay(ol).find("." + THIS).removeClass(THIS),
                                        lay(this).addClass(THIS),
                                        setTimeStatus(),
                                        scroll(),
                                    (that.endDate || "time" === options.type) && that.done(null, "change"),
                                        that.setBtnStatus())
                                })
                            })
                    }
                ...
                Class.prototype.setBtnStatus = function(tips, start, end) {
                    ...
                    options.range && "date" !== options.type && "time" !== options.type && (start = start || that.startDate,
                    ...
                    tips && isOut && that.hint("string" == typeof tips ? TIPS_OUT.replace(/日期/g, tips) : TIPS_OUT))
                }
                ,
                ...
                Class.prototype.newDate = function(dateTime) {
                    return dateTime = dateTime || {},
                        new Date(dateTime.year || 1,dateTime.month || 0,dateTime.date || 1,dateTime.hours || 0,dateTime.minutes || 0,dateTime.seconds || 0)
                }
                ,
                Class.prototype.setValue = function(value) {
                    ...
                    return "static" === options.position || lay(elem)[valType](value || ""),
                        this
                }
                ,
                Class.prototype.stampRange = function() {
                    ...
                    if (options.range && !that.endDate && lay(that.footer).find(ELEM_CONFIRM).addClass(DISABLED),
                        ...
                        lay.each(tds, function(i, item) {
                            ...
                            lay(item).removeClass("laydate-selected " + THIS),
                            thisTime !== startTime && thisTime !== endTime || lay(item).addClass(lay(item).hasClass("laydate-day-prev") || lay(item).hasClass("laydate-day-next") ? "laydate-selected" : THIS),
                            thisTime > startTime && thisTime < endTime && lay(item).addClass("laydate-selected")
                        })
                    }
                }
                ,
                Class.prototype.done = function(param, type) {
                    ...
                    return lay.each([start, end], function(i, item) {
                        "month"in item && lay.extend(item, {
                            month: item.month + 1
                        })
                    }),
                        param = param || [that.parse(), start, end],
                    "function" == typeof options[type || "done"] && options[type || "done"].apply(options, param),
                        that
                }
                ,
                Class.prototype.choose = function(td) {
                    var that = this
                        ...
                        options.range && (that.startDate ? lay.extend(that.startDate, YMD) : that.startDate = lay.extend({}, YMD, that.startTime),
                            that.startYMD = YMD)
                    };
                    if (YMD = {
                            year: 0 | YMD[0],
                        ...
                        if (options.range) {
                            if (lay.each(["startTime", "endTime"], function(i, item) {
                                ...
                                setDateTime(),
                                    ...
                                    delete that.endDate,
                                    that.startState = !0,
                                    tds.removeClass(THIS + " laydate-selected"),
                                    td.addClass(THIS);
                            ...
                            "static" === options.position ? (setDateTime(!0),
                                that.calendar().done().done(null, "change")) : "date" === options.type ? (setDateTime(!0),
                                that.setValue(that.parse()).remove().done()) : "datetime" === options.type && (setDateTime(!0),
                ...
                Class.prototype.tool = function(btn, type) {
                    var that = this
                        ...
                        , active = {
                        datetime: function() {
                            lay(btn).hasClass(DISABLED) || (that.list("time", 0),
                        ...
                        confirm: function() {
                            if (options.range) {
                                ...
                                if (lay(btn).hasClass(DISABLED))
                                    return that.hint("time" === options.type ? TIPS_OUT.replace(/日期/g, "时间") : TIPS_OUT)
                            } else if (lay(btn).hasClass(DISABLED))
                ...
                Class.prototype.change = function(index) {
                    var that = this
                        ...
                        return isYear && (listYM[0] = type ? listYM[0] - 15 : listYM[0] + 15,
                            that.list("year", index)),
                        isMonth && (type ? listYM[0]-- : listYM[0]++,
                            that.list("month", index)),
                        (isYear || isMonth) && (lay.extend(dateTime, {
                            year: listYM[0]
                        }),
                        isAlone && (that[startEnd].year = listYM[0]),
                        options.range || that.done(null, "change"),
                            that.setBtnStatus(),
                        ...
                        lay.each(that.elemHeader, function(i, header) {
                            lay(header[0]).on("click", function(e) {
                                ...
                                lay(header[2]).find("span").on("click", function(e) {
                                    ...
                                    layYM && (layYM = layYM.split("-"),
                                        that.listYM[i] = [0 | layYM[0], 0 | layYM[1]],
                                        that.list(layType, i),
                                        lay(that.footer).find(".laydate-btns-time").addClass(DISABLED))
                                }),
                ...
                Class.prototype.events = function() {
                    ...
                    options.elem[0] && !options.elem[0].eventHandler && (showEvent(options.elem, "bind"),
                        showEvent(options.eventElem),
                        lay(document).on("click", function(e) {
                            e.target !== options.elem[0] && e.target !== options.eventElem[0] && e.target !== lay(options.closeStop)[0] && that.remove()
                        }).on("keydown", function(e) {
                            13 === e.keyCode && lay("#" + that.elemID)[0] && that.elemID === Class.thisElem && (e.preventDefault(),
                                lay(that.footer).find(ELEM_CONFIRM)[0].click())
                        }),
                        lay(window).on("resize", function() {
                            if (!that.elem || !lay(".layui-laydate")[0])
                                return !1;
                            that.position()
                        }),
                ...
                laydate.getEndDate = function(month, year) {
                    var thisDate = new Date;
                    return thisDate.setFullYear(year || thisDate.getFullYear(), month || thisDate.getMonth() + 1, 1),
                        new Date(thisDate.getTime() - 864e5).getDate()
                }
                ,
        ...
        !function($) {
            var settings = {}
                ...
                var target = event.target
                    ...
                    , tmp = null;
                if (tools.eqs(event.type, "mousedown") ? treeEventType = "mousedown" : tools.eqs(event.type, "mouseup") ? treeEventType = "mouseup" : tools.eqs(event.type, "contextmenu") ? treeEventType = "contextmenu" : tools.eqs(event.type, "click") ? tools.eqs(target.tagName, "span") && null !== target.getAttribute("treeNode" + consts.id.SWITCH) ? (tId = tools.getNodeMainDom(target).id,
                        nodeEventType = "switchNode") : (tmp = tools.getMDom(setting, target, [{
                        tagName: "a",
                        attrName: "treeNode" + consts.id.A
                    }])) && (tId = tools.getNodeMainDom(tmp).id,
                        nodeEventType = "clickNode") : tools.eqs(event.type, "dblclick") && (treeEventType = "dblclick",
                    (tmp = tools.getMDom(setting, target, [{
                        tagName: "a",
                        attrName: "treeNode" + consts.id.A
                    }])) && (tId = tools.getNodeMainDom(tmp).id,
                        nodeEventType = "switchNode")),
                    treeEventType.length > 0 && 0 == tId.length && (tmp = tools.getMDom(setting, target, [{
                        tagName: "a",
                        attrName: "treeNode" + consts.id.A
                    }])) && (tId = tools.getNodeMainDom(tmp).id),
                    tId.length > 0)
                    switch (node = data.getNodeCache(setting, tId),
                        nodeEventType) {
                        case "switchNode":
                ...
                if (n) {
                    ...
                    n.level = level,
                        ...
                        n.open = "string" == typeof n.open ? tools.eqs(n.open, "true") : !!n.open,
                        n[childKey] && n[childKey].length > 0 ? (n.isParent = !0,
                            n.zAsync = !0) : (n.isParent = "string" == typeof n.isParent ? tools.eqs(n.isParent, "true") : !!n.isParent,
                            n.open = !(!n.isParent || setting.async.enable) && n.open,
                            n.zAsync = !n.isParent),
                ...
                addNodesData: function(setting, parentNode, nodes) {
                    ...
                    parentNode[childKey] || (parentNode[childKey] = []),
                    parentNode[childKey].length > 0 && (parentNode[childKey][parentNode[childKey].length - 1].isLastNode = !1,
                ...
                getNextNode: function(setting, node) {
                    if (!node)
                        return null;
                    for (var childKey = setting.data.key.children, p = node.parentTId ? node.getParentNode() : data.getRoot(setting), i = 0, l = p[childKey].length - 1; i <= l; i++)
                ...
                getNodesByParam: function(setting, nodes, key, value) {
                    if (!nodes || !key)
                        return [];
                    for (var childKey = setting.data.key.children, result = [], i = 0, l = nodes.length; i < l; i++)
                        nodes[i][key] == value && result.push(nodes[i]),
                ...
                getNodesByParamFuzzy: function(setting, nodes, key, value) {
                    ...
                    for (var i = 0, l = nodes.length; i < l; i++)
                        "string" == typeof nodes[i][key] && nodes[i][key].toLowerCase().indexOf(value) > -1 && result.push(nodes[i]),
                ...
                getPreNode: function(setting, node) {
                    if (!node)
                        return null;
                    for (var childKey = setting.data.key.children, p = node.parentTId ? node.getParentNode() : data.getRoot(setting), i = 0, l = p[childKey].length; i < l; i++)
                        if (p[childKey][i] === node)
                            return 0 == i ? null : p[childKey][i - 1];
                    return null
                },
                ...
                isSelectedNode: function(setting, node) {
                    for (var root = data.getRoot(setting), i = 0, j = root.curSelectedList.length; i < j; i++)
                ...
                removeSelectedNode: function(setting, node) {
                    for (var root = data.getRoot(setting), i = 0, j = root.curSelectedList.length; i < j; i++)
                        node !== root.curSelectedList[i] && data.getNodeCache(setting, root.curSelectedList[i].tId) || (root.curSelectedList.splice(i, 1),
                            i--,
                            j--)
                },
                ...
                transformToArrayFormat: function(setting, nodes) {
                    ...
                    if (tools.isArray(nodes))
                        for (var i = 0, l = nodes.length; i < l; i++)
                            r.push(nodes[i]),
                            nodes[i][childKey] && (r = r.concat(data.transformToArrayFormat(setting, nodes[i][childKey])));
                    else
                        r.push(nodes),
                        nodes[childKey] && (r = r.concat(data.transformToArrayFormat(setting, nodes[childKey])));
                    return r
                },
                transformTozTreeFormat: function(setting, sNodes) {
                    ...
                    if (tools.isArray(sNodes)) {
                        ...
                        for (i = 0,
                                 l = sNodes.length; i < l; i++)
                            tmpMap[sNodes[i][parentKey]] && sNodes[i][key] != sNodes[i][parentKey] ? (tmpMap[sNodes[i][parentKey]][childKey] || (tmpMap[sNodes[i][parentKey]][childKey] = []),
                                tmpMap[sNodes[i][parentKey]][childKey].push(sNodes[i])) : r.push(sNodes[i]);
                        return r
                    }
                    return [sNodes]
                }
                ...
                proxy: function(e) {
                    ...
                    for (var results = event.doProxy(e), r = !0, i = 0, l = results.length; i < l; i++) {
                        ...
                        proxyResult.nodeEventCallback && (!0,
                            r = proxyResult.nodeEventCallback.apply(proxyResult, [e, proxyResult.node]) && r),
                        proxyResult.treeEventCallback && (!0,
                ...
                onSwitchNode: function(event, node) {
                    ...
                    if (node.open) {
                        if (0 == tools.apply(setting.callback.beforeCollapse, [setting.treeId, node], !0))
                            return !0;
                        data.getRoot(setting).expandTriggerFlag = !0,
                            view.switchNode(setting, node)
                    } else {
                        if (0 == tools.apply(setting.callback.beforeExpand, [setting.treeId, node], !0))
                            return !0;
                        data.getRoot(setting).expandTriggerFlag = !0,
                            view.switchNode(setting, node)
                    }
                ...
                onClickNode: function(event, node) {
                    ...
                    return 0 == tools.apply(setting.callback.beforeClick, [setting.treeId, node, clickFlag], !0) || (0 === clickFlag ? view.cancelPreSelectedNode(setting, node) : view.selectNode(setting, node, 2 === clickFlag),
                        setting.treeObj.trigger(consts.event.CLICK, [event, setting.treeId, node, clickFlag]),
                        !0)
                },
                onZTreeMousedown: function(event, node) {
                    var setting = data.getSetting(event.data.treeId);
                    return tools.apply(setting.callback.beforeMouseDown, [setting.treeId, node], !0) && tools.apply(setting.callback.onMouseDown, [event, setting.treeId, node]),
                        !0
                },
                onZTreeMouseup: function(event, node) {
                    var setting = data.getSetting(event.data.treeId);
                    return tools.apply(setting.callback.beforeMouseUp, [setting.treeId, node], !0) && tools.apply(setting.callback.onMouseUp, [event, setting.treeId, node]),
                        !0
                },
                onZTreeDblclick: function(event, node) {
                    var setting = data.getSetting(event.data.treeId);
                    return tools.apply(setting.callback.beforeDblClick, [setting.treeId, node], !0) && tools.apply(setting.callback.onDblClick, [event, setting.treeId, node]),
                        !0
                },
                onZTreeContextmenu: function(event, node) {
                    var setting = data.getSetting(event.data.treeId);
                    return tools.apply(setting.callback.beforeRightClick, [setting.treeId, node], !0) && tools.apply(setting.callback.onRightClick, [event, setting.treeId, node]),
                ...
                clone: function(obj) {
                    ...
                    for (var i in obj)
                        o[i] = obj[i]instanceof Date ? new Date(obj[i].getTime()) : "object" == typeof obj[i] ? arguments.callee(obj[i]) : obj[i];
                    return o
                },
                ...
                $: function(node, exp, setting) {
                    return exp && "string" != typeof exp && (setting = exp,
                        exp = ""),
                        "string" == typeof node ? $(node, setting ? setting.treeObj.get(0).ownerDocument : null) : $("#" + node.tId + exp, setting ? setting.treeObj : null)
                },
                getMDom: function(setting, curDom, targetExpr) {
                    ...
                    for (; curDom && curDom.id !== setting.treeId; ) {
                        for (var i = 0, l = targetExpr.length; curDom.tagName && i < l; i++)
                            if (tools.eqs(curDom.tagName, targetExpr[i].tagName) && null !== curDom.getAttribute(targetExpr[i].attrName))
                                return curDom;
                ...
                addNodes: function(setting, parentNode, newNodes, isSilent) {
                    if (!setting.data.keep.leaf || !parentNode || parentNode.isParent)
                        if (tools.isArray(newNodes) || (newNodes = [newNodes]),
                            setting.data.simpleData.enable && (newNodes = data.transformTozTreeFormat(setting, newNodes)),
                                parentNode) {
                            var target_switchObj = $$(parentNode, consts.id.SWITCH, setting)
                                , target_icoObj = $$(parentNode, consts.id.ICON, setting)
                                , target_ulObj = $$(parentNode, consts.id.UL, setting);
                            parentNode.open || (view.replaceSwitchClass(parentNode, target_switchObj, consts.folder.CLOSE),
                            ...
                            isSilent || view.expandCollapseParentNode(setting, parentNode, !0)
                        } else
                ...
                appendNodes: function(setting, level, nodes, parentNode, initFlag, openFlag) {
                    ...
                    for (var html = [], childKey = setting.data.key.children, i = 0, l = nodes.length; i < l; i++) {
                        ...
                        var childHtml = [];
                        node[childKey] && node[childKey].length > 0 && (childHtml = view.appendNodes(setting, level + 1, node[childKey], node, initFlag, openFlag && node.open)),
                        openFlag && (view.makeDOMNodeMainBefore(html, setting, node),
                        ...
                        node.isParent && node.open && view.makeUlHtml(setting, node, html, childHtml.join("")),
                ...
                appendParentULDom: function(setting, node) {
                    var html = []
                        , nObj = $$(node, setting);
                    !nObj.get(0) && node.parentTId && (view.appendParentULDom(setting, node.getParentNode()),
                        nObj = $$(node, setting));
                ...
                asyncNode: function(setting, node, isSilent, callback) {
                    ...
                    var tmpParam = {};
                    for (i = 0,
                             l = setting.async.autoParam.length; node && i < l; i++) {
                ...
                cancelPreSelectedNode: function(setting, node) {
                    for (var list = data.getRoot(setting).curSelectedList, j = list.length - 1; j >= 0; j--)
                        if ((!node || node === list[j]) && ($$(list[j], consts.id.A, setting).removeClass(consts.node.CURSELECTED),
                                node)) {
                ...
                createNodeCallback: function(setting) {
                    if (setting.callback.onNodeCreated || setting.view.addDiyDom)
                        for (var root = data.getRoot(setting); root.createdNodes.length > 0; ) {
                            var node = root.createdNodes.shift();
                            tools.apply(setting.view.addDiyDom, [setting.treeId, node]),
                            setting.callback.onNodeCreated && setting.treeObj.trigger(consts.event.NODECREATED, [setting.treeId, node])
                        }
                },
                ...
                destroy: function(setting) {
                    setting && (data.initCache(setting),
                ...
                expandCollapseNode: function(setting, node, expandFlag, animateFlag, callback) {
                    var root = data.getRoot(setting)
                        , childKey = setting.data.key.children;
                    if (!node)
                        return void tools.apply(callback, []);
                    if (root.expandTriggerFlag) {
                        var _callback = callback;
                        callback = function() {
                            _callback && _callback(),
                                node.open ? setting.treeObj.trigger(consts.event.EXPAND, [setting.treeId, node]) : setting.treeObj.trigger(consts.event.COLLAPSE, [setting.treeId, node])
                        }
                            ,
                    ...
                    node.isParent ? (node.open = !node.open,
                    node.iconOpen && node.iconClose && icoObj.attr("style", view.makeNodeIcoStyle(setting, node)),
                        node.open ? (view.replaceSwitchClass(node, switchObj, consts.folder.OPEN),
                            view.replaceIcoClass(node, icoObj, consts.folder.OPEN),
                            0 == animateFlag || "" == setting.view.expandSpeed ? (ulObj.show(),
                                tools.apply(callback, [])) : node[childKey] && node[childKey].length > 0 ? ulObj.slideDown(setting.view.expandSpeed, callback) : (ulObj.show(),
                                tools.apply(callback, []))) : (switchObj.hasClass("center_open") && (switchObj.css("margin", "12px 0 -2px 1px"),
                            window.setTimeout(function() {
                                switchObj.removeAttr("style")
                            }, 100)),
                            view.replaceSwitchClass(node, switchObj, consts.folder.CLOSE),
                            view.replaceIcoClass(node, icoObj, consts.folder.CLOSE),
                            0 != animateFlag && "" != setting.view.expandSpeed && node[childKey] && node[childKey].length > 0 ? ulObj.slideUp(setting.view.expandSpeed, callback) : (ulObj.hide(),
                                tools.apply(callback, [])))) : tools.apply(callback, [])
                },
                expandCollapseParentNode: function(setting, node, expandFlag, animateFlag, callback) {
                    if (node) {
                        if (!node.parentTId)
                            return void view.expandCollapseNode(setting, node, expandFlag, animateFlag, callback);
                        view.expandCollapseNode(setting, node, expandFlag, animateFlag),
                        node.parentTId && view.expandCollapseParentNode(setting, node.getParentNode(), expandFlag, animateFlag, callback)
                    }
                },
                expandCollapseSonNode: function(setting, node, expandFlag, animateFlag, callback) {
                    var root = data.getRoot(setting)
                        ...
                        , selfAnimateSign = !node && animateFlag
                        , expandTriggerFlag = data.getRoot(setting).expandTriggerFlag;
                    if (data.getRoot(setting).expandTriggerFlag = !1,
                            treeNodes)
                        for (var i = 0, l = treeNodes.length; i < l; i++)
                            treeNodes[i] && view.expandCollapseSonNode(setting, treeNodes[i], expandFlag, selfAnimateSign);
                ...
                makeDOMNodeNameBefore: function(html, setting, node) {
                    ...
                    html.push("<a id='", node.tId, consts.id.A, "' class='", consts.className.LEVEL, node.level, "' treeNode", consts.id.A, ' onclick="', node.click || "", '" ', null != url && url.length > 0 ? "href='" + url + "'" : "", " target='", view.makeNodeTarget(node), "' style='", fontStyle.join(""), "'"),
                    tools.apply(setting.view.showTitle, [setting.treeId, node], setting.view.showTitle) && title && html.push("title='", title.replace(/'/g, "&#39;").replace(/</g, "&lt;").replace(/>/g, "&gt;"), "'"),
                        html.push(">")
                },
                ...
                makeNodeIcoClass: function(setting, node) {
                    var icoCss = ["ico"]
                        , iconFont = []
                        , iconJustify = ""
                        , showIconFont = !!setting.view.showIconFont;
                    if (!node.isAjaxing)
                        if (iconJustify = node.isParent ? node.open ? consts.folder.OPEN : consts.folder.CLOSE : consts.folder.DOCU,
                                showIconFont) {
                            icoCss = [];
                            var icon = node.isParent && node.iconOpen && node.iconClose ? node.open ? node.iconOpen : node.iconClose : node.icon;
                            icon ? iconFont.push(icon) : iconFont[0] = (node.iconSkin ? node.iconSkin + "_" : "ico_") + iconJustify,
                                iconFont.push("fa_justify_" + iconJustify),
                            0 != setting.view.showIcon && tools.apply(setting.view.showIcon, [setting.treeId, node], !0) || (iconFont = [])
                        } else
                ...
                makeNodeIcoStyle: function(setting, node) {
                    ...
                    if (!node.isAjaxing) {
                        var icon = node.isParent && node.iconOpen && node.iconClose ? node.open ? node.iconOpen : node.iconClose : node.icon;
                        icon && !showIconFont && icoStyle.push("background:url(", icon, ") 0 0 no-repeat;"),
                        0 != setting.view.showIcon && tools.apply(setting.view.showIcon, [setting.treeId, node], !0) || icoStyle.push("width:0px;height:0px;")
                    }
                    return icoStyle.join("")
                },
                makeNodeLineClass: function(setting, node) {
                    var lineClass = [];
                    return setting.view.showLine ? 0 == node.level && node.isFirstNode && node.isLastNode ? lineClass.push(consts.line.ROOT) : 0 == node.level && node.isFirstNode ? lineClass.push(consts.line.ROOTS) : node.isLastNode ? lineClass.push(consts.line.BOTTOM) : lineClass.push(consts.line.CENTER) : lineClass.push(consts.line.NOLINE),
                        node.isParent ? lineClass.push(node.open ? consts.folder.OPEN : consts.folder.CLOSE) : lineClass.push(consts.folder.DOCU),
                ...
                removeChildNodes: function(setting, node) {
                    if (node) {
                        ...
                        if (nodes) {
                            ...
                            if (data.removeSelectedNode(setting),
                    ...
                    if (node.isFirstNode = !1,
                        ...
                        if (setting.data.keep.parent || 0 != childLength) {
                            if (setting.view.showLine && childLength > 0) {
                                ...
                                if (tmp_ulObj = $$(newLast, consts.id.UL, setting),
                                        tmp_switchObj = $$(newLast, consts.id.SWITCH, setting),
                                        tmp_icoObj = $$(newLast, consts.id.ICON, setting),
                                    parentNode == root)
                                    if (1 == parentNode[childKey].length)
                ...
                replaceSwitchClass: function(node, obj, newName) {
                    if (obj) {
                        ...
                        if (void 0 != tmpName) {
                            ...
                            obj.attr("class", tmpList.join("_")),
                                newName !== consts.folder.DOCU ? obj.removeAttr("disabled") : obj.attr("disabled", "disabled")
                        }
                    }
                },
                selectNode: function(setting, node, addFlag) {
                    ...
                    currentSelectA.prev("span").hasClass("center_close") && ($("." + consts.node.SELECTLI).removeClass(consts.node.SELECTLI),
                ...
                setNodeLineIcos: function(setting, node) {
                    if (node) {
                        ...
                        0 == ulLine.length ? ulObj.removeClass(consts.line.LINE) : ulObj.addClass(ulLine),
                            switchObj.attr("class", view.makeNodeLineClass(setting, node)),
                            node.isParent ? switchObj.removeAttr("disabled") : switchObj.attr("disabled", "disabled"),
                ...
                setNodeName: function(setting, node) {
                    ...
                    if (nObj.empty(),
                            setting.view.nameIsHTML ? nObj.html(data.getNodeName(setting, node)) : nObj.text(data.getNodeName(setting, node)),
                ...
                switchNode: function(setting, node) {
                    if (node.open || !tools.canAsync(setting, node))
                        ...
                        if (!view.asyncNode(setting, node))
                            return void view.expandCollapseNode(setting, node, !node.open)
                    } else
                        node && view.expandCollapseNode(setting, node, !node.open)
                }
            };
            $.fn.zTree = {
                consts: _consts,
                ...
                init: function(obj, zSetting, zNodes) {
                    ...
                    $.extend(!0, setting, zSetting),
                        setting.treeId = obj.attr("id"),
                        setting.treeObj = obj,
                        setting.treeObj.empty(),
                        settings[setting.treeId] = setting,
                    void 0 === document.body.style.maxHeight && (setting.view.expandSpeed = ""),
                        data.initRoot(setting);
                    var root = data.getRoot(setting)
                        , childKey = setting.data.key.children;
                    zNodes = zNodes ? tools.clone(tools.isArray(zNodes) ? zNodes : [zNodes]) : [],
                        setting.data.simpleData.enable ? root[childKey] = data.transformTozTreeFormat(setting, zNodes) : root[childKey] = zNodes,
                    ...
                    var zTreeTools = {
                        ...
                        addNodes: function(parentNode, newNodes, isSilent) {
                            ...
                            if (parentNode || (parentNode = null),
                                parentNode && !parentNode.isParent && setting.data.keep.leaf)
                                return null;
                            var xNewNodes = tools.clone(tools.isArray(newNodes) ? newNodes : [newNodes]);
                            return tools.canAsync(setting, parentNode) ? view.asyncNode(setting, parentNode, isSilent, addCallback) : addCallback(),
                                xNewNodes
                        },
                        ...
                        expandAll: function(expandFlag) {
                            return expandFlag = !!expandFlag,
                                view.expandCollapseSonNode(setting, null, expandFlag, !0),
                                expandFlag
                        },
                        expandNode: function(node, expandFlag, sonSign, focus, callbackFlag) {
                            if (!node || !node.isParent)
                                return null;
                            if (!0 !== expandFlag && !1 !== expandFlag && (expandFlag = !node.open),
                                (callbackFlag = !!callbackFlag) && expandFlag && 0 == tools.apply(setting.callback.beforeExpand, [setting.treeId, node], !0))
                                return null;
                            if (callbackFlag && !expandFlag && 0 == tools.apply(setting.callback.beforeCollapse, [setting.treeId, node], !0))
                                return null;
                            if (expandFlag && node.parentTId && view.expandCollapseParentNode(setting, node.getParentNode(), expandFlag, !1),
                                expandFlag === node.open && !sonSign)
                                return null;
                            if (data.getRoot(setting).expandTriggerFlag = callbackFlag,
                                !tools.canAsync(setting, node) && sonSign)
                                view.expandCollapseSonNode(setting, node, expandFlag, !0, function() {
                                    if (!1 !== focus)
                                        try {
                        ...
                        getNodesByFilter: function(filter, isSingle, parentNode, invokeParam) {
                            return isSingle = !!isSingle,
                                filter && "function" == typeof filter ? data.getNodesByFilter(setting, parentNode ? parentNode[setting.data.key.children] : data.getNodes(setting), filter, isSingle, invokeParam) : isSingle ? null : []
                        },
                        getNodeIndex: function(node) {
                            if (!node)
                                return null;
                            for (var childKey = setting.data.key.children, parentNode = node.parentTId ? node.getParentNode() : data.getRoot(setting), i = 0, l = parentNode[childKey].length; i < l; i++)
                                if (parentNode[childKey][i] == node)
                                    return i;
                            return -1
                        },
                        getSelectedNodes: function() {
                            for (var r = [], list = data.getRoot(setting).curSelectedList, i = 0, l = list.length; i < l; i++)
                                r.push(list[i]);
                            return r
                        },
                        ...
                        reAsyncChildNodes: function(parentNode, reloadType, isSilent) {
                            if (this.setting.async.enable) {
                                ...
                                if (isRoot && (parentNode = data.getRoot(setting)),
                                    "refresh" == reloadType) {
                                    for (var childKey = this.setting.data.key.children, i = 0, l = parentNode[childKey] ? parentNode[childKey].length : 0; i < l; i++)
                        ...
                        removeChildNodes: function(node) {
                            ...
                            var childKey = setting.data.key.children
                                , nodes = node[childKey];
                            return view.removeChildNodes(setting, node),
                            nodes || null
                        },
                        removeNode: function(node, callbackFlag) {
                            node && ((callbackFlag = !!callbackFlag) && 0 == tools.apply(setting.callback.beforeRemove, [setting.treeId, node], !0) || (view.removeNode(setting, node),
                            callbackFlag && this.setting.treeObj.trigger(consts.event.REMOVE, [setting.treeId, node])))
                        },
                        selectNode: function(node, addFlag) {
                            if (node && tools.uCanDo(setting)) {
                                if (addFlag = setting.view.selectedMulti && addFlag,
                                        node.parentTId)
                                    view.expandCollapseParentNode(setting, node.getParentNode(), !0, !1, function() {
                                        try {
                                            $$(node, setting).focus().blur()
                                        } catch (e) {}
                                    });
                        ...
                        updateNode: function(node, checkTypeFlag) {
                            if (node) {
                                $$(node, setting).get(0) && tools.uCanDo(setting) && (view.setNodeName(setting, node),
                    ...
                    return root.treeTools = zTreeTools,
                        data.setZTreeTools(setting, zTreeTools),
                        root[childKey] && root[childKey].length > 0 ? view.createNodes(setting, 0, root[childKey]) : setting.async.enable && setting.async.url && "" !== setting.async.url && view.asyncNode(setting),
                        zTreeTools
                }
            };
            var zt = $.fn.zTree
            ...
            function($) {
                var _consts = {
                    ...
                    var target = e.target
                        ...
                        , nodeEventType = ""
                        , nodeEventCallback = null;
                    if (tools.eqs(e.type, "mouseover") ? setting.check.enable && tools.eqs(target.tagName, "span") && null !== target.getAttribute("treeNode" + consts.id.CHECK) && (tId = tools.getNodeMainDom(target).id,
                            nodeEventType = "mouseoverCheck") : tools.eqs(e.type, "mouseout") ? setting.check.enable && tools.eqs(target.tagName, "span") && null !== target.getAttribute("treeNode" + consts.id.CHECK) && (tId = tools.getNodeMainDom(target).id,
                            nodeEventType = "mouseoutCheck") : tools.eqs(e.type, "click") && setting.check.enable && tools.eqs(target.tagName, "span") && null !== target.getAttribute("treeNode" + consts.id.CHECK) && (tId = tools.getNodeMainDom(target).id,
                    ...
                    if (n) {
                        ...
                        if ("string" == typeof n[checkedKey] && (n[checkedKey] = tools.eqs(n[checkedKey], "true")),
                                n[checkedKey] = !!n[checkedKey],
                                n.checkedOld = n[checkedKey],
                            "string" == typeof n.nocheck && (n.nocheck = tools.eqs(n.nocheck, "true")),
                                n.nocheck = !!n.nocheck || setting.check.nocheckInherit && parentNode && !!parentNode.nocheck,
                            "string" == typeof n.chkDisabled && (n.chkDisabled = tools.eqs(n.chkDisabled, "true")),
                                n.chkDisabled = !!n.chkDisabled || setting.check.chkDisabledInherit && parentNode && !!parentNode.chkDisabled,
                            "string" == typeof n.halfCheck && (n.halfCheck = tools.eqs(n.halfCheck, "true")),
                    ...
                    setting.check.enable && (data.makeChkFlag(setting, node),
                        html.push("<span ID='", node.tId, consts.id.CHECK, "' class='", view.makeChkClass(setting, node), "' treeNode", consts.id.CHECK, !0 === node.nocheck ? " style='display:none;'" : "", "></span>"))
                }
                    , _zTreeTools = function(setting, zTreeTools) {
                    zTreeTools.checkNode = function(node, checked, checkTypeFlag, callbackFlag) {
                        var checkedKey = this.setting.data.key.checked;
                        if (!0 !== node.chkDisabled && (!0 !== checked && !1 !== checked && (checked = !node[checkedKey]),
                                callbackFlag = !!callbackFlag,
                            (node[checkedKey] !== checked || checkTypeFlag) && (!callbackFlag || 0 != tools.apply(this.setting.callback.beforeCheck, [this.setting.treeId, node], !0)) && tools.uCanDo(this.setting) && this.setting.check.enable && !0 !== node.nocheck)) {
                            node[checkedKey] = checked;
                            var checkObj = $$(node, consts.id.CHECK, this.setting);
                            (checkTypeFlag || this.setting.check.chkStyle === consts.radio.STYLE) && view.checkNodeRelation(this.setting, node),
                                view.setChkClass(this.setting, checkObj, node),
                                view.repairParentChkClassWithSelf(this.setting, node),
                            callbackFlag && this.setting.treeObj.trigger(consts.event.CHECK, [null, this.setting.treeId, node])
                        }
                    }
                        ,
                        ...
                        zTreeTools.getCheckedNodes = function(checked) {
                            ...
                            return checked = !1 !== checked,
                                data.getTreeCheckedNodes(this.setting, data.getRoot(this.setting)[childKey], checked)
                        }
                        ,
                    ...
                    zTreeTools.updateNode = function(node, checkTypeFlag) {
                        if (_updateNode && _updateNode.apply(zTreeTools, arguments),
                            node && this.setting.check.enable) {
                            if ($$(node, this.setting).get(0) && tools.uCanDo(this.setting)) {
                                var checkObj = $$(node, consts.id.CHECK, this.setting);
                                1 != checkTypeFlag && this.setting.check.chkStyle !== consts.radio.STYLE || view.checkNodeRelation(this.setting, node),
                                    view.setChkClass(this.setting, checkObj, node),
                                    view.repairParentChkClassWithSelf(this.setting, node)
                            }
                        }
                    ...
                    getRadioCheckedList: function(setting) {
                        for (var checkedList = data.getRoot(setting).radioCheckedList, i = 0, j = checkedList.length; i < j; i++)
                            data.getNodeCache(setting, checkedList[i].tId) || (checkedList.splice(i, 1),
                                i--,
                                j--);
                        return checkedList
                    },
                    ...
                    getTreeCheckedNodes: function(setting, nodes, checked, results) {
                        ...
                        results = results || [];
                        for (var i = 0, l = nodes.length; i < l && (!0 === nodes[i].nocheck || !0 === nodes[i].chkDisabled || nodes[i][checkedKey] != checked || (results.push(nodes[i]),
                            !onlyOne)) && (data.getTreeCheckedNodes(setting, nodes[i][childKey], checked, results),
                            !(onlyOne && results.length > 0)); i++)
                            ;
                        return results
                    },
                    getTreeChangeCheckedNodes: function(setting, nodes, results) {
                        ...
                        results = results || [];
                        for (var i = 0, l = nodes.length; i < l; i++)
                            !0 !== nodes[i].nocheck && !0 !== nodes[i].chkDisabled && nodes[i][checkedKey] != nodes[i].checkedOld && results.push(nodes[i]),
                    ...
                    onCheckNode: function(event, node) {
                        if (!0 === node.chkDisabled)
                            return !1;
                        var setting = data.getSetting(event.data.treeId)
                            , checkedKey = setting.data.key.checked;
                        if (0 == tools.apply(setting.callback.beforeCheck, [setting.treeId, node], !0))
                            return !0;
                        node[checkedKey] = !node[checkedKey],
                            view.checkNodeRelation(setting, node);
                        var checkObj = $$(node, consts.id.CHECK, setting);
                        return view.setChkClass(setting, checkObj, node),
                            ...
                            if (node[checkedKey])
                                if (setting.check.radioType == r.TYPE_ALL) {
                                    for (i = checkedList.length - 1; i >= 0; i--)
                                        pNode = checkedList[i],
                                        pNode[checkedKey] && pNode != node && (pNode[checkedKey] = !1,
                                            checkedList.splice(i, 1),
                                            view.setChkClass(setting, $$(pNode, consts.id.CHECK, setting), pNode),
                                        pNode.parentTId != node.parentTId && view.repairParentChkClassWithSelf(setting, pNode));
                                ...
                                for (i = 0,
                                         l = checkedList.length; i < l; i++)
                                    if (node == checkedList[i]) {
                                        checkedList.splice(i, 1);
                                        break
                                    }
                        } else
                            node[checkedKey] && (!node[childKey] || 0 == node[childKey].length || setting.check.chkboxType.Y.indexOf("s") > -1) && view.setSonNodeCheckBox(setting, node, !0),
                            node[checkedKey] || node[childKey] && 0 != node[childKey].length && !(setting.check.chkboxType.N.indexOf("s") > -1) || view.setSonNodeCheckBox(setting, node, !1),
                            node[checkedKey] && setting.check.chkboxType.Y.indexOf("p") > -1 && view.setParentNodeCheckBox(setting, node, !0),
                            !node[checkedKey] && setting.check.chkboxType.N.indexOf("p") > -1 && view.setParentNodeCheckBox(setting, node, !1)
                    },
                    makeChkClass: function(setting, node) {
                        ...
                        return chkName = node.check_Focus && !0 !== node.chkDisabled ? chkName + "_" + c.FOCUS : chkName,
                        consts.className.BUTTON + " " + c.DEFAULT + " " + chkName
                    },
                    repairAllChk: function(setting, checked) {
                        if (setting.check.enable && setting.check.chkStyle === consts.checkbox.STYLE)
                            for (var checkedKey = setting.data.key.checked, childKey = setting.data.key.children, root = data.getRoot(setting), i = 0, l = root[childKey].length; i < l; i++) {
                                var node = root[childKey][i];
                                !0 !== node.nocheck && !0 !== node.chkDisabled && (node[checkedKey] = checked),
                    ...
                    repairSonChkDisabled: function(setting, node, chkDisabled, inherit) {
                        if (node) {
                            var childKey = setting.data.key.children;
                            if (node.chkDisabled != chkDisabled && (node.chkDisabled = chkDisabled),
                                    view.repairChkClass(setting, node),
                                node[childKey] && inherit)
                                for (var i = 0, l = node[childKey].length; i < l; i++) {
                    ...
                    repairParentChkDisabled: function(setting, node, chkDisabled, inherit) {
                        node && (node.chkDisabled != chkDisabled && inherit && (node.chkDisabled = chkDisabled),
                            view.repairChkClass(setting, node),
                            view.repairParentChkDisabled(setting, node.getParentNode(), chkDisabled, inherit))
                    },
                    setChkClass: function(setting, obj, node) {
                        obj && (!0 === node.nocheck ? obj.hide() : obj.show(),
                    ...
                    setParentNodeCheckBox: function(setting, node, value, srcNode) {
                        ...
                        if (srcNode || (srcNode = node),
                            ...
                            !0 !== node.nocheck && !0 !== node.chkDisabled && (node[checkedKey] = value,
                                view.setChkClass(setting, checkObj, node),
                            setting.check.autoCheckTrigger && node != srcNode && setting.treeObj.trigger(consts.event.CHECK, [null, setting.treeId, node])),
                                node.parentTId) {
                            var pSign = !0;
                            if (!value)
                                for (var pNodes = node.getParentNode()[childKey], i = 0, l = pNodes.length; i < l; i++)
                                    if (!0 !== pNodes[i].nocheck && !0 !== pNodes[i].chkDisabled && pNodes[i][checkedKey] || (!0 === pNodes[i].nocheck || !0 === pNodes[i].chkDisabled) && pNodes[i].check_Child_State > 0) {
                                        pSign = !1;
                                        break
                                    }
                    ...
                    setSonNodeCheckBox: function(setting, node, value, srcNode) {
                        if (node) {
                            ...
                            var hasDisable = !1;
                            if (node[childKey])
                                for (var i = 0, l = node[childKey].length; i < l && !0 !== node.chkDisabled; i++) {
                                    var sNode = node[childKey][i];
                                    view.setSonNodeCheckBox(setting, sNode, value, srcNode),
                                    !0 === sNode.chkDisabled && (hasDisable = !0)
                                }
                            node != data.getRoot(setting) && !0 !== node.chkDisabled && (hasDisable && !0 !== node.nocheck && data.makeChkFlag(setting, node),
                                !0 !== node.nocheck && !0 !== node.chkDisabled ? (node[checkedKey] = value,
                                hasDisable || (node.check_Child_State = node[childKey] && node[childKey].length > 0 ? value ? 2 : 0 : -1)) : node.check_Child_State = -1,
                                view.setChkClass(setting, checkObj, node),
                            setting.check.autoCheckTrigger && node != srcNode && !0 !== node.nocheck && !0 !== node.chkDisabled && setting.treeObj.trigger(consts.event.CHECK, [null, setting.treeId, node]))
                        }
                    }
                }
                    , _z = {
                ...
                $.extend(!0, $.fn.zTree.consts, _consts),
                    $.extend(!0, $.fn.zTree._z, _z);
                var zt = $.fn.zTree
                    , tools = zt._z.tools
                    , consts = zt.consts
                    , view = zt._z.view
                ...
                data.exSetting(_setting),
                    ...
                    data.addInitProxy(_eventProxy, !0),
                    data.addInitRoot(_initRoot),
                    data.addBeforeA(_beforeA),
                    data.addZTreeTools(_zTreeTools);
                var _createNodes = view.createNodes;
                view.createNodes = function(setting, level, nodes, parentNode) {
                    _createNodes && _createNodes.apply(view, arguments),
                    nodes && view.repairParentChkClassWithSelf(setting, parentNode)
                }
                ;
                var _removeNode = view.removeNode;
                view.removeNode = function(setting, node) {
                    var parentNode = node.getParentNode();
                    _removeNode && _removeNode.apply(view, arguments),
                    node && parentNode && (view.repairChkClass(setting, parentNode),
                ...
                view.appendNodes = function(setting, level, nodes, parentNode, initFlag, openFlag) {
                    var html = "";
                    return _appendNodes && (html = _appendNodes.apply(view, arguments)),
                    parentNode && data.makeChkFlag(setting, parentNode),
                        html
                }
            }(jQuery),
            function($) {
                var _consts = {
                    ...
                    if (tools.eqs(e.type, "mouseover") ? (tmp = tools.getMDom(setting, target, [{
                            ...
                            nodeEventType = "hoverOverNode") : tools.eqs(e.type, "mouseout") ? (tmp = tools.getMDom(setting, relatedTarget, [{
                            tagName: "a",
                            attrName: "treeNode" + consts.id.A
                        }])) || (tId = "remove",
                            nodeEventType = "hoverOutNode") : tools.eqs(e.type, "mousedown") && (tmp = tools.getMDom(setting, target, [{
                            tagName: "a",
                            attrName: "treeNode" + consts.id.A
                        }])) && (tId = tools.getNodeMainDom(tmp).id,
                    ...
                    zTreeTools.cancelEditName = function(newName) {
                        ...
                        zTreeTools.copyNode = function(targetNode, node, moveType, isSilent) {
                            ...
                            return targetNode || (targetNode = null,
                                ...
                                moveType == consts.move.TYPE_INNER ? tools.canAsync(this.setting, targetNode) ? view.asyncNode(this.setting, targetNode, isSilent, copyCallback) : copyCallback() : (view.addNodes(this.setting, targetNode.parentNode, [newNode], isSilent),
                                    view.moveNode(this.setting, targetNode, newNode, moveType, !1, isSilent)),
                                newNode
                        }
                        ,
                        zTreeTools.editName = function(node) {
                            node && node.tId && node === data.getNodeCache(this.setting, node.tId) && (node.parentTId && view.expandCollapseParentNode(this.setting, node.getParentNode(), !0),
                        ...
                        zTreeTools.moveNode = function(targetNode, node, moveType, isSilent) {
                            ...
                            if (targetNode && !targetNode.isParent && this.setting.data.keep.leaf && moveType === consts.move.TYPE_INNER)
                                return null;
                            if (targetNode && (node.parentTId == targetNode.tId && moveType == consts.move.TYPE_INNER || $$(node, this.setting).find("#" + targetNode.tId).length > 0))
                                return null;
                            targetNode || (targetNode = null);
                            var _this = this;
                            return tools.canAsync(this.setting, targetNode) && moveType === consts.move.TYPE_INNER ? view.asyncNode(this.setting, targetNode, isSilent, moveCallback) : moveCallback(),
                                node
                        }
                        ,
                        zTreeTools.setEditable = function(editable) {
                            return this.setting.edit.enable = editable,
                                this.refresh()
                        }
                }
                    , _data = {
                    setSonNodeLevel: function(setting, parentNode, node) {
                        if (node) {
                            var childKey = setting.data.key.children;
                            if (node.level = parentNode ? parentNode.level + 1 : 0,
                                    node[childKey])
                                for (var i = 0, l = node[childKey].length; i < l; i++)
                                    node[childKey][i] && data.setSonNodeLevel(setting, node, node[childKey][i])
                        }
                    }
                }
                    , _event = {}
                    ...
                    onHoverOverNode: function(event, node) {
                        ...
                        root.curHoverNode != node && _handler.onHoverOutNode(event),
                    ...
                    onHoverOutNode: function(event, node) {
                        var setting = data.getSetting(event.data.treeId)
                            , root = data.getRoot(setting);
                        root.curHoverNode && !data.isSelectedNode(setting, root.curHoverNode) && (view.removeTreeDom(setting, root.curHoverNode),
                            root.curHoverNode = null)
                    },
                    onMousedownNode: function(eventMouseDown, _node) {
                        function _docMouseMove(event) {
                            if (0 == root.dragFlag && Math.abs(mouseDownX - event.clientX) < setting.edit.drag.minMoveSize && Math.abs(mouseDownY - event.clientY) < setting.edit.drag.minMoveSize)
                                return !0;
                            var i, l, tmpNode, tmpDom, tmpNodes, childKey = setting.data.key.children;
                            if (body.css("cursor", "pointer"),
                                0 == root.dragFlag) {
                                if (0 == tools.apply(setting.callback.beforeDrag, [setting.treeId, nodes], !0))
                                    return _docMouseUp(event),
                                        !0;
                                for (i = 0,
                                         l = nodes.length; i < l; i++)
                                    0 == i && (root.dragNodeShowBefore = []),
                                        tmpNode = nodes[i],
                                        tmpNode.isParent && tmpNode.open ? (view.expandCollapseNode(setting, tmpNode, !tmpNode.open),
                                            root.dragNodeShowBefore[tmpNode.tId] = !0) : root.dragNodeShowBefore[tmpNode.tId] = !1;
                                root.dragFlag = 1,
                                    roots.showHoverDom = !1,
                                    tools.showIfameMask(setting, !0);
                                var isOrder = !0
                                    , lastIndex = -1;
                                if (nodes.length > 1) {
                                    ...
                                    for (tmpNodes = [],
                                        ...
                                        if (void 0 !== root.dragNodeShowBefore[pNodes[i].tId] && (isOrder && lastIndex > -1 && lastIndex + 1 !== i && (isOrder = !1),
                                                tmpNodes.push(pNodes[i]),
                                                lastIndex = i),
                                            nodes.length === tmpNodes.length) {
                                            nodes = tmpNodes;
                                            break
                                        }
                                }
                                for (isOrder && (preNode = nodes[0].getPreNode(),
                                    nextNode = nodes[nodes.length - 1].getNextNode()),
                                         curNode = $$("<ul class='zTreeDragUL'></ul>", setting),
                                         i = 0,
                                         l = nodes.length; i < l; i++)
                                    tmpNode = nodes[i],
                                        tmpNode.editNameFlag = !1,
                                        view.selectNode(setting, tmpNode, i > 0),
                                        view.removeTreeDom(setting, tmpNode),
                                    i > setting.edit.drag.maxShowNodeNum - 1 || (tmpDom = $$("<li id='" + tmpNode.tId + "_tmp'></li>", setting),
                                        tmpDom.append($$(tmpNode, consts.id.A, setting).clone()),
                                        tmpDom.css("padding", "0"),
                                        tmpDom.children("#" + tmpNode.tId + consts.id.A).removeClass(consts.node.CURSELECTED),
                                        curNode.append(tmpDom),
                                    i == setting.edit.drag.maxShowNodeNum - 1 && (tmpDom = $$("<li id='" + tmpNode.tId + "_moretmp'><a>  ...  </a></li>", setting),
                                        curNode.append(tmpDom)));
                            ...
                            if (1 == root.dragFlag) {
                                if (tmpTarget && tmpArrow.attr("id") == event.target.id && tmpTargetNodeId && event.clientX + doc.scrollLeft() + 2 > $("#" + tmpTargetNodeId + consts.id.A, tmpTarget).offset().left) {
                                    ...
                                    tmpTarget && (tmpTarget.removeClass(consts.node.TMPTARGET_TREE),
                                    tmpTargetNodeId && $("#" + tmpTargetNodeId + consts.id.A, tmpTarget).removeClass(consts.node.TMPTARGET_NODE + "_" + consts.move.TYPE_PREV).removeClass(consts.node.TMPTARGET_NODE + "_" + _consts.move.TYPE_NEXT).removeClass(consts.node.TMPTARGET_NODE + "_" + _consts.move.TYPE_INNER));
                                tmpTarget = null,
                                ...
                                for (var s in settings)
                                    settings[s].treeId && settings[s].edit.enable && settings[s].treeId != setting.treeId && (event.target.id == settings[s].treeId || $(event.target).parents("#" + settings[s].treeId).length > 0) && (isOtherTree = !0,
                                ...
                                if (event.target && tools.isChildOrSelf(event.target, targetSetting.treeId)) {
                                    for (var targetObj = event.target; targetObj && targetObj.tagName && !tools.eqs(targetObj.tagName, "li") && targetObj.id != targetSetting.treeId; )
                                        targetObj = targetObj.parentNode;
                                    var canMove = !0;
                                    for (i = 0,
                                             l = nodes.length; i < l; i++) {
                                        if (tmpNode = nodes[i],
                                            targetObj.id === tmpNode.tId) {
                                            canMove = !1;
                                            break
                                        }
                                    ...
                                    canMove && event.target && tools.isChildOrSelf(event.target, targetObj.id + consts.id.A) && (tmpTarget = $(targetObj),
                                        tmpTargetNodeId = targetObj.id)
                                }
                                tmpNode = nodes[0],
                                isTreeInner && tools.isChildOrSelf(event.target, targetSetting.treeId) && (!tmpTarget && (event.target.id == targetSetting.treeId || isTreeTop || isTreeBottom || isTreeLeft || isTreeRight) && (isOtherTree || !isOtherTree && tmpNode.parentTId) && (tmpTarget = targetSetting.treeObj),
                                    isTop ? targetSetting.treeObj.scrollTop(targetSetting.treeObj.scrollTop() - 10) : isBottom && targetSetting.treeObj.scrollTop(targetSetting.treeObj.scrollTop() + 10),
                                    isLeft ? targetSetting.treeObj.scrollLeft(targetSetting.treeObj.scrollLeft() - 10) : isRight && targetSetting.treeObj.scrollLeft(targetSetting.treeObj.scrollLeft() + 10),
                                tmpTarget && tmpTarget != targetSetting.treeObj && tmpTarget.offset().left < targetSetting.treeObj.offset().left && targetSetting.treeObj.scrollLeft(targetSetting.treeObj.scrollLeft() + tmpTarget.offset().left - targetSetting.treeObj.offset().left)),
                                    curNode.css({
                                ...
                                if (tmpTarget && tmpTarget.attr("id") != targetSetting.treeId) {
                                    ...
                                    if (canPrev || canNext || canInner) {
                                        ...
                                        if ((1 == prevPercent || dY_percent <= prevPercent && dY_percent >= -.2) && canPrev ? (dX = 1 - tmpArrow.width(),
                                                dY = tmpTop - tmpArrow.height() / 2,
                                                moveType = consts.move.TYPE_PREV) : (0 == nextPercent || dY_percent >= nextPercent && dY_percent <= 1.2) && canNext ? (dX = 1 - tmpArrow.width(),
                                                dY = null == tmpNextA || tmpTargetNode.isParent && tmpTargetNode.open ? tmpTop + tmpTargetA.height() - tmpArrow.height() / 2 : tmpNextA.offset().top - tmpArrow.height() / 2,
                                                moveType = consts.move.TYPE_NEXT) : (dX = 5 - tmpArrow.width(),
                                                dY = tmpTop,
                                                moveType = consts.move.TYPE_INNER),
                                                tmpArrow.css({
                                                    display: "block",
                                            ...
                                            preTmpTargetNodeId == tmpTargetNodeId && preTmpMoveType == moveType || (startTime = (new Date).getTime()),
                                            tmpTargetNode && tmpTargetNode.isParent && moveType == consts.move.TYPE_INNER) {
                                            var startTimer = !0;
                                            window.zTreeMoveTimer && window.zTreeMoveTargetNodeTId !== tmpTargetNode.tId ? (clearTimeout(window.zTreeMoveTimer),
                                                window.zTreeMoveTargetNodeTId = null) : window.zTreeMoveTimer && window.zTreeMoveTargetNodeTId === tmpTargetNode.tId && (startTimer = !1),
                                            startTimer && (window.zTreeMoveTimer = setTimeout(function() {
                                                moveType == consts.move.TYPE_INNER && tmpTargetNode && tmpTargetNode.isParent && !tmpTargetNode.open && (new Date).getTime() - startTime > targetSetting.edit.drag.autoOpenTime && tools.apply(targetSetting.callback.beforeDragOpen, [targetSetting.treeId, tmpTargetNode], !0) && (view.switchNode(targetSetting, tmpTargetNode),
                                                targetSetting.edit.drag.autoExpandTrigger && targetSetting.treeObj.trigger(consts.event.EXPAND, [targetSetting.treeId, tmpTargetNode]))
                                    ...
                                    moveType = consts.move.TYPE_INNER,
                                        tmpTarget && tools.apply(targetSetting.edit.drag.inner, [targetSetting.treeId, nodes, null], !!targetSetting.edit.drag.inner) ? tmpTarget.addClass(consts.node.TMPTARGET_TREE) : tmpTarget = null,
                                        tmpArrow.css({
                                            display: "none"
                                        }),
                                    window.zTreeMoveTimer && (clearTimeout(window.zTreeMoveTimer),
                        ...
                        function _docMouseUp(event) {
                            function dropCallback() {
                                if (isOtherTree) {
                                    ...
                                    else if (view.addNodes(targetSetting, dragTargetNode.getParentNode(), newNodes),
                                        moveType == consts.move.TYPE_PREV)
                                        for (i = 0,
                                                 l = newNodes.length; i < l; i++)
                                            view.moveNode(targetSetting, dragTargetNode, newNodes[i], moveType, !1);
                                    else
                                        for (i = -1,
                                                 l = newNodes.length - 1; i < l; l--)
                                            view.moveNode(targetSetting, dragTargetNode, newNodes[l], moveType, !1)
                                } else if (isCopy && moveType == consts.move.TYPE_INNER)
                                    view.addNodes(targetSetting, dragTargetNode, newNodes);
                                else if (isCopy && view.addNodes(targetSetting, dragTargetNode.getParentNode(), newNodes),
                            ...
                            if (window.zTreeMoveTimer && (clearTimeout(window.zTreeMoveTimer),
                                ...
                                tmpTarget && (tmpTarget.removeClass(consts.node.TMPTARGET_TREE),
                                tmpTargetNodeId && $("#" + tmpTargetNodeId + consts.id.A, tmpTarget).removeClass(consts.node.TMPTARGET_NODE + "_" + consts.move.TYPE_PREV).removeClass(consts.node.TMPTARGET_NODE + "_" + _consts.move.TYPE_NEXT).removeClass(consts.node.TMPTARGET_NODE + "_" + _consts.move.TYPE_INNER)),
                                    tools.showIfameMask(setting, !1),
                                    roots.showHoverDom = !0,
                                0 != root.dragFlag) {
                                root.dragFlag = 0;
                                var i, l, tmpNode;
                                for (i = 0,
                                         l = nodes.length; i < l; i++)
                                    tmpNode = nodes[i],
                                    tmpNode.isParent && root.dragNodeShowBefore[tmpNode.tId] && !tmpNode.open && (view.expandCollapseNode(setting, tmpNode, !tmpNode.open),
                                        delete root.dragNodeShowBefore[tmpNode.tId]);
                                curNode && curNode.remove(),
                                tmpArrow && tmpArrow.remove();
                                var isCopy = (event.ctrlKey || event.metaKey) && setting.edit.drag.isMove && setting.edit.drag.isCopy || !setting.edit.drag.isMove && setting.edit.drag.isCopy;
                                if (!isCopy && tmpTarget && tmpTargetNodeId && nodes[0].parentTId && tmpTargetNodeId == nodes[0].parentTId && moveType == consts.move.TYPE_INNER && (tmpTarget = null),
                                        tmpTarget) {
                                    var dragTargetNode = null == tmpTargetNodeId ? null : data.getNodeCache(targetSetting, tmpTargetNodeId);
                                    if (0 == tools.apply(setting.callback.beforeDrop, [targetSetting.treeId, nodes, dragTargetNode, moveType, isCopy], !0))
                                        return void view.selectNodes(sourceSetting, nodes);
                        ...
                        if (2 == eventMouseDown.button || !setting.edit.enable || !setting.edit.drag.isCopy && !setting.edit.drag.isMove)
                            return !0;
                        ...
                        if (data.isSelectedNode(setting, _node))
                            for (i = 0,
                                     l = _nodes.length; i < l; i++) {
                                if (_nodes[i].editNameFlag && tools.eqs(target.tagName, "input") && null !== target.getAttribute("treeNode" + consts.id.INPUT))
                                    return !0;
                                if (nodes.push(_nodes[i]),
                                    nodes[0].parentTId !== _nodes[i].parentTId) {
                                    nodes = [_node];
                                    break
                                }
                            }
                    ...
                    showIfameMask: function(setting, showSign) {
                        for (var root = data.getRoot(setting); root.dragMaskList.length > 0; )
                            root.dragMaskList[0].remove(),
                                root.dragMaskList.shift();
                        if (showSign)
                            for (var iframeList = $$("iframe", setting), i = 0, l = iframeList.length; i < l; i++) {
                        ...
                        if (!(node.editNameFlag || $$(node, consts.id.EDIT, setting).length > 0) && tools.apply(setting.edit.showRenameBtn, [setting.treeId, node], setting.edit.showRenameBtn)) {
                            ...
                            aObj.append(editStr),
                                $$(node, consts.id.EDIT, setting).bind("click", function() {
                                    return !(!tools.uCanDo(setting) || 0 == tools.apply(setting.callback.beforeEditName, [setting.treeId, node], !0)) && (view.editNode(setting, node),
                                        !1)
                                }).show()
                        }
                    },
                        ...
                        if (!(node.editNameFlag || $$(node, consts.id.REMOVE, setting).length > 0) && tools.apply(setting.edit.showRemoveBtn, [setting.treeId, node], setting.edit.showRemoveBtn)) {
                            ...
                            aObj.append(removeStr),
                                $$(node, consts.id.REMOVE, setting).bind("click", function() {
                                    return !(!tools.uCanDo(setting) || 0 == tools.apply(setting.callback.beforeRemove, [setting.treeId, node], !0)) && (view.removeNode(setting, node),
                    ...
                    addHoverDom: function(setting, node) {
                        data.getRoots().showHoverDom && (node.isHover = !0,
                        setting.edit.enable && (view.addEditBtn(setting, node),
                    ...
                    cancelCurEditNode: function(setting, forceName, isCancel) {
                        ...
                        if (node) {
                            ...
                            if (!1 === tools.apply(setting.callback.beforeRename, [setting.treeId, node, newName, isCancel], !0))
                                return !1;
                            node[nameKey] = newName,
                                setting.treeObj.trigger(consts.event.RENAME, [setting.treeId, node, isCancel]);
                            $$(node, consts.id.A, setting).removeClass(consts.node.CURSELECTED_EDIT),
                                inputObj.unbind(),
                        ...
                        return root.noSelection = !0,
                            !0
                    },
                    editNode: function(setting, node) {
                        var root = data.getRoot(setting);
                        if (view.editNodeBlur = !1,
                            data.isSelectedNode(setting, node) && root.curEditNode == node && node.editNameFlag)
                        ...
                        inputObj.attr("value", node[nameKey]),
                            setting.edit.editNameSelectAll ? tools.inputSelect(inputObj) : tools.inputFocus(inputObj),
                            inputObj.bind("blur", function(event) {
                                view.editNodeBlur || view.cancelCurEditNode(setting)
                            }).bind("keydown", function(event) {
                                "13" == event.keyCode ? (view.editNodeBlur = !0,
                                    view.cancelCurEditNode(setting)) : "27" == event.keyCode && view.cancelCurEditNode(setting, null, !0)
                    ...
                    moveNode: function(setting, targetNode, node, moveType, animateFlag, isSilent) {
                        ...
                        if (targetNode != node && (!setting.data.keep.leaf || !targetNode || targetNode.isParent || moveType != consts.move.TYPE_INNER)) {
                            ...
                            targetNodeIsRoot && null === targetNode && (targetNode = root),
                            targetNodeIsRoot && (moveType = consts.move.TYPE_INNER);
                            var targetParentNode = targetNode.parentTId ? targetNode.getParentNode() : root;
                            moveType != consts.move.TYPE_PREV && moveType != consts.move.TYPE_NEXT && (moveType = consts.move.TYPE_INNER),
                            moveType == consts.move.TYPE_INNER && (targetNodeIsRoot ? node.parentTId = null : (targetNode.isParent || (targetNode.isParent = !0,
                            ...
                            if (targetNodeIsRoot)
                                ...
                                if (isSilent || moveType != consts.move.TYPE_INNER ? isSilent || view.expandCollapseNode(setting, targetNode.getParentNode(), !0, !1) : view.expandCollapseNode(setting, targetNode, !0, !1),
                                        targetObj = $$(targetNode, setting),
                                        target_ulObj = $$(targetNode, consts.id.UL, setting),
                                    targetObj.get(0) && !target_ulObj.get(0)) {
                                    var ulstr = [];
                            ...
                            nodeDom.get(0) ? targetObj.get(0) || nodeDom.remove() : nodeDom = view.appendNodes(setting, node.level, [node], null, !1, !0).join(""),
                                target_ulObj.get(0) && moveType == consts.move.TYPE_INNER ? target_ulObj.append(nodeDom) : targetObj.get(0) && moveType == consts.move.TYPE_PREV ? targetObj.before(nodeDom) : targetObj.get(0) && moveType == consts.move.TYPE_NEXT && targetObj.after(nodeDom);
                            var i, l, tmpSrcIndex = -1, tmpTargetIndex = 0, oldNeighbor = null, newNeighbor = null, oldLevel = node.level;
                            if (node.isFirstNode)
                                tmpSrcIndex = 0,
                                oldParentNode[childKey].length > 1 && (oldNeighbor = oldParentNode[childKey][1],
                                    oldNeighbor.isFirstNode = !0);
                            else if (node.isLastNode)
                                tmpSrcIndex = oldParentNode[childKey].length - 1,
                                    oldNeighbor = oldParentNode[childKey][tmpSrcIndex - 1],
                                    oldNeighbor.isLastNode = !0;
                            else
                                for (i = 0,
                                         l = oldParentNode[childKey].length; i < l; i++)
                            ...
                            if (tmpSrcIndex >= 0 && oldParentNode[childKey].splice(tmpSrcIndex, 1),
                                moveType != consts.move.TYPE_INNER)
                                for (i = 0,
                                         l = targetParentNode[childKey].length; i < l; i++)
                                    targetParentNode[childKey][i].tId == targetNode.tId && (tmpTargetIndex = i);
                            if (moveType == consts.move.TYPE_INNER ? (targetNode[childKey] || (targetNode[childKey] = new Array),
                                targetNode[childKey].length > 0 && (newNeighbor = targetNode[childKey][targetNode[childKey].length - 1],
                                    newNeighbor.isLastNode = !1),
                                    targetNode[childKey].splice(targetNode[childKey].length, 0, node),
                                    node.isLastNode = !0,
                                    node.isFirstNode = 1 == targetNode[childKey].length) : targetNode.isFirstNode && moveType == consts.move.TYPE_PREV ? (targetParentNode[childKey].splice(tmpTargetIndex, 0, node),
                                    newNeighbor = targetNode,
                                    newNeighbor.isFirstNode = !1,
                                    node.parentTId = targetNode.parentTId,
                                    node.isFirstNode = !0,
                                    node.isLastNode = !1) : targetNode.isLastNode && moveType == consts.move.TYPE_NEXT ? (targetParentNode[childKey].splice(tmpTargetIndex + 1, 0, node),
                                    newNeighbor = targetNode,
                                    newNeighbor.isLastNode = !1,
                                    node.parentTId = targetNode.parentTId,
                                    node.isFirstNode = !1,
                                    node.isLastNode = !0) : (moveType == consts.move.TYPE_PREV ? targetParentNode[childKey].splice(tmpTargetIndex, 0, node) : targetParentNode[childKey].splice(tmpTargetIndex + 1, 0, node),
                                    node.parentTId = targetNode.parentTId,
                                    node.isFirstNode = !1,
                                    node.isLastNode = !1),
                                ...
                                !setting.data.keep.parent && oldParentNode[childKey].length < 1) {
                                oldParentNode.isParent = !1,
                                    oldParentNode.open = !1;
                                ...
                                oldNeighbor && view.setNodeLineIcos(setting, oldNeighbor);
                            newNeighbor && view.setNodeLineIcos(setting, newNeighbor),
                            setting.check && setting.check.enable && view.repairChkClass && (view.repairChkClass(setting, oldParentNode),
                                view.repairParentChkClassWithSelf(setting, oldParentNode),
                            oldParentNode != node.parent && view.repairParentChkClassWithSelf(setting, node)),
                            isSilent || view.expandCollapseParentNode(setting, node.getParentNode(), !0, animateFlag)
                        }
                    },
                ...
                view.cancelPreSelectedNode = function(setting, node) {
                    for (var list = data.getRoot(setting).curSelectedList, i = 0, j = list.length; i < j && (node && node !== list[i] || (view.removeTreeDom(setting, list[i]),
                        !node)); i++)
                        ;
                ...
                view.createNodes = function(setting, level, nodes, parentNode) {
                    _createNodes && _createNodes.apply(view, arguments),
                    nodes && view.repairParentChkClassWithSelf && view.repairParentChkClassWithSelf(setting, parentNode)
                }
                ;
                ...
                view.removeNode = function(setting, node) {
                    var root = data.getRoot(setting);
                    root.curEditNode === node && (root.curEditNode = null),
                    _removeNode && _removeNode.apply(view, arguments)
                }
                ;
                ...
                view.selectNode = function(setting, node, addFlag) {
                    var root = data.getRoot(setting);
                    return (!data.isSelectedNode(setting, node) || root.curEditNode != node || !node.editNameFlag) && (_selectNode && _selectNode.apply(view, arguments),
                        view.addHoverDom(setting, node),
                        !0)
                }
                ;
                ...
                tools.uCanDo = function(setting, e) {
                    var root = data.getRoot(setting);
                    return !(!e || !(tools.eqs(e.type, "mouseover") || tools.eqs(e.type, "mouseout") || tools.eqs(e.type, "mousedown") || tools.eqs(e.type, "mouseup"))) || (root.curEditNode && (view.editNodeBlur = !1,
                        root.curEditInput.focus()),
                    !root.curEditNode && (!_uCanDo || _uCanDo.apply(view, arguments)))
                }
            }(jQuery)
    }
    , function(module, exports) {
        window.ZtreeCreator = function(treeId, url, initJson) {
            function pushJsonToBuildTree(json, level, callBack) {
                if (_treeObj = jQuery.fn.zTree.init(jQuery("#" + treeId), _setting, json),
                        level ? (_treeObj.expandAll(!1),
                            expandTree(_treeObj, _treeObj.getNodes(), level)) : _treeObj.expandAll(!0),
                    jQuery.isFunction(callBack) && callBack(_treeObj, treeId),
                        outLookStyle) {
                    try {
            ...
            function expandTree(treeObj, nodes, level) {
                for (var thelevel = level - 1, i = 0; i < nodes.length; i++) {
                    var node = nodes[i];
                    treeObj.expandNode(node, !0, !1, !1),
                    thelevel > 0 && node.children && node.children.length > 0 && expandTree(treeObj, node.children, thelevel)
                }
            }
            treeId || alert("构造Ztree必须提供 treeId"),
                this.treeId = treeId;
            var _treeObj, outLookStyle = !1;
            this.initZtree = function(param, level, callBack) {
                return url || _setting.async.url || alert("构造Ztree必须提供 请求地址！"),
                jQuery.isFunction(param) && (callBack = param,
                    param = {}),
                jQuery.isFunction(level) && (callBack = level,
                    level = !1),
                param || (param = {}),
                    initJson ? (pushJsonToBuildTree(initJson, level, callBack),
                        this) : _setting.async.url ? (_treeObj = jQuery.fn.zTree.init(jQuery("#" + treeId), _setting),
                        this) : (jQuery.post(url, param, function(result) {
                        "[object String]" === Object.prototype.toString.call(result) && (result = eval("(" + result + ")")),
                        result && result.code && (result = result.data),
                ...
                this.getTreeObj = function() {
                    return _treeObj || alert(treeId + "尚未初始化"),
                        _treeObj
                }
                ,
                this.setDataKey = function(keys) {
                    return keys ? (keys.idKey && (_setting.data.simpleData.idKey = keys.idKey),
                    keys.pIdKey && (_setting.data.simpleData.pIdKey = keys.pIdKey),
                    keys.name && (_setting.data.key.name = keys.name),
                    keys.title && (_setting.data.key.title = keys.title),
                    keys.rootPId && (_setting.data.simpleData.rootPId = keys.rootPId),
                        this) : this
                }
                ,
                this.setChildKey = function(key) {
                    return key || (key = "children"),
                        _setting.data.simpleData.enable = !1,
                        _setting.data.key.children = key,
                        this
                }
                ,
                this.setCheckboxType = function(type) {
                    return _setting.check.enable = !0,
                    type instanceof Object && (_setting.check.chkboxType = type),
                        this
                }
                ,
                this.setCallback = function(callBack) {
                    if (callBack instanceof Object)
                        for (call in callBack)
                            jQuery.isFunction(callBack[call]) || alert(call + " :is not a function"),
                                _setting.callback[call] = callBack[call];
                    return this
                }
                ,
                this.setAsync = function(conf) {
                    return _setting.async = conf,
                        this
                }
                ,
                this.setShowIcon = function(call) {
                    return _setting.view.showIcon = call,
                        this
                }
                ,
                    ...
                    return this.setSetingParam({
                        view: {
                            ...
                            addDiyDom: function(treeId, treeNode) {
                                ...
                                if (switchObj.remove(),
                                    treeNode.children && 0 != treeNode.children.length || switchObj.removeClass("switch"),
            ...
            this.makeCombTree = function(isShowIn, width, height) {
                ...
                return jQuery("#" + isShowIn).after(menuContent),
