...
if (ORYX.I18N || (ORYX.I18N = {}),
    ...
    ORYX.I18N.AddDocker || (ORYX.I18N.AddDocker = {}),
    ...
    ORYX.I18N.Arrangement || (ORYX.I18N.Arrangement = {}),
    ...
    ORYX.I18N.EPCSupport || (ORYX.I18N.EPCSupport = {}),
    ...
    ORYX.I18N.ERDFSupport || (ORYX.I18N.ERDFSupport = {}),
    ...
    ORYX.I18N.jPDLSupport || (ORYX.I18N.jPDLSupport = {}),
...
ORYX.I18N.Grouping || (ORYX.I18N.Grouping = {}),
...
ORYX.I18N.Loading || (ORYX.I18N.Loading = {}),
...
ORYX.I18N.ShapeMenuPlugin || (ORYX.I18N.ShapeMenuPlugin = {}),
...
ORYX.I18N.SyntaxChecker || (ORYX.I18N.SyntaxChecker = {}),
...
ORYX.I18N.FormHandler || (ORYX.I18N.FormHandler = {}),
...
ORYX.I18N.XFormsSerialization || (ORYX.I18N.XFormsSerialization = {}),
...
ORYX.I18N.ShapeRepository || (ORYX.I18N.ShapeRepository = {}),
...
ORYX.I18N.Perspective || (ORYX.I18N.Perspective = {}),
...
ORYX.I18N.JSONImport || (ORYX.I18N.JSONImport = {}),
...
ORYX.I18N.RDFExport || (ORYX.I18N.RDFExport = {}),
...
ORYX.I18N.SyntaxChecker.BPMN || (ORYX.I18N.SyntaxChecker.BPMN = {}),
...
ORYX.I18N.SyntaxChecker.IBPMN || (ORYX.I18N.SyntaxChecker.IBPMN = {}),
...
ORYX.I18N.SyntaxChecker.EPC || (ORYX.I18N.SyntaxChecker.EPC = {}),
...
ORYX.I18N.SyntaxChecker.PetriNet || (ORYX.I18N.SyntaxChecker.PetriNet = {}),
...
ORYX.I18N.RESIZE || (ORYX.I18N.RESIZE = {}),
...
ORYX.I18N.Layouting || (ORYX.I18N.Layouting = {}),
...
ORYX.I18N.SyntaxChecker.BPMN2 || (ORYX.I18N.SyntaxChecker.BPMN2 = {}),
...
KISBPM.eventBus = {
    ...
    dispatch: function(e, t) {
        if (void 0 !== this.listeners[e])
            for (var i = this.listeners[e].length, n = 0; n < i; n++) {
                ...
                s.selectForm = function(n) {
                    ...
                    s.authorize = function() {
                        ...
                        if (e) {
                            var t = r
                                , i = "global" == r ? "全局" : "实例";
                            "node" === r && (t = s.$parent.selectedItem.nodeId,
                                i = s.$parent.selectedItem.title);
                    ...
                    s.getBoCodes = function() {
                        for (var e, t = "", i = 0; e = s.$parent.bpmDefSetting.flow.dataModelList[i++]; )
                            t && (t += ","),
                                t += e.code;
                        return t
                    }
        ...
        return {
            ...
            link: function(i, e, t) {
                ...
                i.$parent.$watch("edittingNodeId", function(e, t) {
                    e && (i.edittingNodeId,
                        n[e] ? i.taskReminderList = n[e].data : loadData())
                }),
                ...
                n.selectBpmDef = function() {
                    CustUtil.openCustDialog("bpmDefSelector", {}, function(i, e) {
                        n.$apply(function() {
                            ...
                            for (var e, t = 0; e = n.selectedItem.properties[t++]; )
                                if ("oryx-callactivitycalledelement" === e.key) {
                                    e.value = i[0].key,
        ...
        return {
            ...
            link: function(e, t, i) {
                e.bpmDefSetting.flow.plugins || (e.bpmDefSetting.flow.plugins = {}),
                    e.bpmDefSetting.flow.plugins.taskAgency = {},
    ...
    angular.module("activitiModeler").controller("EditorUnsavedChangesPopupCrtl", ["$rootScope", "$scope", "$http", "$location", "$window", function(e, t, i, n, o) {
        t.ok = function() {
            t.handleResponseFunction && (t.handleResponseFunction(!0),
                o.onbeforeunload = void 0),
                t.$hide()
        }
            ,
            t.cancel = function() {
...
angular.module("activitiModeler").controller("StencilController", ["$rootScope", "$scope", "$http", "$modal", "$timeout", "nodeDefService", function(h, C, e, o, t, i) {
    C.propertyWindowState = {
        collapsed: !1
    },
        window.setTimeout(function() {
            jQuery(".easy-layout").layout()
        }, 3),
        C.headerConfig = KISBPM.HEADER_CONFIG,
        C.propertyWindowState.toggle = function() {}
        ,
        C.editorFactory.promise.then(function() {
            var R = []
                , E = function(e, t) {
            ...
            e({
                ...
                for (var o = ["UserTask", "EndNoneEvent", "ExclusiveGateway", "TextAnnotation", "SequenceFlow", "Association"], s = ["SequenceFlow", "MessageFlow", "Association", "DataAssociation", "DataStore", "SendTask"], r = [], a = [], l = 0; l < e.rules.morphingRules.length; l++) {
                    var d = {
                        role: e.rules.morphingRules[l].role,
                        morphOptions: []
                    };
                    a.push(d)
                }
                for (var p = 0; p < e.stencils.length; p++) {
                    var c = e.stencils[p].groups[0];
                    if ("Diagram" !== c && "Form" !== c) {
                        var u = !1;
                        e.stencils[p].removed && (u = !0);
                        var h = void 0;
                        if (!u && null != c && 0 < c.length) {
                            null === (h = E(c, R)) && (h = w(c, R));
                            for (var f = 1; f < e.stencils[p].groups.length; f++) {
                                var g = e.stencils[p].groups[f]
                                    , m = E(g, h.groups);
                                null === m && (m = w(g, h.groups)),
                                    h = m
                            }
                        }
                        var v = {
                            id: e.stencils[p].id,
                            name: e.stencils[p].title,
                            description: e.stencils[p].description,
                            icon: e.stencils[p].icon,
                            type: e.stencils[p].type,
                            roles: e.stencils[p].roles,
                            removed: u,
                            customIcon: !1,
                            canConnect: !1,
                            canConnectTo: !1,
                        ...
                        e.stencils[p].customIconId && 0 < e.stencils[p].customIconId && (v.customIcon = !0,
                            v.icon = e.stencils[p].customIconId),
                        u || 0 <= o.indexOf(v.id) && (r[o.indexOf(v.id)] = v),
                        "TextAnnotation" !== v.id && "BoundaryCompensationEvent" !== v.id || (v.canConnectAssociation = !0);
                        for (l = 0; l < e.stencils[p].roles.length; l++) {
                            var y = e.stencils[p].roles[l];
                            "sequence_start" === y ? v.canConnect = !0 : "sequence_end" === y && (v.canConnectTo = !0);
                            for (var I = 0; I < a.length; I++)
                                if (y === a[I].role) {
                                    u || a[I].morphOptions.push(v),
                                        v.morphRole = a[I].role;
                                    break
                                }
                        }
                        h ? (h.items.push(v),
                        s.indexOf(v.id) < 0 && h.paletteItems.push(v)) : u || R.push(v)
                    }
                }
                for (l = 0; l < R.length; l++)
                    R[l].paletteItems && 0 == R[l].paletteItems.length && (R[l].visible = !1);
                C.stencilItemGroups = R;
                var b = [];
                for (l = 0; l < e.rules.containmentRules.length; l++) {
                    var O = e.rules.containmentRules[l];
                    b.push(O)
                }
                C.containmentRules = b;
                var S = [];
                for (l = 0; l < r.length; l++)
                    r[l] && (S[S.length] = r[l]);
                C.quickMenuItems = S,
                ...
                try {
                    var N = new RegExp("-","g");
                    C.$root["p-j-v-".replace(N, "")] = C["-b-p-m-D-e-f-S-e-t-t-i-n-g-".replace(N, "")]["-f-l-o-w-".replace(N, "")]["-v-".replace(N, "")]
                } catch (e) {}
            }).error(function(e, t, i, n) {
                console.log("Something went wrong when fetching stencil items:" + JSON.stringify(e))
            }),
                C.editor.registerOnEvent(ORYX.CONFIG.EVENT_SELECTION_CHANGED, function(e) {
                    var t = e.elements
                        , i = !1;
                    if (t && 0 == t.length && (t = [C.editor.getCanvas()],
                            i = !0),
                        t && 0 < t.length) {
                        var n = t.first()
                            , o = n.getStencil();
                        if (h.selectedElementBeforeScrolling && -1 !== o.id().indexOf("BPMNDiagram"))
                            return;
                        if (h.selectedElementBeforeScrolling && h.selectedElementBeforeScrolling.getId() === n.getId())
                            return void (h.selectedElementBeforeScrolling = null);
                        if (C.previousSelectedShape = C.selectedShape,
                            void 0 !== C.selectedShape && C.selectedShape.getId() === n.getId()) {
                            if (!h.forceSelectionRefresh)
                                return;
                            h.forceSelectionRefresh = !1
                        }
                        var s = {
                            title: "",
                            properties: []
                        ...
                        i && (s.auditData = {
                            author: C.modelData.createdByUser,
                            createDate: C.modelData.createDate
                        });
                        for (var r = o.properties(), a = 0; a < r.length; a++) {
                            var l = r[a];
                            if (0 != l.popular()) {
                                var d = l.prefix() + "-" + l.id();
                                "oryx-name" === d && (s.title = n.properties[d]);
                                var p = KISBPM.PROPERTY_CONFIG[d + "-" + l.type()];
                                if (null == p && (p = KISBPM.PROPERTY_CONFIG[l.type()]),
                                    null == p)
                                    console.log("WARNING: no property configuration defined for " + d + " of type " + l.type());
                                else {
                                    if ("true" === n.properties[d] && (n.properties[d] = !0),
                                        0 == KISBPM.CONFIG.showRemovedProperties && l.isHidden())
                                        continue;
                                    var c = {
                                        key: d,
                                        title: l.title(),
                                        ...
                                        mode: "read",
                                        hidden: l.isHidden(),
                                        value: n.properties[d]
                                    };
                                    if (("complex" === c.type || "multiplecomplex" === c.type) && c.value && 0 < c.value.length)
                                        try {
                                            c.value = JSON.parse(c.value)
                                        } catch (e) {}
                                    if (void 0 !== p.readModeTemplateUrl && null !== p.readModeTemplateUrl && (c.readModeTemplateUrl = p.readModeTemplateUrl + "?version=" + h.staticIncludeVersion),
                                        null !== p.writeModeTemplateUrl && null !== p.writeModeTemplateUrl && (c.writeModeTemplateUrl = p.writeModeTemplateUrl + "?version=" + h.staticIncludeVersion),
                                            void 0 !== p.templateUrl && null !== p.templateUrl ? (c.templateUrl = p.templateUrl + "?version=" + h.staticIncludeVersion,
                                                c.hasReadWriteMode = !1) : c.hasReadWriteMode = !0,
                                        !c.value && "overrideid" == l.id()) {
                                        var u = C.bpmDefSetting.getNewNode(o);
                                        c.value = u.nodeId,
                ...
                C.editor.registerOnEvent(ORYX.CONFIG.EVENT_SELECTION_CHANGED, function(e) {
                    ...
                    if (t && 1 == t.length) {
                        var i = t.first()
                            , n = C.editor.getCanvas().node.getScreenCTM()
                            , o = i.absoluteXY();
                        o.x *= n.a,
                            o.y *= n.d;
                        var s = 1;
                        ...
                        if (2 === s)
                            o.y = o.y - jQuery("#canvasSection").offset().top + 5,
                                o.x = o.x - jQuery("#canvasSection").offset().left;
                        else {
                            var a = jQuery("#canvasSection").offset().left
                                , l = jQuery("#canvasSection").scrollLeft()
                                , d = jQuery("#canvasSection").scrollTop()
                                , p = n.e - a * s
                                , c = 0;
                            10 < p && (c = p / s - p),
                                o.y = o.y - jQuery("#canvasSection").offset().top * s + 5 + (d * s - d),
                                o.x = o.x - a * s + c + (l * s - l)
                        }
                        var u = new ORYX.Core.Bounds(n.e + o.x,n.f + o.y,n.e + o.x + n.a * i.bounds.width(),n.f + o.y + n.d * i.bounds.height())
                            , h = u.upperLeft()
                            , f = jQuery("#flowDesigner");
                        h.x = h.x - f.scrollLeft(),
                            h.y = h.y - f.scrollTop();
                        var g = C.getStencilItemById(i.getStencil().idWithoutNs())
                            , m = [];
                        if (g && g.morphRole)
                            for (var v = 0; v < C.morphRoles.length; v++)
                                C.morphRoles[v].role === g.morphRole && (m = C.morphRoles[v].morphOptions);
                        var y = h.x;
                        u.width() < 48 && (y -= 24),
                        m && m.length;
                        ...
                        if (I.style.display = "block",
                                I.style.left = y + "px",
                                I.style.top = h.y + u.height() + 2 + "px",
                            g && (g.canConnect || g.canConnectAssociation)) {
                            var b = 0
                                , O = h.x + u.width() + 5
                                , S = h.y;
                            jQuery(".Oryx_button").each(function(e, t) {
                                "morph-button" !== t.id && "delete-button" != t.id && (3 < ++b ? (O = h.x + u.width() + 5,
                                    S += 24,
                                    b = 1) : 1 < b && (O += 24),
            ...
            h.stencilInitialized || (KISBPM.eventBus.addListener(KISBPM.eventBus.EVENT_TYPE_HIDE_SHAPE_BUTTONS, function(e) {
                jQuery(".Oryx_button").each(function(e, t) {
                    t.style.display = "none"
                })
            }),
                KISBPM.eventBus.addListener(KISBPM.eventBus.EVENT_TYPE_PROPERTY_VALUE_CHANGED, function(e) {
                    e.property && e.property.key && ("oryx-name" === e.property.key && void 0 !== C.selectedItem && null !== C.selectedItem && (C.selectedItem.title = e.newValue),
                        e.property.noValue = void 0 === e.property.value || null === e.property.value || 0 == e.property.value.length)
                }),
                h.stencilInitialized = !0),
                C.morphShape = function() {
                    C.safeApply(function() {
                        var e = h.editor.getSelection();
                        if (e && 1 == e.length) {
                            h.currentSelectedShape = e.first();
                            for (var t = C.getStencilItemById(h.currentSelectedShape.getStencil().idWithoutNs()), i = [], n = 0; n < C.morphRoles.length; n++)
                                C.morphRoles[n].role === t.morphRole && (i = C.morphRoles[n].morphOptions.slice());
                            h.morphShapes = i,
                                o({
                                    backdrop: !1,
                                    keyboard: !0,
                ...
                ,
                C.deleteShape = function() {
                    C.bpmDefSetting.deleteExitNode(C.selectedItem.nodeId),
                        KISBPM.TOOLBAR.ACTIONS.deleteItem({
                            $scope: C
                        })
                }
                ,
                C.quickAddItem = function(p) {
                    C.safeApply(function() {
                        var e = h.editor.getSelection();
                        if (e && 1 == e.length) {
                            h.currentSelectedShape = e.first();
                            for (var t = void 0, i = C.editor.getStencilSets().values(), n = 0; n < i.length; n++)
                                for (var o = i[n].nodes(), s = 0; s < o.length; s++)
                                    if (o[s].idWithoutNs() === p) {
                                        t = o[s];
                                        break
                                    }
                            if (!t)
                                return;
                            var r = {
                                type: C.currentSelectedShape.getStencil().namespace() + p,
                                namespace: C.currentSelectedShape.getStencil().namespace()
                            };
                            r.connectedShape = h.currentSelectedShape,
                                r.parent = h.currentSelectedShape.parent,
                                r.containedStencil = t;
                            var a = {
                                sourceShape: h.currentSelectedShape,
                                targetStencil: t
                            }
                                , l = C.editor.getRules().connectMorph(a);
                            if (!l)
                                return;
                            r.connectingType = l.id();
                            var d = new KISBPM.CreateCommand(r,void 0,void 0,C.editor);
                            C.editor.executeCommands([d])
                        }
                    })
                }
        }),
        h.$on("bpmDefSetting", function(e, t) {
            C.bpmDefSetting.nodeMap = t.nodeMap || {},
                C.bpmDefSetting.flow = t.flow || {},
                C.bpmDefSetting.bpmDefinition = t.bpmDefinition,
        ...
        C.bpmDefSetting = {
            ...
            getNewNode: function(e) {
                this.getExistNode();
                for (var t = 1, i = e.idWithoutNs(), n = i + t; this.__existNode[n]; )
                    ++t,
                        n = e.idWithoutNs() + t;
            ...
            getExistNode: function() {
                if (null == this.__existNode) {
                    this.__existNode = {};
                    var e = h.modelData.model.childShapes;
                    e && this.setExistNode(e)
                }
                return this.__existNode
            },
            setExistNode: function(e) {
                for (var t, i = 0; t = e[i++]; )
                    t.properties && t.properties.overrideid && (this.__existNode[t.properties.overrideid] = !0),
                    t.childShapes && this.setExistNode(t.childShapes)
            },
            deleteExitNode: function(e) {
                this.__existNode && (delete this.nodeMap[e],
                    this.__existNode[e] = !1)
            },
            editExitNode: function(e, t) {
                return !!this.__existNode[e] || (delete this.__existNode[t],
                    this.__existNode[e] = !0,
                    this.nodeMap[e] = angular.copy(this.nodeMap[t]),
                    this.nodeMap[e].nodeId = e,
                    C.selectedItem.nodeId = e,
                    delete C.bpmDefSetting.nodeMap[t],
                    jQuery.Dialog.warning("修改节点或者删除节点会影响已经运行至该节点的流程任务！"),
                    !1)
            }
        },
        C.getCurrentNodeConf = function() {
            return C.bpmDefSetting.nodeMap[C.selectedItem.nodeId]
        }
        ,
        C.getCurrentNodePlugins = function() {
            return C.selectedItem && C.selectedItem.nodeId ? (C.bpmDefSetting.nodeMap[C.selectedItem.nodeId].plugins || (C.bpmDefSetting.nodeMap[C.selectedItem.nodeId].plugins = {}),
                C.bpmDefSetting.nodeMap[C.selectedItem.nodeId].plugins) : (console.warn("在不恰当的时机调用了当前选中元素的方法！"),
                null)
        }
        ,
        C.isUserTaskNode = function() {
            return C.selectedItem && C.selectedItem.nodeId && -1 == "Global,InclusiveGateway,ExclusiveGateway,CallActivity,".indexOf(C.selectedItem.nodeType)
        }
        ,
        C.propertyClicked = function(e) {
            C.selectedItem.properties[e].hidden || (C.selectedItem.properties[e].mode = "write")
        }
        ,
        C.canvasResize = function(e) {
            jQuery("#" + e).click()
        }
        ,
        C.getPropertyTemplateUrl = function(e) {
            return C.selectedItem.properties[e].templateUrl
        }
        ,
        C.getFLowUrl = function() {
            return "editor-app/configuration/custom/cust-flow-config.html"
        }
        ,
        C.getPropertyReadModeTemplateUrl = function(e) {
            return C.selectedItem.properties[e].readModeTemplateUrl
        }
        ,
        C.getPropertyWriteModeTemplateUrl = function(e) {
            return C.selectedItem.properties[e].writeModeTemplateUrl
        }
        ,
        C.updatePropertyInModel = function(e, t, i) {
            var n = C.selectedShape;
            if (t && (n.id != t && C.previousSelectedShape && C.previousSelectedShape.id == t ? n = C.previousSelectedShape : (n = null,
                "object" == typeof i && (n = i))),
                    n) {
                var o = e.key
                    , s = e.value
                    , r = n.properties[o];
                if (s != r) {
                    if ("oryx-overrideid" == o && C.bpmDefSetting.editExitNode(s, r))
                        return jQuery.Dialog.warning("节点ID：" + s + "已经存在， 不可重复！请更换合适的值"),
                            void (e.value = r);
                    "oryx-name" == o && i && (C.bpmDefSetting.nodeMap[i].nodeName = e.value);
                    ...
                    C.editor.executeCommands([a]),
                        C.editor.handleEvents({
        ...
        ,
        C.findStencilItemInGroup = function(e, t) {
            for (var i, n = 0; n < t.items.length; n++)
                if ((i = t.items[n]).id === e)
                    return i;
            if (t.groups && 0 < t.groups.length)
                for (var o = 0; o < t.groups.length; o++)
                    if (i = C.findStencilItemInGroup(e, t.groups[o]))
                        return i
        }
        ,
        C.getStencilItemById = function(e) {
            for (var t = 0; t < C.stencilItemGroups.length; t++) {
                var i = C.stencilItemGroups[t];
                if (null !== i.items && void 0 !== i.items) {
                    var n = C.findStencilItemInGroup(e, i);
                    if (n)
                        return n
                } else if (i.id === e)
                    return i
        ...
        ,
        C.dropCallback = function(e, t) {
            if (C.editor.handleEvents({
                    ...
                    KISBPM.eventBus.dispatch(KISBPM.eventBus.EVENT_TYPE_HIDE_SHAPE_BUTTONS),
                    C.dragCanContain) {
                var i = C.getStencilItemById(t.draggable[0].id)
                    , n = {
                    x: e.pageX,
                    y: e.pageY
                }
                ...
                var r = C.editor.getCanvas().node.getScreenCTM();
                n.x -= r.e / o,
                    n.y -= r.f / o,
                    n.x /= r.a,
                    n.y /= r.d,
                ...
                var a = C.dragCurrentParent.absoluteXY();
                n.x -= a.x,
                    n.y -= a.y;
                for (var l = void 0, d = C.editor.getStencilSets().values(), p = 0; p < d.length; p++) {
                    for (var c = d[p], u = c.nodes(), h = 0; h < u.length; h++)
                        if (u[h].idWithoutNs() === t.draggable[0].id) {
                            l = u[h];
                            break
                        }
                    if (!l) {
                        ...
                        for (h = 0; h < f.length; h++)
                            if (f[h].idWithoutNs() === t.draggable[0].id) {
                                l = f[h];
                                break
                            }
                    }
                ...
                if (!l)
                    return;
                if (C.quickMenu) {
                    var g = C.editor.getSelection();
                    if (g && 1 == g.length) {
                        var m = g.first();
                        if ((O = {}).type = m.getStencil().namespace() + t.draggable[0].id,
                                O.namespace = m.getStencil().namespace(),
                                O.connectedShape = m,
                                O.parent = C.dragCurrentParent,
                                O.containedStencil = l,
                                !e.ctrlKey) {
                            var v = m.bounds.center();
                            Math.abs(v.x - n.x) < 20 && (n.x = v.x),
                            Math.abs(v.y - n.y) < 20 && (n.y = v.y)
                        }
                        if (O.position = n,
                            "SequenceFlow" !== l.idWithoutNs() && "Association" !== l.idWithoutNs() && "MessageFlow" !== l.idWithoutNs() && "DataAssociation" !== l.idWithoutNs()) {
                            var y = {
                                sourceShape: m,
                                targetStencil: l
                            }
                                , I = C.editor.getRules().connectMorph(y);
                            if (!I)
                                return;
                            O.connectingType = I.id()
                        }
                        var b = new KISBPM.CreateCommand(O,C.dropTargetElement,n,C.editor);
                        C.editor.executeCommands([b])
                    }
                } else {
                    var O, S = !1;
                    "BoundaryErrorEvent" !== l.idWithoutNs() && "BoundaryTimerEvent" !== l.idWithoutNs() && "BoundarySignalEvent" !== l.idWithoutNs() && "BoundaryMessageEvent" !== l.idWithoutNs() && "BoundaryCancelEvent" !== l.idWithoutNs() && "BoundaryCompensationEvent" !== l.idWithoutNs() || (n = C.editor.eventCoordinates(e),
                        S = !0),
                        (O = {}).type = C.modelData.model.stencilset.namespace + i.id,
                        O.namespace = C.modelData.model.stencilset.namespace,
                        O.position = n,
                        O.parent = C.dragCurrentParent;
                    b = new (ORYX.Core.Command.extend({
                        ...
                        execute: function() {
                            this.shape ? this.parent && this.parent.add(this.shape) : (this.shape = this.facade.createShape(O),
                                this.parent = this.shape.parent),
                            this.canAttach && this.shape.dockers && this.shape.dockers.length && (this.docker = this.shape.dockers[0],
                                this.dockedShapeParent.add(this.docker.parent),
                                this.docker.setDockedShape(void 0),
                                this.docker.bounds.centerMoveTo(this.position),
                            this.dockedShape !== this.facade.getCanvas() && this.docker.setDockedShape(this.dockedShape),
                                this.facade.setSelection([this.docker.parent])),
                                this.facade.getCanvas().update(),
                                this.facade.updateSelection()
                        },
                        rollback: function() {
                            this.shape && (this.facade.setSelection(this.selection.without(this.shape)),
                                this.facade.deleteShape(this.shape)),
                            this.canAttach && this.docker && this.docker.setDockedShape(void 0),
                                this.facade.getCanvas().update(),
                                this.facade.updateSelection()
                        }
                    }))(O,C.dragCurrentParent,S,n,C.editor);
                    C.editor.executeCommands([b]);
                    var N = {
            ...
            C.dragCurrentParent = void 0,
                C.dragCurrentParentId = void 0,
                C.dragCurrentParentStencil = void 0,
                C.dragCanContain = void 0,
                C.quickMenu = void 0,
                C.dropTargetElement = void 0
        }
        ,
        C.overCallback = function(e, t) {
            C.dragModeOver = !0
        }
        ,
        C.outCallback = function(e, t) {
            C.dragModeOver = !1
        }
        ,
        C.startDragCallback = function(e, t) {
            C.dragModeOver = !1,
                C.quickMenu = !1,
            t.helper.hasClass("stencil-item-dragged") || t.helper.addClass("stencil-item-dragged")
        }
        ,
        C.startDragCallbackQuickMenu = function(e, t) {
            C.dragModeOver = !1,
                C.quickMenu = !0
        }
        ,
        C.dragCallback = function(e, t) {
            if (0 != C.dragModeOver) {
                var i = C.editor.eventCoordinatesXY(e.pageX, e.pageY)
                    , n = 1;
                if (!isNaN(screen.logicalXDPI) && !isNaN(screen.systemXDPI))
                    if (0 <= navigator.userAgent.indexOf("MSIE")) {
                ...
                1 !== n && (i.x = i.x / n,
                    i.y = i.y / n);
                var s = C.editor.getCanvas().getAbstractShapesAtPosition(i);
                if (s.length <= 0 && e.helper)
                    return C.dragCanContain = !1;
                if (s[0]instanceof ORYX.Core.Canvas && C.editor.getCanvas().setHightlightStateBasedOnX(i.x),
                    1 == s.length && s[0]instanceof ORYX.Core.Canvas) {
                    var r = s[0];
                    return C.dragCanContain = !0,
                        C.dragCurrentParent = r,
                        C.dragCurrentParentId = r.id,
                        C.editor.handleEvents({
                            type: ORYX.CONFIG.EVENT_HIGHLIGHT_HIDE,
                            highlightId: "shapeRepo.attached"
                        }),
                ...
                var a = C.getStencilItemById(e.target.id);
                ...
                if ("node" === a.type) {
                    var l = !1
                        , d = r.getStencil().id();
                    if (C.dragCurrentParentId && C.dragCurrentParentId === r.id)
                        return !1;
                    var p = C.getStencilItemById(r.getStencil().idWithoutNs());
                    if (-1 < p.roles.indexOf("Activity") ? -1 < a.roles.indexOf("IntermediateEventOnActivityBoundary") && (l = !0) : "Pool" === r.getStencil().idWithoutNs() && "Lane" === a.id && (l = !0),
                            l)
                        C.editor.handleEvents({
                        ...
                        for (var c = 0; c < C.containmentRules.length; c++) {
                            var u = C.containmentRules[c];
                            if (u.role === p.id) {
                                for (var h = 0; h < u.contains.length; h++)
                                    if (-1 < a.roles.indexOf(u.contains[h])) {
                                        l = !0;
                                        break
                                    }
                                if (l)
                    ...
                    C.dragCurrentParent = r,
                        C.dragCurrentParentId = r.id,
                        C.dragCurrentParentStencil = d,
                        C.dragCanContain = l
                } else {
                    var f = C.editor.getCanvas()
                        , g = !1
                        , m = C.getStencilItemById(r.getStencil().idWithoutNs());
                    if (m) {
                        var v = !1;
                        ...
                        (m.canConnectTo || v) && (g = !0)
                    }
                    C.dragCurrentParent = f,
                        C.dragCurrentParentId = f.id,
                        C.dragCurrentParentStencil = f.getStencil().id(),
                        C.dragCanContain = g,
                        C.editor.handleEvents({
                            type: ORYX.CONFIG.EVENT_HIGHLIGHT_SHOW,
                            highlightId: "shapeRepo.added",
        ...
        ,
        C.dragCallbackQuickMenu = function(e, t) {
            if (0 != C.dragModeOver) {
                var i = C.editor.eventCoordinatesXY(e.pageX, e.pageY)
                    , n = 1;
                if (!isNaN(screen.logicalXDPI) && !isNaN(screen.systemXDPI))
                ...
                if (s.length <= 0 && e.helper)
                    return C.dragCanContain = !1;
                s[0]instanceof ORYX.Core.Canvas && C.editor.getCanvas().setHightlightStateBasedOnX(i.x);
                for (var r = void 0, a = C.editor.getStencilSets().values(), l = 0; l < a.length; l++) {
                    for (var d = a[l], p = d.nodes(), c = 0; c < p.length; c++)
                        if (p[c].idWithoutNs() === e.target.id) {
                            r = p[c];
                            break
                        }
                    if (!r) {
                        ...
                        for (c = 0; c < u.length; c++)
                            if (u[c].idWithoutNs() === e.target.id) {
                                r = u[c];
                                break
                            }
                    }
                ...
                var h = s.last()
                    , f = !1;
                if ("node" === r.type()) {
                    var g = C.editor.getRules().canContain({
                        containingShape: h,
                        containedStencil: r
                    });
                    if (!(S = s.reverse().find(function(e) {
                            return e instanceof ORYX.Core.Canvas || e instanceof ORYX.Core.Node || e instanceof ORYX.Core.Edge
                        })))
                        return C.dragCanContain = !1;
                    C.dragCurrentParent = S,
                        C.dragCurrentParentId = S.id,
                        C.dragCurrentParentStencil = S.getStencil().id(),
                        C.dragCanContain = g,
                        C.dropTargetElement = S,
                        f = g
                } else {
                    var m = C.editor.getSelection();
                    if (m && 1 == m.length) {
                        var v = m.first()
                            , y = h
                            , I = !1
                            , b = C.getStencilItemById(y.getStencil().idWithoutNs());
                        if (b) {
                            var O = !1;
                            if ("Association" !== r.idWithoutNs() || "TextAnnotation" !== y.getStencil().idWithoutNs() && "BoundaryCompensationEvent" !== y.getStencil().idWithoutNs() ? "DataAssociation" === r.idWithoutNs() && "DataStore" === y.getStencil().idWithoutNs() && (O = !0) : O = !0,
                                b.canConnectTo || O)
                                for (; !I && y && !(y instanceof ORYX.Core.Canvas); )
                                    h = y,
                                        I = C.editor.getRules().canConnect({
                                            sourceShape: v,
                                            edgeStencil: r,
                                            targetShape: y
                                        }),
                        ...
                        var S = C.editor.getCanvas();
                        f = I,
                            C.dragCurrentParent = S,
                            C.dragCurrentParentId = S.id,
                            C.dragCurrentParentStencil = S.getStencil().id(),
                            C.dragCanContain = I,
                            C.dropTargetElement = h
                    }
                }
                C.editor.handleEvents({
                    type: ORYX.CONFIG.EVENT_HIGHLIGHT_SHOW,
...
KISBPM.CreateCommand = ORYX.Core.Command.extend({
    ...
    execute: function() {
        if (this.shape ? this.shape instanceof ORYX.Core.Node ? (this.parent.add(this.shape),
            this.edge && (this.facade.getCanvas().add(this.edge),
                ...
                this.facade.setSelection([this.shape])) : this.shape instanceof ORYX.Core.Edge && (this.facade.getCanvas().add(this.shape),
                this.shape.dockers.first().setDockedShape(this.connectedShape),
                this.shape.dockers.first().setReferencePoint(this.sourceRefPos)) : (this.shape = this.facade.createShape(this.option),
                this.edge = this.shape instanceof ORYX.Core.Edge ? void 0 : this.shape.getIncomingShapes().first()),
            ...
            if (this.shape instanceof ORYX.Core.Edge) {
                ...
                else if (this.shape.dockers.last().setDockedShape(this.currentReference),
                    "TextAnnotation" === this.currentReference.getStencil().idWithoutNs()) {
                    var e = {
                        x: 0
                    };
                ...
                this.edge && (this.sourceRefPos = this.edge.dockers.first().referencePoint,
            ...
            var t = this.containedStencil
                ...
                , n = this.shape.bounds
                , o = i.center();
            "north" === t.defaultAlign() ? o.y -= i.height() / 2 + ORYX.CONFIG.SHAPEMENU_CREATE_OFFSET + n.height() / 2 : "northeast" === t.defaultAlign() ? (o.x += i.width() / 2 + ORYX.CONFIG.SHAPEMENU_CREATE_OFFSET_CORNER + n.width() / 2,
                o.y -= i.height() / 2 + ORYX.CONFIG.SHAPEMENU_CREATE_OFFSET_CORNER + n.height() / 2) : "southeast" === t.defaultAlign() ? (o.x += i.width() / 2 + ORYX.CONFIG.SHAPEMENU_CREATE_OFFSET_CORNER + n.width() / 2,
                o.y += i.height() / 2 + ORYX.CONFIG.SHAPEMENU_CREATE_OFFSET_CORNER + n.height() / 2) : "south" === t.defaultAlign() ? o.y += i.height() / 2 + ORYX.CONFIG.SHAPEMENU_CREATE_OFFSET + n.height() / 2 : "southwest" === t.defaultAlign() ? (o.x -= i.width() / 2 + ORYX.CONFIG.SHAPEMENU_CREATE_OFFSET_CORNER + n.width() / 2,
                o.y += i.height() / 2 + ORYX.CONFIG.SHAPEMENU_CREATE_OFFSET_CORNER + n.height() / 2) : "west" === t.defaultAlign() ? o.x -= i.width() / 2 + ORYX.CONFIG.SHAPEMENU_CREATE_OFFSET + n.width() / 2 : "northwest" === t.defaultAlign() ? (o.x -= i.width() / 2 + ORYX.CONFIG.SHAPEMENU_CREATE_OFFSET_CORNER + n.width() / 2,
                o.y -= i.height() / 2 + ORYX.CONFIG.SHAPEMENU_CREATE_OFFSET_CORNER + n.height() / 2) : o.x += i.width() / 2 + ORYX.CONFIG.SHAPEMENU_CREATE_OFFSET + n.width() / 2,
    ...
    angular.module("activitiModeler").controller("ToolbarController", ["$scope", "$http", "$modal", "$q", "$rootScope", "$translate", "$location", function(s, o, r, a, l, d, e) {
        ...
        var p = function(e, t) {
            for (var i = Array.prototype.slice.call(arguments).splice(2), n = e.split("."), o = n.pop(), s = 0; s < n.length; s++)
                t = t[n[s]];
...
var KisBpmShapeSelectionCtrl = ["$rootScope", "$scope", "$timeout", "$translate", function(e, l, t, i) {
    ...
    for (var n = 0; n < l.morphShapes.length; n++)
        l.morphShapes[n].id != l.currentSelectedShape.getStencil().idWithoutNs() && l.availableMorphShapes.push(l.morphShapes[n]);
    l.gridOptions = {
        ...
        l.select = function() {
            if (0 < l.selectedMorphShapes.length) {
                var e = ORYX.Core.Command.extend({
                    ...
                    execute: function() {
                        ...
                        t.properties().each(function(t) {
                            ...
                            .bind(this)),
                            this.newShape ? (newShape = this.newShape,
                                this.facade.getCanvas().add(newShape)) : newShape = this.facade.createShape({
                                type: t.id(),
                        ...
                        if (this.facade.getRules().preserveBounds(e.getStencil())) {
                            var r = e.bounds.height()
                                , a = e.bounds.width();
                            newShape.minimumSize && (e.bounds.height() < newShape.minimumSize.height && (r = newShape.minimumSize.height),
                            e.bounds.width() < newShape.minimumSize.width && (a = newShape.minimumSize.width)),
                            newShape.maximumSize && (e.bounds.height() > newShape.maximumSize.height && (r = newShape.maximumSize.height),
                            e.bounds.width() > newShape.maximumSize.width && (a = newShape.maximumSize.width)),
                                s = {
                                    a: {
                                        x: e.bounds.a.x,
                                        y: e.bounds.a.y
                        ...
                        null !== s && newShape.bounds.set(s),
                        "edge" !== newShape.getStencil().type() && 0 != newShape.dockers.length && newShape.dockers[0].getDockedShape() || newShape.bounds.centerMoveTo(p),
                    ...
                    rollback: function() {
                        this.shape && this.newShape && this.newShape.parent && (this.newShape.parent.add(this.shape),
                    ...
                    setRelatedDockers: function(s, r) {
                        "node" === s.getStencil().type() ? ((s.incoming || []).concat(s.outgoing || []).each(function(o) {
                            o.dockers.each(function(e) {
                                if (e.getDockedShape() == s) {
                                    ...
                                    if (e.setDockedShape(r),
                                            e.setReferencePoint(i),
                                        o instanceof ORYX.Core.Edge)
                                        e.bounds.centerMoveTo(i);
                                    else {
                                        var n = s.absoluteXY();
                        ...
                        0 < s.dockers.length && s.dockers.first().getDockedShape() && (r.dockers.first().setDockedShape(s.dockers.first().getDockedShape()),
                            r.dockers.first().setReferencePoint(Object.clone(s.dockers.first().referencePoint)))) : (r.dockers.first().setDockedShape(s.dockers.first().getDockedShape()),
                            r.dockers.first().setReferencePoint(s.dockers.first().referencePoint),
                            r.dockers.last().setDockedShape(s.dockers.last().getDockedShape()),
                            r.dockers.last().setReferencePoint(s.dockers.last().referencePoint))
                    }
                })
                    , t = void 0
                ...
                for (var o = 0; o < i.length; o++)
                    for (var s = i[o].nodes(), r = 0; r < s.length; r++)
                        if (s[r].idWithoutNs() === n) {
                            t = s[r];
                            break
                        }
                if (!t)
...
KISBPM.TOOLBAR = {
    ACTIONS: {
        ...
        undo: function(e) {
            ...
            var o = !1;
            if (0 < e.$scope.redoStack.length && (o = !0),
                n || o)
                for (i = 0; i < e.$scope.items.length; i++) {
        ...
        redo: function(e) {
            ...
            var n = !1;
            if (0 == e.$scope.redoStack.length && (n = !0),
                i || n)
                for (var o = 0; o < e.$scope.items.length; o++) {
        ...
        addBendPoint: function(e) {
            var t = KISBPM.TOOLBAR.ACTIONS._getOryxDockerPlugin(e.$scope)
                , i = !t.enabledAdd();
            t.setEnableAdd(i),
                i ? (t.setEnableRemove(!1),
                    document.body.style.cursor = "pointer") : document.body.style.cursor = "default"
        },
...
var SaveModelCtrl = ["$rootScope", "$scope", "$http", "$route", "$location", function(e, l, d, t, i) {
    var p = l.editor.getModelMetaData()
        , n = "";
    p.description && (n = p.description);
    var o = {
        name: p.name,
        description: n
    };
        ...
        l.save = function(s) {
            if (l.saveDialog.name && 0 != l.saveDialog.name.length) {
                l.status = {
                    ...
                    p.name = l.bpmDefSetting.bpmDefinition.name,
                    p.description = l.bpmDefSetting.bpmDefinition.desc;
                var e = l.editor.getJSON();
                e = JSON.stringify(e);
                var t = l.editor.getSelection();
                l.editor.setSelection([]);
                var i = l.editor.getCanvas().getSVGRepresentation(!0);
                if (l.editor.setSelection(t),
                    !1 === l.editor.getCanvas().properties["oryx-showstripableelements"])
                    for (var n = (o = jQuery(i).find(".stripable-element")).length - 1; 0 <= n; n--)
                        o[n].remove();
                var o;
                for (n = (o = jQuery(i).find(".stripable-element-force")).length - 1; 0 <= n; n--)
                    o[n].remove();
                var r = {
                    json_xml: e,
                ...
                !0 === s && (r.publish = !0,
                    ...
                    d({
                        ...
                        url: KISBPM.URL.putModel(p.modelId)
                    }).success(function(e, t, i, n) {
                        if (e && !1 === e.isOk)
                            return l.error = {
                                msg: e.msg
                        ...
                        1 == l.bpmDefSetting.bpmDefinition.rev && window.location.reload(),
                            l.bpmDefSetting.bpmDefinition.rev = l.bpmDefSetting.bpmDefinition.rev + 1,
                            l.status.loading = !1,
                            l.$hide();
                        var o = {
                        ...
                        if (KISBPM.eventBus.dispatch(KISBPM.eventBus.EVENT_TYPE_MODEL_SAVED, o),
                                l.error = void 0,
                                l.status.loading = !1,
                            window.opener && window.opener.reloadGrid && window.opener.reloadGrid(),
                                a)
                            try {
                                jQuery.Dialog.close()
                            } catch (e) {
    ...
    t.shapeId = t.selectedShape.id,
        ...
        t.enterPressed = function(e) {
            e && 13 === e.which && (e.preventDefault(),
                t.inputBlurred())
        }
        ,
        t.$on("$destroy", function() {
            t.valueFlushed || (t.property.value && (t.property.value = t.property.value.replace(/(<([^>]+)>)/gi, "")),
                t.updatePropertyInModel(t.property, t.shapeId))
        })
}
]
                ...
                if (t && 0 < t.length) {
                    ...
                    if (i && 1 < i.length)
                        for (var n = 0; n < i.length; n++) {
                            if (i[n].resourceId != e.resourceId)
                                i[n].properties["oryx-defaultflow"] && i[n].setProperty("oryx-defaultflow", !1, !0)
                        }
                }
            }
        }
    ...
    e.all([o, r, a]).then(function(e) {
        ...
        s.addNewField = function() {
            0 < s.selectedListeners.length && (null == s.selectedListeners[0].fields && (s.selectedListeners[0].fields = []),
                s.selectedListeners[0].fields.push({
                    name: "fieldName",
                    implementation: "",
                    stringValue: "",
                    expression: "",
        ...
        ,
        s.save = function() {
            0 < s.executionListeners.length ? (s.property.value = {},
                s.property.value.executionListeners = s.executionListeners) : s.property.value = null,
    ...
    e.all([i, n, o]).then(function(e) {
        ...
        s.listenerDetailsChanged = function() {
            ...
            if (e.events) {
                for (var t = "", i = 0; i < e.events.length; i++)
                    0 < i && (t += ", "),
                        t += e.events[i].event;
            ...
            if (e.rethrowEvent) {
                ...
                "" !== s.selectedListeners[0].className ? s.selectedListeners[0].implementation = s.selectedListeners[0].className : "" !== s.selectedListeners[0].delegateExpression ? s.selectedListeners[0].implementation = s.selectedListeners[0].delegateExpression : s.selectedListeners[0].implementation = ""
        }
        ,
        s.addNewListener = function() {
        ...
        ,
        s.save = function() {
            0 < s.eventListeners.length ? (s.property.value = {},
                s.property.value.eventListeners = s.eventListeners) : s.property.value = null,
                s.updatePropertyInModel(s.property),
                s.close()
        }
        ,
    ...
    var e = function(e) {
        if (e.assignment.candidateUsers) {
            for (var t = !0, i = [], n = 0; n < e.assignment.candidateUsers.length; n++)
                "" != e.assignment.candidateUsers[n].value ? t = !1 : i[i.length] = n;
            for (n = 0; n < i.length; n++)
                e.assignment.candidateUsers.splice(i[n], 1);
            t && (e.assignment.candidateUsers = void 0)
        }
        if (e.assignment.candidateGroups) {
            var o = !0;
            for (i = [],
                     n = 0; n < e.assignment.candidateGroups.length; n++)
                "" != e.assignment.candidateGroups[n].value ? o = !1 : i[i.length] = n;
            for (n = 0; n < i.length; n++)
                e.assignment.candidateGroups.splice(i[n], 1);
    ...
    e.all([s, r]).then(function(e) {
        ...
        ,
        i.save = function() {
            0 < i.fields.length ? (i.property.value = {},
                i.property.value.fields = i.fields) : i.property.value = null,
    ...
    if (void 0 !== i.property.value && null !== i.property.value && void 0 !== i.property.value.formProperties && null !== i.property.value.formProperties) {
        ...
        for (var o = 0; o < i.formProperties.length; o++) {
            ...
            if (s.enumValues && 0 < s.enumValues.length)
                for (var r = 0; r < s.enumValues.length; r++) {
                    var a = s.enumValues[r];
                    a.id || a.name || !a.value || (a.id = a.value,
                        a.name = a.value)
                }
        }
    } else
    ...
    var l = t("PROPERTY.FORMPROPERTIES.ID")
        , d = t("PROPERTY.FORMPROPERTIES.NAME")
        , p = t("PROPERTY.FORMPROPERTIES.TYPE");
    e.all([l, d, p]).then(function(e) {
    ...
    i.addNewProperty = function() {
        ...
        ,
        i.save = function() {
            0 < i.formProperties.length ? (i.property.value = {},
                i.property.value.formProperties = i.formProperties) : i.property.value = null,
                i.updatePropertyInModel(i.property),
                i.close()
        }
        ,
    ...
    e.all([n, o, s]).then(function(e) {
        ...
        ,
        i.save = function() {
            0 < i.parameters.length ? (i.property.value = {},
                i.property.value.inParameters = i.parameters) : i.property.value = null,
                i.updatePropertyInModel(i.property),
                i.close()
        }
        ,
    ...
    e.all([n, o, s]).then(function(e) {
        ...
        i.save = function() {
            0 < i.parameters.length ? (i.property.value = {},
                i.property.value.outParameters = i.parameters) : i.property.value = null,
                i.updatePropertyInModel(i.property),
                i.close()
        }
        ,
    ...
    e.all([o, r, a]).then(function(e) {
        ...
        ,
        s.save = function() {
            0 < s.taskListeners.length ? (s.property.value = {},
                s.property.value.taskListeners = s.taskListeners) : s.property.value = null,
                s.updatePropertyInModel(s.property),
                s.close()
        }
        ,
    ...
    var t = []
        , n = i.selectedShape;
    if (n) {
        for (var o = n.getOutgoingShapes(), s = 0; s < o.length; s++)
            if ("Sequence flow" === o[s].getStencil().title()) {
                var r = o[s].getTarget();
                t.push({
                    id: o[s].resourceId,
    ...
    if (i.property.value && i.property.value.sequenceFlowOrder) {
        for (var l = i.property.value.sequenceFlowOrder, d = 0; d < l.length; d++)
    ...
    i.outgoingSequenceFlow = a,
        ...
        i.save = function() {
            if (0 < i.outgoingSequenceFlow.length) {
                ...
                for (var e = 0; e < i.outgoingSequenceFlow.length; e++)
                    i.property.value.sequenceFlowOrder.push(i.outgoingSequenceFlow[e].id)
            } else
...
angular.module("activitiModeler").controller("ActivitiSignalDefinitionsCtrl", ["$scope", "$modal", function(e, t) {
    ...
    angular.module("activitiModeler").controller("ActivitiSignalRefCtrl", ["$scope", function(e) {
        for (var t = void 0, i = e.selectedShape; null != i && void 0 === t; )
            i.properties && i.properties["oryx-signaldefinitions"] ? t = i.properties["oryx-signaldefinitions"] : i = i.parent;
        try {
    ...
    angular.module("activitiModeler").controller("ActivitiMessageRefCtrl", ["$scope", function(e) {
        for (var t = void 0, i = e.selectedShape; null != i && void 0 === t; )
            i.properties && i.properties["oryx-messagedefinitions"] ? t = i.properties["oryx-messagedefinitions"] : i = i.parent;
        try {
            "string" == typeof (t = JSON.parse(t)) && (t = JSON.parse(t))
        } catch (e) {}
...
var NodeConfController = ["$scope", "baseService", "ArrayToolService", "nodeDefService", function(a, e, t, i) {
    var n = a.$root.pjv;
    if ("blacklist" != n) {
        for (var o in a.nodeMap = a.bpmDefSetting.nodeMap,
            a.ArrayTool = t,
            a.isEditAllNode_forms = !1,
            a.isEditAllNode_btns = !1,
            a.isEditAllNode_nodeUser = !1,
            a.bpmDefSetting.getExistNode()) {
            var s = a.nodeMap[o];
            s || (s = a.nodeMap[o] = {
                nodeId: o,
                form: {
        ...
        a.testSelect = function(e) {
            return e === this.node.propertie.backNode
        }
            ,
            a.editAllNodes = function(e) {
                a["isEditAllNode_" + e] ? a["isEditAllNode_" + e] = !1 : (jQuery(".collapse.in").not("." + e).collapse("hide"),
                    a["isEditAllNode_" + e] = !0)
            }
            ,
            a.checkHandler = function(t) {
                t && e.get(__ctx + "/flow/node/validHandler?handler=" + t).then(function(e) {
                    "0" != e.result && $.topCall.error("接口" + t + "有误，原因：" + e.msg)
                })
            }
            ,
            a.editBtns = function(e) {
                if (!a.b) {
                    var n = e.nodeId
                        , t = {
                        passData: angular.copy(a.nodeMap[n].btnList),
                        width: 950,
                        height: 580,
                        btnAlign: "c",
                        title: "节点按钮设置",
            ...
            ,
            a.nodeUserFilter = function(e) {
                return !(this.nodeId != this.selectedItem.nodeId && !this.isEditAllNode_nodeUser) && -1 != "UserTask".indexOf(e.nodeType)
            }
            ,
            a.addNodeUserCondition = function(e, n) {
                var t = e.nodeType
                    , i = e.nodeId;
                a.getCurrentNodePlugins().userAssign || (a.getCurrentNodePlugins().userAssign = {
                    ruleList: []
                }),
                    a.currentUserCondtion = a.nodeMap[i].plugins.userAssign.ruleList;
                var o = {
                    calcs: [],
                    rule: ""
                };
                null != n && (o = angular.copy(a.currentUserCondtion[n]));
                a.bpmDefSetting.bpmDefinition.defId;
                var s = "/bpm/nodeDef/userConditionDialog.html?defId=" + bpmDefId + "&nodeId=" + i + "&nodeType=" + t
                    , r = {
                    passData: {
                        nodeList: a.getNodeList("UserTask,StartNoneEvent,"),
                        userCondition: o
                    },
                    width: 1e3,
                    height: 600,
                    ...
                    ok: function(e, t) {
                        var i = t.getData();
                        i && (a.$apply(function() {
                            null != n ? a.currentUserCondtion[n] = i : a.currentUserCondtion && a.currentUserCondtion.push(i)
                        }),
                            t.parent.layer.close(e))
                    }
                };
                jQuery.Dialog.open(r)
            }
            ,
            a.getNodeList = function(e) {
                var t = [];
                for (var i in a.bpmDefSetting.nodeMap) {
                    var n = a.bpmDefSetting.nodeMap[i];
    ...
    , FlowConfController = ["$scope", "nodeDefService", "ArrayToolService", "baseService", function(r, e, t, i) {
    r.ArrayTool = t;
    var n = r.$root.pjv;
    if ("blacklist" != n) {
        if (r.bpmDefSetting.flow || (r.bpmDefSetting.flow = {
                globalForm: {
                    type: "inner"
                },
                instForm: {
            ...
            r.bpmDefSetting.flow.properties || (r.bpmDefSetting.flow.properties = {
                allowExecutorEmpty: !0,
                logSubmitData: !0,
                status: "draft",
                subjectRule: "{发起人:startorName}在{发起时间:startDate}发起{流程标题:title}",
                supportMobile: 0
            }),
                r.properties = r.bpmDefSetting.flow.properties,
            r.bpmDefSetting.flow.dataModelList || (r.bpmDefSetting.flow.dataModelList = []),
                r.dataModelList = r.bpmDefSetting.flow.dataModelList,
            r.bpmDefSetting.flow.nodeInitList || (r.bpmDefSetting.flow.nodeInitList = []),
                r.nodeInitList = r.bpmDefSetting.flow.nodeInitList,
            r.bpmDefSetting.flow.variableList || (r.bpmDefSetting.flow.variableList = []),
                r.variableList = r.bpmDefSetting.flow.variableList,
                !r.bpmDefSetting.flow.plugins.nodeMessage) {
            r.bpmDefSetting.flow.plugins.nodeMessage = JSON.parse('[{"htmlTemplate": "<p>您有新的待办需要审批:${bpmInstance.subject}</p><p>&lt;#if isTask&gt;</p><p>上一节点：${submitTaskname}</p><p>处理人：${currentUser.fullname} ，处理结果 ：${submitActionDesc}</p><p>提交意见：${submitOpinion}</p><p>&lt;/#if&gt;</p>", "msgType": "email", "userRules": [], "html": "<p>您有新的待办需要审批:{待办标题}</p><p>上一环节：{用户任务1}，{小王} 处理结果&nbsp;：{同意/反对}</p><p>意见：{阿什顿发阿什顿发}</p>", "event": "postTaskCreate", "$$hashKey": "04V", "desc": "任务待办通知"}, {"htmlTemplate": "<p>您的申请的流程已经审批完结{subject}<br/></p>", "msgType": "email", "userRules": [{"rule": "", "description": "  [用户]发起人;\\n", "$$hashKey": "004", "calcs": [{"pluginType": "user", "extract": "no", "description": "发起人", "logicCal": "or", "source": "start", "vars": ""}]}], "html": "<p>您发起的流程已经完成审批<br/>${bpmInstance.subject}</p>", "event": "end", "$$hashKey": "04S", "nodeId": "", "desc": "流程结束通知发起人"}]')
        }
        r.nodeMessageList = r.bpmDefSetting.flow.plugins.nodeMessage,
        r.bpmDefSetting.flow.plugins.reminder || (r.bpmDefSetting.flow.plugins.reminder = []),
            r.reminderList = r.bpmDefSetting.flow.plugins.reminder,
            r.addDataModel = function() {
                CustUtil.openCustDialog("busObjectSelect", function(s, e) {
                    0 !== s.length ? (r.dataModelList || (r.dataModelList = []),
                        r.$apply(function() {
                            for (var e, t = 0; e = s[t++]; ) {
                                for (var i, n = !1, o = 0; i = r.dataModelList[o++]; )
                                    i.code === e.key && (n = !0);
                                n || r.dataModelList.push({
                                    code: e.key,
                                    name: e.name
                                })
                            }
                            r.loadSubjectVariable()
                        }),
                        jQuery.Dialog.close(e)) : $.Dialog.alert("请至少选择一个业务对象！")
                })
            }
            ,
            r.editNodeInit = function(n) {
                if (!(r.b && 1 < r.nodeInitList.length)) {
                    var e = "/bpm/definition/definitionNodeInitDialog.html?defId=" + bpmDefId
                        , t = {};
                    -1 < n && (t = r.bpmDefSetting.flow.nodeInitList[n]),
                        showDialog({
                            url: e,
                            width: 660,
                            height: 500,
                            title: "流程节点初始化配置",
                            passData: {
                                nodeList: r.getNodeList("UserTask,StartNoneEvent"),
                                nodeInit: angular.copy(t)
                            },
                            ok: function(e, t) {
                                var i = t.getData();
                                i && (r.$apply(function() {
                                    -1 < n ? r.bpmDefSetting.flow.nodeInitList[n] = i : r.bpmDefSetting.flow.nodeInitList.push(i)
                                }),
                                    layer.close(e))
                            }
                        })
            ...
            ,
            r.editNodeMessage = function(n) {
                if (!(r.b && 2 < r.nodeMessageList.length)) {
                    var e = "/bpm/definition/definitionNodeMessageDialog.html?defId=" + bpmDefId
                        , t = {};
                    -1 < n && (t = r.nodeMessageList[n]),
                        showDialog({
                            url: e,
                            width: 800,
                            height: 600,
                            title: "流程节点消息配置",
                            passData: {
                                nodeList: r.getNodeList("UserTask,,StartNoneEvent,EndNoneEvent"),
                                nodeMessage: angular.copy(t)
                            },
                            ok: function(e, t) {
                                var i = t.getData();
                                i && (r.$apply(function() {
                                    -1 < n ? r.nodeMessageList[n] = i : r.nodeMessageList.push(i)
                                }),
                                    layer.close(e))
                            }
                        })
            ...
            ,
            r.editReminder = function(n) {
                var e = "/bpm/definition/taskReminderConfigDialog.html?defId=" + bpmDefId
                    , t = {};
                -1 < n && (t = r.reminderList[n]),
                    showDialog({
                        url: e,
                        width: 800,
                        height: 600,
                        title: "任务催办配置",
                        passData: {
                            nodeList: r.getNodeList("UserTask"),
                            reminder: angular.copy(t)
                        },
                        ok: function(e, t) {
                            var i = t.getData();
                            i && (r.$apply(function() {
                                -1 < n ? r.reminderList[n] = i : r.reminderList.push(i)
                            }),
                                layer.close(e))
                        }
                    })
            ...
            ,
            r.b = "agilebpm" != n,
            r.editVariable = function(n) {
                var e = "/bpm/definition/definitionVariableDialog.html?defId=" + bpmDefId
                    , t = {
                    dataType: "string"
                };
                -1 < n && ((t = angular.copy(r.bpmDefSetting.flow.variableList[n])).isUpdate = !0),
                    showDialog({
                        url: e,
                        width: 660,
                        height: 400,
                        ...
                        passData: {
                            variable: t,
                            variableList: r.bpmDefSetting.flow.variableList
                        },
                        ok: function(e, t) {
                            var i = t.getData();
                            i && (r.$apply(function() {
                                -1 < n ? r.bpmDefSetting.flow.variableList[n] = i : r.bpmDefSetting.flow.variableList.push(i)
                            }),
                                layer.close(e))
                        }
                    })
            ...
            ,
            r.getNodeList = function(e) {
                var t = [];
                for (var i in r.bpmDefSetting.nodeMap) {
                    var n = r.bpmDefSetting.nodeMap[i];
                    if (!e || -1 != e.indexOf(n.nodeType)) {
                        var o = {
                            nodeId: n.nodeId,
                            nodeName: n.nodeName || i,
            ...
            ,
            r.loadSubjectVariable = function() {
                var e = r.getBoCodes();
                e && i.get(__ctx + "/bpm/processDef/getSubjectVariable?defId=" + bpmDefId + "&boCodes=" + e).then(function(e) {
                    r.subjectVariables = e
                })
            }
            ,
            r.setSubject = function() {
                r.properties.subjectRule = r.properties.subjectRule + "{" + this.subjectVar.name + ":" + this.subjectVar.key + "}",
                    this.subjectVar = ""
            }
            ,
            r.getBoCodes = function() {
                for (var e, t = "", i = 0; e = r.dataModelList[i++]; )
                    t && (t += ","),
                        t += e.code;
                return t
            }
            ,
            r.loadSubjectVariable(),
            r.pluginHasPermission = function(e) {
                if (!e)
                    return !0;
                if (!r.permissionPlugins)
                    return !1;
                for (var t, i = 0; t = r.permissionPlugins[i++]; )
                    if (t.type === e)
                        return !0;
                return !1
            }
    ...
    n.pluginList = [{
        ...
        n.pluginHasPermission = function(e) {
            if (!e)
                return !0;
            if (!n.permissionPlugins)
                return !1;
            for (var t, i = 0; t = n.permissionPlugins[i++]; )
                if (t.type === e)
                    return !0;
            return !1
        }
    ...
    , InclusiveConditionsController = ["$scope", "$translate", function(d, e) {
    d.$watch("selectedItem.nodeId", function(e, t) {
        var i = d.selectedItem.nodeType;
        if (i && ("InclusiveGateway" == i || "ExclusiveGateway" == i) && (e != t || !d.outgoingSequenceFlow)) {
            d.outgoingSequenceFlowList = [];
            var n = d.selectedShape;
            if (n)
                for (var o = n.getOutgoingShapes(), s = 0; s < o.length; s++) {
                    var r = o[s];
                    if ("SequenceFlow" === r.getStencil().idWithoutNs()) {
                        ...
                        r.properties.each(function(e, t) {
                            "oryx-conditionsequenceflow" == e.key && (l.condition = e,
                                l.flowconditionExpression = e.value)
                        }),
                            l.shapeId = r.getId(),
                            l.shape = r,
                            d.outgoingSequenceFlowList.push(l)
                    }
                }
            else
                console.log("Programmatic error: no selected shape found")
        ...
        d.changeCondition = function(n) {
            var e = d.selectedItem.nodeId
                , t = "/bpm/definition/definitionScriptDialog.html?defId=" + bpmDefId + "&nodeId=" + e
                , i = d.outgoingSequenceFlowList[n]
                , o = {
            ...
            showDialog({
                ...
                ok: function(e, t) {
                    var i = t.getData();
                    d.$apply(function() {
                        var e = d.outgoingSequenceFlowList[n];
                        e.flowconditionExpression = i,
                            e.condition.value = i,
                            d.updatePropertyInModel(e.condition, e.shapeId, e.shape)
                    }),
                        layer.close(e)
                }
            })
...
var dialogHelper__ = {
        ...
        jQuery.extend({
            Dialog: {
                ...
                open: function(i) {
                    ...
                    i.btn || (i.btn = ["确定", "取消"])),
                        jQuery.extend(d, i);
                    var p = r.layer.open(d);
                    if (r.layerIndexRecord || (r.layerIndexRecord = []),
                            r.layerIndexRecord.push(p),
                            n) {
            ...
            Toast: {
                warning: function(e, t, i) {
                    i || (i = top.toastr ? top : window),
                        i.toastr.warning(e, t)
                },
                success: function(e, t, i) {
                    i || (i = top.toastr ? top : window),
                        i.toastr.success(e, t)
                },
    ...
    getUrl: function(e) {
        var t = e.attr("url");
        return t ? ("http://" != t.substr(0, 7) && -1 == t.indexOf("html") && (t += ".html"),
        -1 != t.indexOf("?") && (t = t.format(jQuery.getParams())),
            t) : ""
    },
    initCustDialogs: function() {
        window.CustUtil = {
            openCustDialog: function(n, o, i, s, r, a) {
                jQuery.isFunction(o) && (r = s,
                    s = i,
                    i = o,
                    o = {}),
                i || (i = function(e, t) {
    ...
    getProjectUrl: function(e) {
        if (e && -1 == e.indexOf("http://") && "/" === e.substring(0, 1)) {
            ...
            return "" === i || -1 != "/bus,/bpm,/sys,/org,/form,/flow-editor,/bpmplugin".indexOf(i) ? e : e.startWith(i) ? e : i + e
        }
        return e
    }
};
("function" == typeof define && define.amd ? define : function(e, t) {
    ...
    return function() {
        function u(e, t) {
            return e || (e = f()),
            (m = I("#" + e.containerId)).length || t && (i = e,
                (m = I("<div/>").attr("id", i.containerId).addClass(i.positionClass).attr("aria-live", "polite").attr("role", "alert")).appendTo(I(i.target)),
                m = m),
                m;
            var i
        }
        ...
        function o(e) {
            function t(e) {
                return !I(":focus", s).length || e ? (clearTimeout(p.intervalId),
                    s[i.hideMethod]({
            ...
            if (void 0 !== e.optionsOverride && (i = I.extend(i, e.optionsOverride),
                    n = e.optionsOverride.iconClass || n),
                    i.preventDuplicates) {
                if (e.message === v)
                    return;
                v = e.message
            ...
            e.title && (r.append(e.title).addClass(i.titleClass),
                s.append(r)),
            e.message && (a.append(e.message).addClass(i.messageClass),
                s.append(a)),
            i.closeButton && (d.addClass("toast-close-button").attr("role", "button"),
                s.prepend(d)),
            i.progressBar && (l.addClass("toast-progress"),
                s.prepend(l)),
                s.hide(),
                i.newestOnTop ? m.prepend(s) : m.append(s),
                s[i.showMethod]({
                    duration: i.showDuration,
                    easing: i.showEasing,
                    complete: i.onShown
                }),
            0 < i.timeOut && (o = setTimeout(t, i.timeOut),
                p.maxHideTime = parseFloat(i.timeOut),
                p.hideEta = (new Date).getTime() + p.maxHideTime,
            i.progressBar && (p.intervalId = setInterval(function() {
                ...
                s.hover(function() {
                    ...
                    (0 < i.timeOut || 0 < i.extendedTimeOut) && (o = setTimeout(t, i.extendedTimeOut),
                        p.maxHideTime = parseFloat(i.extendedTimeOut),
                        p.hideEta = (new Date).getTime() + p.maxHideTime)
                }),
            !i.onclick && i.tapToDismiss && s.click(t),
            i.closeButton && d && d.click(function(e) {
        ...
        var m, t, v, y = 0, s = {
            ...
            clear: function(e) {
                ...
                m || u(t),
                n(e, t) || function(e) {
                    for (var t = m.children(), i = t.length - 1; 0 <= i; i--)
                        n(I(t[i]), e)
                }(t)
            },
            remove: function(e) {
                var t = f();
                return m || u(t),
                    e && 0 === I(":focus", e).length ? void g(e) : void (m.children().length && m.remove())
            },
            error: function(e, t, i) {
                return o({
                    type: s.error,
    ...
    function(u) {
        u.parser = {
            ...
            parseValue: function(e, t, i, n) {
                ...
                return "%" == o.substr(o.length - 1, 1) ? (o = parseInt(o.substr(0, o.length - 1)),
                    o = 0 <= e.toLowerCase().indexOf("width") ? Math.floor((i.width() - n) * o / 100) : Math.floor((i.height() - n) * o / 100)) : o = parseInt(o) || void 0,
                    o
            },
            parseOptions: function(i, e) {
                ...
                if (o && ("{" != o.substring(0, 1) && (o = "{" + o + "}"),
                        n = new Function("return " + o)()),
                        u.map(["width", "height", "left", "top", "minWidth", "maxWidth", "minHeight", "maxHeight"], function(e) {
                            var t = u.trim(i.style[e] || "");
                            t && (-1 == t.indexOf("%") && (t = parseInt(t) || void 0),
                                n[e] = t)
                        }),
                        e) {
                    for (var s = {}, r = 0; r < e.length; r++) {
                        ...
                        if ("string" == typeof a)
                            ...
                            for (var l in a) {
                                var d = a[l];
                                "boolean" == d ? s[l] = t.attr(l) ? "true" == t.attr(l) : void 0 : "number" == d && (s[l] = "0" == t.attr(l) ? 0 : parseFloat(t.attr(l)) || void 0)
                            }
                    }
                    u.extend(n, s)
                }
            ...
            u.fn._size = function(i, n) {
                ...
                function o(e, t, i) {
                    ...
                    var n = u(e)[0]
                        , o = t[0]
                        , s = o.fcount || 0;
                    return i ? (n.fitted || (n.fitted = !0,
                        o.fcount = s + 1,
                        u(o).addClass("panel-noscroll"),
                    "BODY" == o.tagName && u("html").addClass("panel-fit")),
                        {
                            width: u(o).width() || 1,
                            height: u(o).height() || 1
                        }) : (n.fitted && (n.fitted = !1,
                        o.fcount = s - 1,
                    0 == o.fcount && (u(o).removeClass("panel-noscroll"),
                    "BODY" == o.tagName && u("html").removeClass("panel-fit"))),
                        !1)
                }
                function s(e, t, i, n) {
                    var o = u(e)
                        ...
                        , d = u.parser.parseValue(s, n[s], i)
                        , p = 0 <= String(n[s] || "").indexOf("%");
                    if (isNaN(d))
                        o._size(s, ""),
                            o._size("min" + r, a),
                            o._size("max" + r, l);
                    else {
                        var c = Math.min(Math.max(d, a || 0), l || 99999);
                        p || (n[s] = c),
                            o._size("min" + r, ""),
                            o._size("max" + r, ""),
                            o._size(s, c)
                ...
                function e(e, t, i) {
                    ...
                    "" === i ? n.css(t, "") : (u._boxModel && (i -= o()) < 0 && (i = 0),
                        n.css(t, i + "px"))
                }
            }
    }(jQuery),
    function(o) {
        ...
        document.addEventListener && (document.addEventListener("touchstart", function(e) {
            1 == e.touches.length && (i ? (clearTimeout(dblClickTimer),
                i = !1,
                n(e, "dblclick")) : (i = !0,
            ...
            document.addEventListener("touchmove", function(e) {
                1 == e.touches.length && (t && clearTimeout(t),
                    n(e, "mousemove"),
                (o.fn.draggable.isDragging || o.fn.resizable.isResizing) && e.preventDefault())
            }, !0),
    ...
    function(c) {
        c.fn.resizable = function(t, e) {
            if ("string" == typeof t)
                return c.fn.resizable.methods[t](this, e);
            function i(e) {
                var t = e.data
            ...
            return this.each(function() {
                ...
                function o(e) {
                    ...
                    for (var a = p.handles.split(","), l = 0; l < a.length; l++) {
                        var d = a[l].replace(/(^\s*)|(\s*$)/g, "");
                        if ("all" == d || d == i)
                            return i
                    }
                    return ""
                }
                e ? (c(this).unbind(".resizable"),
                    p = c.extend(e.options, t || {})) : (p = c.extend({}, c.fn.resizable.defaults, c.fn.resizable.parseOptions(this), t || {}),
                    c.data(this, "resizable", {
                        options: p
                    })),
                1 != p.disabled && c(this).bind("mousemove.resizable", {
                    target: this
                }, function(e) {
    ...
    function($) {
        ...
        function _3(e, t) {
            ...
            if (t && $.extend(n, {
                    ...
                    o._size(n),
                    s.add(r)._outerWidth(o.width()),
                    isNaN(parseInt(n.height))) {
                r.css("height", "");
                var l = $.parser.parseValue("minHeight", n.minHeight, o.parent())
                    , d = $.parser.parseValue("maxHeight", n.maxHeight, o.parent())
                    , p = s._outerHeight() + a._outerHeight() + o._outerHeight() - o.height();
                r._size("minHeight", l ? l - p : ""),
                    r._size("maxHeight", d ? d - p : "")
            } else
                r._outerHeight(o.height() - s._outerHeight() - a._outerHeight());
            o.css({
                height: "",
                minHeight: "",
                maxHeight: "",
        ...
        function _f(e, t) {
            ...
            t && (null != t.left && (i.left = t.left),
            null != t.top && (i.top = t.top)),
                n.css({
                    left: i.left,
                    top: i.top
                }),
        ...
        function _18(_19) {
            ...
            function _1d() {
                if (_1b.tools && "string" == typeof _1b.tools && _1c.find(">div.panel-header>div.panel-tool .panel-tool-a").appendTo(_1b.tools),
                        _1(_1c.children("div.panel-header")),
                    _1b.title && !_1b.noheader) {
                    var _22 = $('<div class="panel-header"></div>').prependTo(_1c)
                        , _23 = $('<div class="panel-title"></div>').html(_1b.title).appendTo(_22);
                    _1b.iconCls && (_23.addClass("panel-with-icon"),
        ...
        function _25(i, e) {
            var n = $.data(i, "panel")
                , o = n.options;
            if (t && (o.queryParams = e),
                o.href && (!n.isLoaded || !o.cache)) {
                var t = $.extend({}, o.queryParams);
                if (0 == o.onBeforeLoad.call(i, t))
                    return;
                n.isLoaded = !1,
                    $(i).panel("clear"),
        ...
        function _31(e, t) {
            ...
            if (1 == t || 0 != i.onBeforeOpen.call(e))
                if (n.stop(!0, !0),
                        $.isFunction(i.openAnimation))
                    i.openAnimation.call(e, o);
                else
            ...
            function o() {
                ...
                n.children("div.panel-header").find("a.panel-tool-restore").length && (i.maximized = !0),
                    i.onOpen.call(e),
                1 == i.maximized && (i.maximized = !1,
                    _37(e)),
                1 == i.collapsed && (i.collapsed = !1,
                    _38(e)),
                i.collapsed || (_25(e),
                    _2f(e))
            }
        ...
        function _39(e, t) {
            var i = $.data(e, "panel").options
                , n = $.data(e, "panel").panel;
            if (1 == t || 0 != i.onBeforeClose.call(e))
                if (n.stop(!0, !0),
                        n._size("unfit"),
                        $.isFunction(i.closeAnimation))
                    i.closeAnimation.call(e, o);
                else
                    switch (i.closeAnimation) {
                        case "slide":
        ...
        function _3e(e, t) {
            var i = $.data(e, "panel")
                , n = i.options
                , o = i.panel;
            1 != t && 0 == n.onBeforeDestroy.call(e) || ($(e).panel("clear").panel("clear", "footer"),
                _1(o),
                n.onDestroy.call(e))
        }
        function _38(e, t) {
            ...
            1 != i.collapsed && (o.stop(!0, !0),
            0 != i.onBeforeCollapse.call(e) && (s.addClass("panel-tool-expand"),
                1 == t ? o.slideUp("normal", function() {
                    i.collapsed = !0,
                        i.onCollapse.call(e)
                }) : (o.hide(),
                    i.collapsed = !0,
        ...
        function _4a(e, t) {
            var i = $.data(e, "panel").options
                ...
                , o = n.children("div.panel-body")
                , s = n.children("div.panel-header").find("a.panel-tool-collapse");
            0 != i.collapsed && (o.stop(!0, !0),
            0 != i.onBeforeExpand.call(e) && (s.removeClass("panel-tool-expand"),
                1 == t ? o.slideDown("normal", function() {
                    i.collapsed = !1,
                        i.onExpand.call(e),
                        _25(e),
                        _2f(e)
        ...
        function _37(e) {
            ...
            1 != t.maximized && (i.addClass("panel-tool-restore"),
            $.data(e, "panel").original || ($.data(e, "panel").original = {
                width: t.width,
                height: t.height,
                left: t.left,
                top: t.top,
        ...
        function _59(e) {
            ...
            0 != t.maximized && (i.show(),
                n.removeClass("panel-tool-restore"),
            ...
            _61 && clearTimeout(_61),
                _61 = setTimeout(function() {
                    ...
                    e.length ? (e.layout("resize"),
                        $("body").children(".easyui-fluid:visible").trigger("_resize")) : $("body").panel("doLayout"),
                        _61 = null
                }, 100)
        }),
            $.fn.panel = function(i, e) {
                return "string" == typeof i ? $.fn.panel.methods[i](this, e) : (i = i || {},
                    this.each(function() {
                        var e, t = $.data(this, "panel");
                        t ? (e = $.extend(t.options, i),
                            t.isLoaded = !1) : (e = $.extend({}, $.fn.panel.defaults, $.fn.panel.parseOptions(this), i),
                            $(this).attr("title", ""),
                            t = $.data(this, "panel", {
                                options: e,
                                panel: _14(this),
                            ...
                            _18(this),
                        1 == e.doSize && (t.panel.css("display", "block"),
                            _3(this)),
    ...
    function(u) {
            ...
            function l(e, t) {
                if (e.length && g(e)) {
                    ...
                    e.panel("move", {
                        ...
                        r.width -= n,
                    "w" == t && (r.left += n,
                    !i.split && i.border && r.left--),
                    !i.split && i.border && r.width++
                }
            }
            a(g(o.expandNorth) ? o.expandNorth : o.north, "n"),
                a(g(o.expandSouth) ? o.expandSouth : o.south, "s"),
                l(g(o.expandEast) ? o.expandEast : o.east, "e"),
                l(g(o.expandWest) ? o.expandWest : o.west, "w"),
                    ...
                    "west" == s && (d = "e"),
                        l.resizable(u.extend({}, {
                            ...
                            onStartResize: function(e) {
                                if (h = !0,
                                    "north" == s || "south" == s)
                                    var t = u(">div.layout-split-proxy-v", o);
                                else
                                    t = u(">div.layout-split-proxy-h", o);
                                var i = {
                                    display: "block"
                                };
                                "north" == s ? (i.top = parseInt(l.css("top")) + l.outerHeight() - t.height(),
                                    i.left = parseInt(l.css("left")),
                                    i.width = l.outerWidth(),
                                    i.height = t.height()) : "south" == s ? (i.top = parseInt(l.css("top")),
                                    i.left = parseInt(l.css("left")),
                                    i.width = l.outerWidth(),
                                    i.height = t.height()) : "east" == s ? (i.top = parseInt(l.css("top")) || 0,
                                    i.left = parseInt(l.css("left")) || 0,
                                    i.width = t.width(),
                                    i.height = l.outerHeight()) : "west" == s && (i.top = parseInt(l.css("top")) || 0,
                                    i.left = l.outerWidth() - t.width(),
                                    i.width = t.width(),
        ...
        function f(a, l, e) {
            null == e && (e = "normal");
            var d = u.data(a, "layout").panels
                , p = d[l]
                , c = p.panel("options");
            if (0 != c.onBeforeCollapse.call(p)) {
                ...
                d[t] || (d[t] = function(e) {
                    ...
                    d[t].panel("panel").bind("click", function() {
                        p.panel("expand", !1).panel("open");
                        var e = n();
                        return p.panel("resize", e.collapse),
                            p.panel("panel").animate(e.expand, function() {
                                u(this).unbind(".layout").bind("mouseleave.layout", {
                                    region: l
                                }, function(e) {
                                    1 != h && (u("body>div.combo-p>div.combo-panel:visible").length || f(a, e.data.region))
                                })
                            }),
                            !1
                    }));
                var i = n();
                g(d[t]) || d.center.panel("resize", i.resizeC),
                    p.panel("panel").animate(i.collapse, e, function() {
                        p.panel("collapse", !1).panel("close"),
                            d[t].panel("open").panel("resize", i.expandP),
                            u(this).unbind(".layout")
                    })
            }
            function n() {
                var e = u(a)
                    , t = d.center.panel("options")
                    , i = c.collapsedSize;
                if ("east" == l) {
                    var n = p.panel("panel")._outerWidth()
                        , o = t.width + n - i;
                ...
                if ("north" == l) {
                    var s = p.panel("panel")._outerHeight()
                        , r = t.height;
                    return g(d.expandNorth) || (r += s - i + (c.split || !c.border ? 1 : 0)),
                ...
                if ("south" == l) {
                    s = p.panel("panel")._outerHeight(),
                        r = t.height;
                    return g(d.expandSouth) || (r += s - i + (c.split || !c.border ? 1 : 0)),
                        d.east.add(d.west).add(d.expandEast).add(d.expandWest).panel("resize", {
                            height: r
                        }),
                        {
        ...
        u.fn.layout = function(o, e) {
            return "string" == typeof o ? u.fn.layout.methods[o](this, e) : (o = o || {},
                this.each(function() {
                    var e, t, i = u.data(this, "layout");
                    if (i)
                        u.extend(i.options, o);
                    else {
                        ...
                        u.data(this, "layout", {
                            ...
                            function(i) {
                                ...
                                e.addClass("layout"),
                                    ...
                                    e.bind("_resize", function(e, t) {
                                        return (u(this).hasClass("easyui-fluid") || t) && p(i),
                                            !1
                                    })
                            }(this)
                    }
                    p(this),
                        e = this,
                    (t = u.data(e, "layout").panels).east.length && t.east.panel("options").collapsed && f(e, "east", 0),
                    t.west.length && t.west.panel("options").collapsed && f(e, "west", 0),
                    t.north.length && t.north.panel("options").collapsed && f(e, "north", 0),
                    t.south.length && t.south.panel("options").collapsed && f(e, "south", 0)
                }))
        }
            ,
            u.fn.layout.methods = {
                ...
                add: function(e, t) {
                    return e.each(function() {
                        s(this, t),
                            p(this),
                        u(this).layout("panel", t.region).panel("options").collapsed && f(this, t.region, 0)
                    })
                },
                remove: function(e, t) {
                    return e.each(function() {
    ...
    function(Se, Ne, Re) {
        var e;
        e = function(E) {
            var h, e, v, t, m, w = !0, x = !1, y = null, P = "x", _ = "y", D = "width", L = "height", k = "top", A = "left", M = "bottom", X = "right", Y = "center", F = "flipinvert", $ = "shift", C = {}, B = "qtip", f = "data-hasqtip", p = "data-qtip-id", i = ["ui-widget", "ui-tooltip"], I = "." + B, n = "click dblclick mousedown mouseup mousemove mouseleave mouseenter".split(" "), u = B + "-fixed", c = B + "-default", r = B + "-focus", s = B + "-hover", g = B + "-disabled", o = "_replacedByqTip", b = "oldtitle", T = {
                ie: function() {
            ...
            function S(e) {
                ...
                "ajax"in t && (s = t.ajax,
                        ...
                        t.text = function(e, n) {
                            ...
                            return r ? t : (n.set("content.text", t),
                                i)
                        }
                ),
                "title"in t && (a(t.title) || (t.button = t.title.button,
                    t.title = t.title.text),
                l(t.title || x) && (t.title = x))),
                "position"in e && a(e.position) && (e.position = {
                    my: e.position,
                    at: e.position
                }),
            ...
            function d(e, t) {
                for (var i, n = 0, o = e, s = t.split("."); o = o[s[n++]]; )
                    n < s.length && (i = o);
                return [i || e, s.pop()]
            }
            function N(e, t) {
                ...
                for (i in this.checks)
                    for (n in this.checks[i])
                        (o = new RegExp(n,"i").exec(e)) && (t.push(o),
                        ("builtin" === i || this.plugins[i]) && this.checks[i][n].apply(this.plugins[i] || this, t))
            }
            (e = O.prototype)._when = function(e) {
                ...
                e.render = function(e) {
                    ...
                    return E.attr(this.target[0], "aria-describedby", this._id),
                        this.tooltip = o.tooltip = E("<div/>", {
                            ...
                            "aria-hidden": w
                        }).toggleClass(g, this.disabled).attr(p, this.id).data(B, this).appendTo(l.container).append(o.content = E("<div />", {
                            class: B + "-content",
                            id: this._id + "-content",
                            "aria-atomic": w
                        })),
                        ...
                        this.positioning = w,
                    r && (this._createTitle(),
                    E.isFunction(r) || d.push(this._updateTitle(r, x))),
                    a && this._createButton(),
                    E.isFunction(s) || d.push(this._updateContent(s, x)),
                        this.rendered = w,
                        this._setWidget(),
                        E.each(C, function(e) {
                            var t;
                        ...
                        this._when(d).then(function() {
                            i._trigger("render"),
                                i.positioning = x,
                            i.hiddenDuringWait || !t.show.ready && !e || i.toggle(w, n.event, x),
                ...
                e.destroy = function(e) {
                    ...
                    function t() {
                        if (!this.destroyed) {
                            ...
                            this.rendered && this.tooltip.stop(1, 0).find("*").remove().end().remove(),
                                ...
                                this._unassignEvents(),
                                e.removeData(B).removeAttr(p).removeAttr(f).removeAttr("aria-describedby"),
                    ...
                    return e === w && "hide" !== this.triggering || !this.rendered ? t.call(this) : (this.tooltip.one("tooltiphidden", E.proxy(t, this)),
                ...
                t = e.checks = {
                    builtin: {
                        "^id$": function(e, t, i, n) {
                            var o = i === w ? h.nextid : i
                                , s = B + "-" + o;
                            o !== x && 0 < o.length && !E("#" + s).length ? (this._id = s,
                            this.rendered && (this.tooltip[0].id = this._id,
                                this.elements.content[0].id = this._id + "-content",
                                this.elements.title[0].id = this._id + "-title")) : e[t] = n
                        },
                ...
                e.get = function(e) {
                    if (this.destroyed)
                        return this;
                    var t = d(this.options, e.toLowerCase())
                        , i = t[0][t[1]];
            ...
            e.set = function(o, e) {
                ...
                this.checks;
                return "string" == typeof o ? (t = o,
                    (o = {})[t] = e) : o = E.extend({}, o),
                    E.each(o, function(e, t) {
                        if (s && z.test(e))
                            delete o[e];
                        else {
                            var i, n = d(a, e.toLowerCase());
                            i = n[0][n[1]],
                ...
                e._update = function(e, t, i) {
                    var n = this
                        , o = this.cache;
                    return this.rendered && e ? (E.isFunction(e) && (e = e.call(this.elements.target, o.event, this) || ""),
                        E.isFunction(e.then) ? (o.waiting = w,
                            e.then(function(e) {
                                return o.waiting = x,
                                    n._update(e, t)
                            }, y, function(e) {
                ...
                e._createTitle = function() {
                    ...
                    e.titlebar && this._removeTitle(),
                        e.titlebar = E("<div />", {
                            class: B + "-titlebar " + (this.options.style.widget ? V("header") : "")
                ...
                e.reposition = function(e, t) {
                    if (!this.rendered || this.positioning || this.destroyed)
                        return this;
                    this.positioning = w;
                    var i, n, o = this.cache, s = this.tooltip, r = this.options.position, a = r.target, l = r.my, d = r.at, p = r.viewport, c = r.container, u = r.adjust, h = u.method.split(" "), f = s.outerWidth(x), g = s.outerHeight(x), m = 0, v = 0, y = s.css("position"), I = {
                        left: 0,
                        top: 0
                    }, b = 0 < s[0].offsetWidth, O = e && "scroll" === e.type, S = E(Se), N = c[0].ownerDocument, R = this.mouse;
                    if (E.isArray(a) && 2 === a.length)
                        ...
                        "static" !== y && (I = c.offset()),
                        N.body.offsetWidth !== (Se.innerWidth || N.documentElement.clientWidth) && (n = E(Ne.body).offset()),
                            I = {
                                left: e.pageX - I.left + (n && n.left || 0),
                                top: e.pageY - I.top + (n && n.top || 0)
                            },
                        u.mouse && O && R && (I.left -= (R.scrollX || 0) - S.scrollLeft(),
                            I.top -= (R.scrollY || 0) - S.scrollTop());
                    else {
                        if ("event" === a ? e && e.target && "scroll" !== e.type && "resize" !== e.type ? o.target = E(e.target) : e.target || (o.target = this.elements.target) : "event" !== a && (o.target = E(a.jquery ? a : this.elements.target)),
                                a = o.target,
                            0 === (a = E(a).eq(0)).length)
                            return this;
                        a[0] === Ne || a[0] === Se ? (m = T.iOS ? Se.innerWidth : a.width(),
                            v = T.iOS ? Se.innerHeight : a.height(),
                        a[0] === Se && (I = {
                            top: (p || a).scrollTop(),
                            left: (p || a).scrollLeft()
                        })) : C.imagemap && a.is("area") ? i = C.imagemap(this, a, d, C.viewport ? h : x) : C.svg && a && a[0].ownerSVGElement ? i = C.svg(this, a, d, C.viewport ? h : x) : (m = a.outerWidth(x),
                            v = a.outerHeight(x),
                            I = a.offset()),
                        i && (m = i.width,
                            v = i.height,
                        ...
                        (3.1 < T.iOS && T.iOS < 4.1 || 4.3 <= T.iOS && T.iOS < 4.33 || !T.iOS && "fixed" === y) && (I.left -= S.scrollLeft(),
                            I.top -= S.scrollTop()),
                        (!i || i && i.adjustable !== x) && (I.left += d.x === X ? m : d.x === Y ? m / 2 : 0,
                            I.top += d.y === M ? v : d.y === Y ? v / 2 : 0)
                    }
                    return I.left += u.x + (l.x === X ? -f : l.x === Y ? -f / 2 : 0),
                        I.top += u.y + (l.y === M ? -g : l.y === Y ? -g / 2 : 0),
                        C.viewport ? (I.adjusted = C.viewport(this, I, r, m, v, f, g),
                        n && I.adjusted.left && (I.left += n.left),
                        n && I.adjusted.top && (I.top += n.top)) : I.adjusted = {
                            left: 0,
                            top: 0
                        },
                    this._trigger("move", [I, p.elem || p], e) && (delete I.adjusted,
                        t === x || !b || isNaN(I.left) || isNaN(I.top) || "mouse" === a || !E.isFunction(r.effect) ? s.css(I) : E.isFunction(r.effect) && (r.effect.call(s, this, E.extend({}, I)),
                            s.queue(function(e) {
                                E(this).css({
                                    opacity: "",
                                    height: ""
                ...
                e.reposition.offset = function(e, i, t) {
                    if (!t[0])
                        return i;
                    var n, o, s, r, a = E(e[0].ownerDocument), l = !!T.ie && "CSS1Compat" !== Ne.compatMode, d = t[0];
                    function p(e, t) {
                        i.left += t * e.scrollLeft(),
                            i.top += t * e.scrollTop()
                    }
                    for (; "static" !== (o = E.css(d, "position")) && ("fixed" === o ? (s = d.getBoundingClientRect(),
                        p(a, -1)) : ((s = E(d).position()).left += parseFloat(E.css(d, "borderLeftWidth")) || 0,
                        s.top += parseFloat(E.css(d, "borderTopWidth")) || 0),
                        i.left -= s.left + (parseFloat(E.css(d, "marginLeft")) || 0),
                        i.top -= s.top + (parseFloat(E.css(d, "marginTop")) || 0),
                    n || "hidden" === (r = E.css(d, "overflow")) || "visible" === r || (n = E(d))),
                               d = d.offsetParent; )
                        ;
                    return n && (n[0] !== a[0] || l) && p(n, 1),
                        i
                }
            ;
            var U = (v = e.reposition.Corner = function(e, t) {
                    e = ("" + e).replace(/([A-Z])/, " $1").replace(/middle/gi, Y).toLowerCase(),
            ...
            function W(e) {
                return e && {
                    ...
                    scrollX: e.scrollX || Se.pageXOffset || Ne.body.scrollLeft || Ne.documentElement.scrollLeft,
                    scrollY: e.scrollY || Se.pageYOffset || Ne.body.scrollTop || Ne.documentElement.scrollTop
                } || {}
            }
            function H(e, t) {
                if (0 < t)
                    return setTimeout(E.proxy(e, this), t);
                e.call(this)
            }
            function G(e) {
                if (this.tooltip.hasClass(g))
                    return x;
                clearTimeout(this.timers.show),
                    clearTimeout(this.timers.hide),
                    this.timers.show = H.call(this, function() {
                        this.toggle(w, e)
            ...
            function j(e) {
                ...
                if (clearTimeout(this.timers.show),
                        clearTimeout(this.timers.hide),
                    this !== t[0] && "mouse" === this.options.position.target && i || this.options.hide.fixed && /mouse(out|leave|move)/.test(e.type) && (i || n))
                    try {
                        e.preventDefault(),
                            e.stopImmediatePropagation()
                    } catch (e) {}
                else
                    this.timers.hide = H.call(this, function() {
                        this.toggle(x, e)
                    }, this.options.hide.delay, this)
            }
            function q(e) {
                if (this.tooltip.hasClass(g) || !this.options.hide.inactive)
                    return x;
                clearTimeout(this.timers.inactive),
                    this.timers.inactive = H.call(this, function() {
                        this.hide(e)
            ...
            U.invert = function(e, t) {
                this[e] = this[e] === A ? X : this[e] === X ? A : t || this[e]
            }
                ,
                U.string = function() {
                    var e = this.x
                ...
                e.toggle = function(e, t) {
                    var i = this.cache
                        ...
                        , o = this.tooltip;
                    if (t) {
                        if (/over|enter/.test(t.type) && /out|leave/.test(i.event.type) && n.show.target.add(t.target).length === n.show.target.length && o.has(t.relatedTarget).length)
                            return this;
                        i.event = W(t)
                    }
                    if (this.waiting && !e && (this.hiddenDuringWait = w),
                            !this.rendered)
                        return e ? this.render(1) : this;
                    if (this.destroyed || this.disabled)
                        return this;
                    var s, r, a, l = e ? "show" : "hide", d = this.options[l], p = (this.options[e ? "hide" : "show"],
                        this.options.position), c = this.options.content, u = this.tooltip.css("width"), h = this.tooltip.is(":visible"), f = e || 1 === d.target.length, g = !t || d.target.length < 2 || i.target[0] === t.target;
                    return (typeof e).search("boolean|number") && (e = !h),
                        r = (s = !o.is(":animated") && h === e && g) ? y : !!this._trigger(l, [90]),
                        this.destroyed ? this : (r !== x && e && this.focus(t),
                        !r || s || (E.attr(o[0], "aria-hidden", !e),
                            e ? (i.origin = W(this.mouse),
                            E.isFunction(c.text) && this._updateContent(c.text, x),
                            E.isFunction(c.title) && this._updateTitle(c.title, x),
                            !m && "mouse" === p.target && p.adjust.mouse && (E(Ne).bind("mousemove." + B, this._storeMouse),
                                m = w),
                            u || o.css("width", o.outerWidth(x)),
                                this.reposition(t, arguments[2]),
                            u || o.css("width", ""),
                            d.solo && ("string" == typeof d.solo ? E(d.solo) : E(I, d.solo)).not(o).not(d.target).qtip("hide", E.Event("tooltipsolo"))) : (clearTimeout(this.timers.show),
                                delete i.origin,
                            m && !E(I + '[tracking="true"]:visible', d.solo).not(o).length && (E(Ne).unbind("mousemove." + B),
                                m = x),
                                this.blur(t)),
                            a = E.proxy(function() {
                                e ? (T.ie && o[0].style.removeAttribute("filter"),
                                    o.css("overflow", ""),
                                "string" == typeof d.autofocus && E(this.options.show.autofocus, o).focus(),
                                    this.options.show.target.trigger("qtip-" + this.id + "-inactive")) : o.css({
                                    display: "",
                                    visibility: "",
                                    opacity: "",
                                    left: "",
                            ...
                            d.effect === x || f === x ? (o[l](),
                                a()) : E.isFunction(d.effect) ? (o.stop(1, 1),
                                d.effect.call(o, this),
                                o.queue("fx", function(e) {
                                    a(),
                                        e()
                                })) : o.fadeTo(90, e ? 1 : 0, a),
                        e && d.target.trigger("qtip-" + this.id + "-inactive")),
                            this)
                }
                ,
                e.show = function(e) {
                ...
                e.focus = function(e) {
                    ...
                    return i.hasClass(r) || this._trigger("focus", [o], e) && (n !== o && (t.each(function() {
                        ...
                        t.filter("." + r).qtip("blur", e)),
                        i.addClass(r)[0].style.zIndex = o),
                        this
                }
                ,
                e.blur = function(e) {
                    return !this.rendered || this.destroyed || (this.tooltip.removeClass(r),
                        this._trigger("blur", [this.tooltip.css("zIndex")], e)),
                        this
                }
                ,
                e.disable = function(e) {
                    return this.destroyed || ("toggle" === e ? e = !(this.rendered ? this.tooltip.hasClass(g) : this.disabled) : "boolean" != typeof e && (e = w),
                    this.rendered && this.tooltip.toggleClass(g, e).attr("aria-disabled", e),
                        this.disabled = !!e),
                        this
                }
                ,
                ...
                e._setWidget = function() {
                    var e = this.options.style.widget
                        ...
                        , n = i.hasClass(g);
                    i.removeClass(g),
                        g = e ? "ui-state-disabled" : "qtip-disabled",
                        i.toggleClass(g, n),
                        i.toggleClass("ui-helper-reset " + V(), e).toggleClass(c, this.options.style.def && !e),
            ...
            E(function() {
                J(I, ["mouseenter", "mouseleave"], function(e) {
                    var t = "mouseenter" === e.type
                        ...
                        , o = this.options;
                    t ? (this.focus(e),
                    i.hasClass(u) && !i.hasClass(g) && clearTimeout(this.timers.hide)) : "mouse" === o.position.target && o.hide.event && o.show.target && !n.closest(o.show.target[0]).length && this.hide(e),
                        i.toggleClass(s, t)
                }),
                    J("[" + p + "]", n, q)
            }),
                ...
                e._assignEvents = function() {
                    var i = this
                        ...
                        , d = (E(Ne.body),
                        E(Se))
                        , p = o.show.event ? E.trim("" + o.show.event).split(" ") : []
                    ...
                    -1 < ("" + o.hide.event).indexOf("unfocus") && this._bind(r.closest("html"), ["mousedown", "touchstart"], function(e) {
                        var t = E(e.target)
                            , i = this.rendered && !this.tooltip.hasClass(g) && 0 < this.tooltip[0].offsetWidth
                    ...
                    "number" == typeof o.hide.inactive && (this._bind(t, "qtip-" + this.id + "-inactive", q),
                        this._bind(s.add(n), h.inactiveEvents, q, "-inactive")),
                        this._bindEvents(p, c, t, s, G, j),
                    ...
                    "mouse" === e.target && e.adjust.mouse && (o.hide.event && this._bind(t, ["mouseenter", "mouseleave"], function(e) {
                        ...
                        this._bind(l, "mousemove", function(e) {
                            this.rendered && this.cache.onTarget && !this.tooltip.hasClass(g) && 0 < this.tooltip[0].offsetWidth && this.reposition(e)
                        })),
                    (e.adjust.resize || a.length) && this._bind(E.event.special.resize ? a : d, "resize", K),
                    e.adjust.scroll && this._bind(d.add(e.container), "scroll", K)
                }
                ,
                e._unassignEvents = function() {
                    var e = [this.options.show.target[0], this.options.hide.target[0], this.rendered && this.tooltip[0], this.options.position.container[0], this.options.position.viewport[0], this.options.position.container.closest("html")[0], Se, Ne];
                ...
                h = E.fn.qtip = function(e, t, i) {
                    ...
                    return !arguments.length && a || "api" === n ? a : "string" == typeof e ? (this.each(function() {
                        ...
                        if (!e)
                            return w;
                        if (r && r.timeStamp && (e.cache.event = r),
                            !t || "option" !== n && "options" !== n)
                            e[n] && e[n].apply(e, s);
                        else {
                            if (i === Re && !E.isPlainObject(t))
                                return o = e.get(t),
                                    x;
                            e.set(t, i)
                        }
                    }),
                        o !== y ? o : this) : "object" != typeof e && arguments.length ? void 0 : (a = S(E.extend(w, {}, e)),
                        this.each(function(e) {
                            var t, i;
                            if (i = !(i = E.isArray(a.id) ? a.id[e] : a.id) || i === x || i.length < 1 || h.api[i] ? h.nextid++ : i,
                                (t = function(e, t, i) {
                                    var n, o, s, r, a, l = E(Ne.body), d = e[0] === Ne ? l : e, p = e.metadata ? e.metadata(i.metadata) : y, c = "html5" === i.metadata.type && p ? p[i.metadata.name] : y, u = e.data(i.metadata.name || "qtipopts");
                                    try {
                                        u = "string" == typeof u ? E.parseJSON(u) : u
                                    } catch (e) {}
                                    if (o = (r = E.extend(w, {}, h.defaults, i, "object" == typeof u ? S(u) : y, S(c || p))).position,
                                            r.id = t,
                                        "boolean" == typeof r.content.text) {
                                        if (s = e.attr(r.content.attr),
                                            r.content.attr === x || !s)
                                            return x;
                                        r.content.text = s
                                    }
                                    if (o.container.length || (o.container = l),
                                        o.target === x && (o.target = d),
                                        r.show.target === x && (r.show.target = d),
                                        r.show.solo === w && (r.show.solo = o.container.closest("body")),
                                        r.hide.target === x && (r.hide.target = d),
                                        r.position.viewport === w && (r.position.viewport = o.container),
                                            o.container = o.container.eq(0),
                                            o.at = new v(o.at,w),
                                            o.my = new v(o.my),
                                            e.data(B))
                                        if (r.overwrite)
                                            e.qtip("destroy", !0);
                                        else if (r.overwrite === x)
                                            return x;
                                    return e.attr(f, t),
                                    r.suppress && (a = e.attr("title")) && e.removeAttr("title").attr(b, a).attr("title", ""),
                                        n = new O(e,r,t,!!s),
                                        e.data(B, n),
                ...
                E.each({
                    attr: function(e, t) {
                        if (this.length) {
                            var i = this[0]
                                , n = E.data(i, "qtip");
                            if ("title" === e && n && "object" == typeof n && n.options.suppress)
                                return arguments.length < 2 ? E.attr(i, b) : (n && "title" === n.options.content.attr && n.cache.attr && n.set("content.text", t),
                                    this.attr(b, t))
                        }
                    ...
                    clone: function(e) {
                        ...
                        return e || t.filter("[" + b + "]").attr("title", function() {
                            return E.attr(this, b)
                        }).removeAttr(b),
                            t
                    }
                }, function(e, t) {
            ...
            E.ui || (E["cleanData" + o] = E.cleanData,
                    E.cleanData = function(e) {
                        for (var t, i = 0; (t = E(e[i])).length; i++)
                            if (t.attr(f))
                                try {
            ...
            var Z, ee = "margin", te = "border", ie = "color", ne = "background-color", oe = "transparent", se = " !important", re = !!Ne.createElement("canvas").getContext, ae = /rgba?\(0, 0, 0(, 0)?\)|transparent|#123456/i;
            function le(e) {
                return e.charAt(0).toUpperCase() + e.slice(1)
            }
            var de, pe = {}, ce = ["Webkit", "O", "Moz", "ms"];
            function ue(e, t) {
                return Math.ceil(parseFloat(function(e, t) {
                    var i, n, o = t.charAt(0).toUpperCase() + t.slice(1), s = (t + " " + ce.join(o + " ") + o).split(" "), r = 0;
                    if (pe[t])
                        return e.css(pe[t]);
                    for (; i = s[r++]; )
                        if ((n = e.css(i)) !== Re)
            ...
            if (re)
                var he = (Se.devicePixelRatio || 1) / ((de = Ne.createElement("canvas").getContext("2d")).backingStorePixelRatio || de.webkitBackingStorePixelRatio || de.mozBackingStorePixelRatio || de.msBackingStorePixelRatio || de.oBackingStorePixelRatio || 1);
            else
            ...
            E.extend(ge.prototype, {
                init: function(e) {
                    var t, i;
                    i = this.element = e.elements.tip = E("<div />", {
                        class: B + "-tip"
                    }).prependTo(e.tooltip),
                        re ? ((t = E("<canvas />").appendTo(this.element)[0].getContext("2d")).lineJoin = "miter",
                            t.miterLimit = 1e5,
                            t.save()) : (t = fe("shape", 'coordorigin="0,0"', "position:absolute;"),
                            this.element.html(t + t),
                            e._bind(E("*", i).add(i), ["click", "mousedown"], function(e) {
                                e.stopPropagation()
                            }, this._ns)),
                ...
                _useTitle: function(e) {
                    ...
                    return t && (e.y === k || e.y === Y && this.element.position().top + this.size[1] / 2 + this.options.offset < t.outerHeight(w))
                },
                _parseCorner: function(e) {
                    var t = this.qtip.options.position.my;
                    return e === x || t === x ? e = x : e === w ? e = new v(t.string()) : e.string || ((e = new v(e)).fixed = w),
                        e
                },
                ...
                _calculateSize: function(e) {
                    var t, i, n = e.precedance === _, o = this.options.width, s = this.options.height, r = "c" === e.abbrev(), a = (n ? o : s) * (r ? .5 : 1), l = Math.pow, d = Math.round, p = Math.sqrt(l(a, 2) + l(s, 2)), c = [this.border / a * p, this.border / s * p];
                    return c[2] = Math.sqrt(l(c[0], 2) - l(this.border, 2)),
                        c[3] = Math.sqrt(l(c[1], 2) - l(this.border, 2)),
                        i = [d((t = (p + c[2] + c[3] + (r ? 0 : c[0])) / p) * o), d(t * s)],
                        n ? i : i.reverse()
                },
                ...
                create: function() {
                    ...
                    return (this.enabled = !!this.corner && "c" !== this.corner.abbrev()) && (this.qtip.cache.corner = e.clone(),
                        this.update()),
                ...
                update: function(e, t) {
                    if (!this.enabled)
                        return this;
                    var i, n, o, s, r, a, l, d, p = this.qtip.elements, c = this.element, u = c.children(), h = this.options, f = this.size, g = h.mimic, m = Math.round;
                    e || (e = this.qtip.cache.corner || this.corner),
                        g === x ? g = e : ((g = new v(g)).precedance = e.precedance,
                            "inherit" === g.x ? g.x = e.x : "inherit" === g.y ? g.y = e.y : g.x === g.y && (g[e.precedance] = e[e.precedance])),
                        n = g.precedance,
                        e.precedance === P ? this._swapDimensions() : this._resetDimensions(),
                        (i = this.color = this._parseColours(e))[1] !== oe ? (d = this.border = this._parseWidth(e, e[e.precedance]),
                        h.border && d < 1 && !ae.test(i[1]) && (i[0] = i[1]),
                            this.border = d = h.border !== w ? h.border : d) : this.border = d = 0,
                        ...
                        a = e.precedance === _ ? [m(g.x === A ? d : g.x === X ? l[0] - f[0] - d : (l[0] - f[0]) / 2), m(g.y === k ? l[1] - f[1] : 0)] : [m(g.x === A ? l[0] - f[0] : 0), m(g.y === k ? d : g.y === M ? l[1] - f[1] - d : (l[1] - f[1]) / 2)],
                        re ? ((o = u[0].getContext("2d")).restore(),
                            o.save(),
                            o.clearRect(0, 0, 6e3, 6e3),
                            s = this._calculateTip(g, f, he),
                            r = this._calculateTip(g, this.size, he),
                            u.attr(D, l[0] * he).attr(L, l[1] * he),
                            u.css(D, l[0]).css(L, l[1]),
                            this._drawCoords(o, r),
                            o.fillStyle = i[1],
                            o.fill(),
                            o.translate(a[0] * he, a[1] * he),
                            this._drawCoords(o, s),
                            o.fillStyle = i[0],
                            o.fill()) : (s = "m" + (s = this._calculateTip(g))[0] + "," + s[1] + " l" + s[2] + "," + s[3] + " " + s[4] + "," + s[5] + " xe",
                            a[2] = d && /^(r|b)/i.test(e.string()) ? 8 === T.ie ? 2 : 1 : 0,
                            u.css({
                                coordsize: l[0] + d + " " + (l[1] + d),
                                antialias: "" + (-1 < g.string().indexOf(Y)),
                                ...
                                !e && t.html(fe("stroke", 'weight="' + 2 * d + 'px" color="' + i[1] + '" miterlimit="1000" joinstyle="miter"'))
                            })),
                    Se.opera && setTimeout(function() {
                        p.tip.css({
                ...
                calculate: function(s, r) {
                    if (!this.enabled)
                        return x;
                    var a, e, l = this, d = this.qtip.elements, t = this.element, p = this.options.offset, c = (d.tooltip.hasClass("ui-widget"),
                        {});
                    ...
                    a === P && e.reverse(),
                        E.each(e, function(e, t) {
                            var i, n, o;
                            t === Y ? (c[i = a === _ ? A : k] = "50%",
                                c[ee + "-" + i] = -Math.round(r[a === _ ? 0 : 1] / 2) + p) : (i = l._parseWidth(s, t, d.tooltip),
                                n = l._parseWidth(s, t, d.content),
                                o = l._parseRadius(s),
                                c[t] = Math.max(-l.border, e ? n : p + (i < o ? o : -i)))
                        }),
                        c[s[a]] -= r[a === P ? 0 : 1],
                        t.css({
                            margin: "",
                ...
                reposition: function(e, t, n, i) {
                    if (this.enabled) {
                        var o, s, r = t.cache, a = this.corner.clone(), l = n.adjusted, d = t.options.position.adjust.method.split(" "), p = d[0], c = d[1] || d[0], u = {
                            left: x,
                            top: x,
                            x: 0,
                            y: 0
                        }, h = {};
                        this.corner.fixed !== w && (f(p, P, _, A, X),
                            f(c, _, P, k, M),
                        a.string() === r.corner.string() || r.cornerTop === l.top && r.cornerLeft === l.left || this.update(a, x)),
                        (o = this.calculate(a)).right !== Re && (o.left = -o.right),
                        o.bottom !== Re && (o.top = -o.bottom),
                            o.user = this.offset,
                        (u.left = p === $ && !!l.left) && g(P, A, X),
                        (u.top = c === $ && !!l.top) && g(_, k, M),
                            this.element.css(h).toggle(!(u.x && u.y || a.x === Y && u.y || a.y === Y && u.x)),
                            n.left -= o.left.charAt ? o.user : p !== $ || u.top || !u.left && !u.top ? o.left + this.border : 0,
                            n.top -= o.top.charAt ? o.user : c !== $ || u.left || !u.left && !u.top ? o.top + this.border : 0,
                            r.cornerLeft = l.left,
                            r.cornerTop = l.top,
                            r.corner = a.clone()
                    }
                    function f(e, t, i, n, o) {
                        e === $ && a.precedance === t && l[n] && a[i] !== Y ? a.precedance = a.precedance === P ? _ : P : e !== $ && l[n] && (a[t] = a[t] === Y ? 0 < l[n] ? n : o : a[t] === n ? o : n)
                    }
                    function g(e, t, i) {
                        a[e] === Y ? h[ee + "-" + t] = u[e] = o[ee + "-" + t] - l[t] : (s = o[i] !== Re ? [l[t], -o[t]] : [-l[t], o[t]],
                        (u[e] = Math.max(s[0], s[1])) > s[0] && (n[t] -= l[t],
                            u[t] = x),
                            h[o[i] !== Re ? i : t] = u[e])
                    }
                },
                ...
                (Z = C.tip = function(e) {
                        return new ge(e,e.options.style.tip)
                    }
                ).initialize = "render",
                Z.sanitize = function(e) {
                    if (e.style && "tip"in e.style) {
                        ...
                        /string|boolean/i.test(typeof t.corner) || (t.corner = w)
                    }
                }
                ,
                t.tip = {
            ...
            ve = new (ve = function() {
                    ...
                    E.extend(u, {
                        init: function() {
                            return c = u.elem = E("<div />", {
                                ...
                                E(Ne).bind("keydown" + Ie, function(e) {
                                    d && d.options.show.modal.escape && 27 === e.keyCode && d.hide(e)
                                }),
                                c.bind("click" + Ie, function(e) {
                                    d && d.options.show.modal.blur && d.hide(e)
                                }),
                                u
                        },
                        update: function(e) {
                            o = (d = e).options.show.modal.stealfocus !== x ? e.tooltip.find("*").filter(function() {
                                return function(e) {
                                    if (E.expr[":"].focusable)
                                        return E.expr[":"].focusable;
                                    var t, i, n, o = !isNaN(E.attr(e, "tabindex")), s = e.nodeName && e.nodeName.toLowerCase();
                                    return "area" === s ? (i = (t = e.parentNode).name,
                                    !(!e.href || !i || "map" !== t.nodeName.toLowerCase()) && !!(n = E("img[usemap=#" + i + "]")[0]) && n.is(":visible")) : /input|select|textarea|button|object/.test(s) ? !e.disabled : "a" === s && e.href || o
                                }(this)
                            }) : []
                        },
                        toggle: function(e, t, i) {
                            ...
                            c.is(":animated") && a === t && p !== x || !t && l.length || (c.stop(w, x),
                                E.isFunction(s) ? s.call(c, t) : s === x ? c[r]() : c.fadeTo(parseInt(i, 10) || 90, t ? 1 : 0, function() {
                                    t || c.hide()
                                }),
                    ...
                    init: function(e) {
                        ...
                        e.elements.overlay = ve.elem,
                            ...
                            e._bind(s, ["tooltipshow", "tooltiphide"], function(e, t, i) {
                                ...
                                if (e.target === s[0])
                                    if (n && "tooltiphide" === e.type && /mouse(leave|enter)/.test(n.type) && E(n.relatedTarget).closest(ve.elem[0]).length)
                                        try {
                                            e.preventDefault()
                                        } catch (e) {}
                                    else
                                        (!n || n && "tooltipsolo" !== n.type) && this.toggle(e, "tooltipshow" === e.type, i)
                            }, this._ns, this),
                ...
                (me = C.modal = function(e) {
                        return new be(e,e.options.show.modal)
                    }
                ).sanitize = function(e) {
                    e.show && ("object" != typeof e.show.modal ? e.show.modal = {
                        on: !!e.show.modal
                    } : void 0 === e.show.modal.on && (e.show.modal.on = w))
                }
                ,
                h.modal_zindex = h.zindex - 200,
                me.initialize = "render",
                t.modal = {
                ...
                C.viewport = function(e, I, t, i, n, o, s) {
                    var r, b, a, O, S, N, R, E, w, l = t.target, d = e.elements.tooltip, C = t.my, T = t.at, p = t.adjust, c = p.method.split(" "), u = c[0], h = c[1] || c[0], f = t.viewport, g = t.container, m = e.cache, v = {
                        left: 0,
                        top: 0
                    };
                    if (!f.jquery || l[0] === Se || l[0] === Ne.body || "none" === p.method)
                        return v;
                    function y(e, t, i, n, o, s, r, a, l) {
                        var d = I[o]
                            ...
                            , m = g - d
                            , v = d + l - (r === D ? N : R) - g
                            , y = h - (C.precedance === e || p === C[t] ? f : 0) - (c === Y ? a / 2 : 0);
                        return u ? (y = (p === o ? 1 : -1) * h,
                            I[o] += 0 < m ? m : 0 < v ? -v : 0,
                            I[o] = Math.max(-O[o] + w[o], d - y, Math.min(Math.max(-O[o] + w[o] + (r === D ? N : R), d + y), I[o], "center" === p ? d - h : 1e9))) : (n *= i === F ? 2 : 0,
                            0 < m && (p !== o || 0 < v) ? (I[o] -= y + n,
                                b.invert(e, o)) : 0 < v && (p !== s || 0 < m) && (I[o] -= (p === Y ? -y : y) + n,
                                b.invert(e, s)),
                        I[o] < E && -I[o] > v && (I[o] = d,
                            b = C.clone())),
                        I[o] - d
                    ...
                    return O = g.offset() || v,
                        S = "static" === g.css("position"),
                        r = "fixed" === d.css("position"),
                        N = f[0] === Se ? f.width() : f.outerWidth(x),
                        R = f[0] === Se ? f.height() : f.outerHeight(x),
                        E = {
                            left: r ? 0 : f.scrollLeft(),
                            top: r ? 0 : f.scrollTop()
                        },
                        w = f.offset() || v,
                    "shift" === u && "shift" === h || (b = C.clone()),
                        v = {
                            left: "none" !== u ? y(P, _, u, p.x, A, X, D, i, o) : 0,
                            top: "none" !== h ? y(_, P, h, p.y, k, M, L, n, s) : 0
                        },
                    b && m.lastClass !== (a = B + "-pos-" + b.abbrev()) && d.removeClass(e.cache.lastClass).addClass(e.cache.lastClass = a),
                        v
                }
                ,
                C.polys = {
                    polygon: function(e, t) {
                        var i, n, o, s = {
                            ...
                            adjustable: x
                        }, r = 0, a = [], l = 1, d = 1, p = 0, c = 0;
                        for (r = e.length; r--; )
                            (i = [parseInt(e[--r], 10), parseInt(e[r + 1], 10)])[0] > s.position.right && (s.position.right = i[0]),
                            i[0] < s.position.left && (s.position.left = i[0]),
                            i[1] > s.position.bottom && (s.position.bottom = i[1]),
                            i[1] < s.position.top && (s.position.top = i[1]),
                                a.push(i);
                        if (n = s.width = Math.abs(s.position.right - s.position.left),
                                o = s.height = Math.abs(s.position.bottom - s.position.top),
                            "c" === t.abbrev())
                            s.position = {
                            ...
                            for (; 0 < n && 0 < o && 0 < l && 0 < d; )
                                for (n = Math.floor(n / 2),
                                         o = Math.floor(o / 2),
                                         t.x === A ? l = n : t.x === X ? l = s.width - n : l += Math.floor(n / 2),
                                         t.y === k ? d = o : t.y === M ? d = s.height - o : d += Math.floor(o / 2),
                                         r = a.length; r-- && !(a.length < 2); )
                                    p = a[r][0] - s.position.left,
                                        c = a[r][1] - s.position.top,
                                    (t.x === A && l <= p || t.x === X && p <= l || t.x === Y && (p < l || p > s.width - l) || t.y === k && d <= c || t.y === M && c <= d || t.y === Y && (c < d || c > s.height - d)) && a.splice(r, 1);
                            s.position = {
                                left: a[0][0],
                                top: a[0][1]
                            }
                    ...
                    ellipse: function(e, t, i, n, o) {
                        var s = C.polys._angles[o.abbrev()]
                ...
                C.svg = function(e, t, i) {
                    for (var n, o, s, r, a, l, d, p, c, u, h, f = E(Ne), g = t[0], m = E(g.ownerSVGElement), v = !0; !g.getBBox; )
                        g = g.parentNode;
                    if (!g.getBBox || !g.parentNode)
                        return x;
                    n = m.attr("width") || m.width() || parseInt(m.css("width"), 10),
                        o = m.attr("height") || m.height() || parseInt(m.css("height"), 10);
                    ...
                    y / o),
                        ...
                        case "ellipse":
                        case "circle":
                            u = C.polys.ellipse(g.cx.baseVal.value, g.cy.baseVal.value, (g.rx || g.r).baseVal.value + y, (g.ry || g.r).baseVal.value + y, i);
                            break;
                        case "line":
                        case "polygon":
                        case "polyline":
                            for (u = [],
                                     p = -1,
                                     l = (c = g.points || [{
                                         x: g.x1.baseVal.value,
                                         y: g.y1.baseVal.value
                                     }, {
                                         x: g.x2.baseVal.value,
                                         y: g.y2.baseVal.value
                                     }]).numberOfItems || c.length; ++p < l; )
                                d = c.getItem ? c.getItem(p) : c[p],
                                    u.push.apply(u, [d.x, d.y]);
                            u = C.polys.polygon(u, i);
                            break;
                        default:
                            v = !(u = {
                                width: (u = g.getBoundingClientRect()).width,
                                height: u.height,
                                position: {
                                    left: u.left,
                                    top: u.top
                    ...
                    return h = u.position,
                        m = m[0],
                    v && (m.createSVGPoint && (s = g.getScreenCTM(),
                        (c = m.createSVGPoint()).x = h.left,
                        c.y = h.top,
                        r = c.matrixTransform(s),
                        h.left = r.x,
                        h.top = r.y),
                    m.viewBox && (a = m.viewBox.baseVal) && a.width && a.height && (n / a.width,
                    o / a.height)),
                        h.left += f.scrollLeft(),
                        h.top += f.scrollTop(),
                        u
                ...
                C.imagemap = function(e, t, i, n) {
                    t.jquery || (t = E(t));
                    var o, s, r, a, l, d = t.attr("shape").toLowerCase().replace("poly", "polygon"), p = E('img[usemap="#' + t.parent("map").attr("name") + '"]'), c = E.trim(t.attr("coords")).replace(/,$/, "").split(",");
                    if (!p.length)
                        return x;
                    if ("polygon" === d)
                        a = C.polys.polygon(c, i);
                    else {
                        if (!C.polys[d])
                            return x;
                        for (r = -1,
                                 l = c.length,
                                 s = []; ++r < l; )
                            s.push(parseInt(c[r], 10));
                        a = C.polys[d].apply(this, s.concat(i))
                    }
                    return (o = p.offset()).left += Math.ceil((p.outerWidth(x) - p.width()) / 2),
                        o.top += Math.ceil((p.outerHeight(x) - p.height()) / 2),
            ...
            E.extend(Oe.prototype, {
                _scroll: function() {
                    ...
                    e && (e[0].style.top = E(Se).scrollTop() + "px")
                },
                init: function(e) {
                    var t = e.tooltip;
                    E("select, object").length < 1 && (this.bgiframe = e.elements.bgiframe = E('<iframe class="qtip-bgiframe" frameborder="0" tabindex="-1" src="javascript:\'\';"  style="display:block; position:absolute; z-index:-1; filter:alpha(opacity=0); -ms-filter:"progid:DXImageTransform.Microsoft.Alpha(Opacity=0)";"></iframe>').appendTo(t),
                        e._bind(t, "tooltipmove", this.adjustBGIFrame, this._ns, this)),
                        this.redrawContainer = E("<div/>", {
                            id: B + "-rcontainer"
                        }).appendTo(Ne.body),
                    e.elements.overlay && e.elements.overlay.addClass("qtipmodal-ie6fix") && (e._bind(Se, ["scroll", "resize"], this._scroll, this._ns, this),
                        e._bind(t, ["tooltipshow"], this._scroll, this._ns, this)),
                        this.redraw()
                },
                adjustBGIFrame: function() {
                    var e, t, i = this.qtip.tooltip, n = {
                    ...
                    o && s && (t[(e = "x" === o.corner.precedance ? [D, A] : [L, k])[1]] -= s[e[0]]()),
                        this.bgiframe.css(t).css(n)
                },
                redraw: function() {
                    if (this.qtip.rendered < 1 || this.drawing)
                        return this;
                    var e, t, i, n, o = this.qtip.tooltip, s = this.qtip.options.style, r = this.qtip.options.position.container;
                    return this.qtip.drawing = 1,
                    s.height && o.css(L, s.height),
                        s.width ? o.css(D, s.width) : (o.css(D, "").appendTo(this.redrawContainer),
                        (t = o.width()) % 2 < 1 && (t += 1),
                            e = -1 < ((i = o.css("maxWidth") || "") + (n = o.css("minWidth") || "")).indexOf("%") ? r.width() / 100 : 0,
                            t = (i = (-1 < i.indexOf("%") ? e : 1) * parseInt(i, 10) || t) + (n = (-1 < n.indexOf("%") ? e : 1) * parseInt(n, 10) || 0) ? Math.min(Math.max(t, n), i) : t,
                            o.css(D, Math.round(t)).appendTo(r)),
                        this.drawing = 0,
                        this
                },
                destroy: function() {
                    this.bgiframe && this.bgiframe.remove(),
                        this.qtip._unbind([Se, this.qtip.tooltip], this._ns)
                }
            }),
                (C.ie6 = function(e) {
